...
final class b
{
  ...
  static
  {
    try
    {
      lZ = SharedPreferences.Editor.class.getMethod("apply", new Class[0]);
      return;
    }
  ...
  static List<File> a(Context paramContext, ApplicationInfo paramApplicationInfo, File paramFile, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        lZ.invoke(paramContext, new Object[0]);
        paramContext = paramApplicationInfo;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/android/support/multidex/b.class
