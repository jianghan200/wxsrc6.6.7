...
final class c
{
  private static long a(RandomAccessFile paramRandomAccessFile, a parama)
  {
    ...
    long l = parama.size;
    paramRandomAccessFile.seek(parama.mb);
  ...
  private static a a(RandomAccessFile paramRandomAccessFile)
  {
    ...
    for (;;)
    {
      ...
      locala.mb = (Integer.reverseBytes(paramRandomAccessFile.readInt()) & 0xFFFFFFFF);
      return locala;
      l1 = l3;
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/android/support/multidex/c.class
