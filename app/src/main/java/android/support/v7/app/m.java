...
final class m
{
  ...
  public final void a(long paramLong, double paramDouble1, double paramDouble2)
  {
    ...
    this.FD = (Math.round((f1 + paramDouble2) * 8.64E7D) + 946728000000L);
    this.FE = (Math.round((paramDouble2 - f1) * 8.64E7D) + 946728000000L);
    if ((this.FE < paramLong) && (this.FD > paramLong))
    {
      this.state = 0;
      return;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/android/support/v7/app/m.class
