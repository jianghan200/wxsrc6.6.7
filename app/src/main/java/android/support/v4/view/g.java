...
public final class g
{
  ...
  {
    return uI.metaStateHasNoModifiers(paramKeyEvent.getMetaState());
  }
  
  public static boolean a(KeyEvent paramKeyEvent, int paramInt)
  {
    return uI.metaStateHasModifiers(paramKeyEvent.getMetaState(), paramInt);
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/view/g.class
