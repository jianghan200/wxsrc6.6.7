  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  private static final android.support.v4.e.j<String, Class<?>> sClassMap = new android.support.v4.e.j();
  boolean mAdded;
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    h.a(paramBundle, this.mChildFragmentManager);
    return paramBundle;
  }
  ...
  {
    this.mEnterTransitionCallback = paramal;
  }
  ...
  {
    this.mExitTransitionCallback = paramal;
  }
  ...
  public void setInitialSavedState(SavedState paramSavedState)
  {
    ...
    if ((paramSavedState != null) && (paramSavedState.ny != null)) {}
    for (paramSavedState = paramSavedState.ny;; paramSavedState = null)
    {
  ...
  {
    if (this.mHost != null) {
      return this.mHost.H(paramString);
    }
    return false;
  }
    ...
    implements Parcelable
  {
    ...
    {
      this.ny = paramParcel.readBundle();
    }
    ...
    {
      paramParcel.writeBundle(this.ny);
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/app/Fragment.class
