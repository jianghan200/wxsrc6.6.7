  ...
  implements XWalkExtensionContextClient
{
  ...
  private void loadNativeExtensions()
  {
    ...
    if ((localObject != null) && (new File((String)localObject).isDirectory())) {
      this.mNativeExtensionLoader.registerNativeExtensionsInPath((String)localObject);
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/org/xwalk/core/extension/XWalkExternalExtensionManagerImpl.class
