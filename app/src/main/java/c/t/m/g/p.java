  ...
  public static void e()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        g = 0;
        f = false;
        ??? = ((WifiManager)m.a().getSystemService("wifi")).getConnectionInfo();
        c = ((WifiInfo)???).getSSID();
        d = ((WifiInfo)???).getBSSID();
      }
      ...
      label170:
      localObject4 = ((NetworkInfo)localObject2).getExtraInfo();
      ...
      i2 = ((NetworkInfo)localObject2).getSubtype();
      g = i2;
      if ((i2 != 1) && (i2 != 2) && (i2 != 4)) {
        break label331;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/c/t/m/g/p.class
