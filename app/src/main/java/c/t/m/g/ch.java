...
public final class ch
{
  ...
  public static String a(String paramString)
  {
    ...
    localObject = new ch();
    ((ch)localObject).a();
    ((ch)localObject).a(new ByteArrayInputStream(paramString), paramString.length);
    paramString = new byte[8];
    a(paramString, ((ch)localObject).c, 8);
    i = (int)(localObject.c[0] >>> 3) & 0x3F;
    if (i < 56)
    {
      i = 56 - i;
      ((ch)localObject).a(a, i);
      ((ch)localObject).a(paramString, 8);
      a(((ch)localObject).e, ((ch)localObject).b, 16);
      localObject = ((ch)localObject).e;
      paramString = "";
      i = 0;
      while (i < 16)
      {
  ...
  private boolean a(java.io.InputStream paramInputStream, long paramLong)
  {
    ...
    //   119: pop
    //   120: aload_0
    //   121: getfield 27	c/t/m/g/ch:d	[B
    //   124: astore 12
    //   126: iconst_0
    //   127: istore 4
    //   129: iload 4
    ...
    //   158: aload_0
    //   159: aload_0
    //   160: getfield 27	c/t/m/g/ch:d	[B
    //   163: invokespecial 275	c/t/m/g/ch:a	([B)V
    //   166: iload 7
    //   168: istore 4
    //   170: iload 4
    //   172: bipush 63
    ...
    //   188: aload_0
    //   189: aload 10
    //   191: invokespecial 275	c/t/m/g/ch:a	([B)V
    //   194: iload 4
    //   196: bipush 64
    //   198: iadd
    //   199: istore 4
    ...
    //   223: pop
    //   224: aload_0
    //   225: getfield 27	c/t/m/g/ch:d	[B
    //   228: astore_1
    //   229: aload 10
    //   231: arraylength
    //   232: istore 7
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/c/t/m/g/ch.class
