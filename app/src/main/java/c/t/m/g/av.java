  ...
  extends SQLiteOpenHelper
{
  ...
  private av(Context paramContext, String paramString)
  {
  ...
  private int a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokevirtual 37	c/t/m/g/av:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   7: astore 4
    //   9: iload_1
    //   10: ifeq +57 -> 67
    //   13: iload_2
  ...
  public static av a(String paramString)
  {
    synchronized (b)
    {
      av localav = (av)a.get(paramString);
      Object localObject1 = localav;
      if (localav == null)
      {
        localObject1 = "HalleyAction_" + m.b() + "_" + m.h() + "_" + paramString + ".db";
        localObject1 = new av(m.a(), (String)localObject1);
  ...
  public final boolean a(int paramInt)
  {
    ...
    //   1: iconst_1
    //   2: iconst_1
    //   3: invokespecial 163	c/t/m/g/av:a	(ZZ)I
    //   6: iload_1
    //   7: if_icmple +45 -> 52
    //   10: aload_0
    //   11: invokevirtual 37	c/t/m/g/av:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: ldc 39
    //   16: aconst_null
    //   17: aconst_null
    ...
    //   26: iconst_1
    //   27: iconst_1
    //   28: invokespecial 163	c/t/m/g/av:a	(ZZ)I
    //   31: iload_1
    //   32: if_icmple +20 -> 52
    //   35: aload_0
    //   36: invokevirtual 37	c/t/m/g/av:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   39: astore_2
    //   40: aload_2
    //   41: ldc -91
  ...
  public final long b(String paramString)
  {
    ...
    //   10: lreturn
    //   11: aload_0
    //   12: invokevirtual 37	c/t/m/g/av:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   15: astore 4
  ...
  public final List<a> b(int paramInt)
  {
    ...
    //   10: astore 8
    //   12: aload_0
    //   13: invokevirtual 37	c/t/m/g/av:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   16: ldc 39
    //   18: aconst_null
    //   19: ldc 60
    //   21: iconst_1
    ...
    //   118: pop
    //   119: aload 8
    //   121: new 6	c/t/m/g/av$a
    //   124: dup
    //   125: lload_3
    //   126: aload 7
    //   128: iconst_0
    //   129: invokespecial 216	c/t/m/g/av$a:<init>	(JLjava/lang/String;B)V
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/c/t/m/g/av.class
