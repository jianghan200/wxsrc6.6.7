...
public final class ci
{
  ...
  public static String c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          localObject = (WifiManager)m.a().getSystemService("wifi");
          if (localObject != null)
          {
  ...
  public static String d()
  {
    ...
    return ch.a(localStringBuilder.toString());
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/c/t/m/g/ci.class
