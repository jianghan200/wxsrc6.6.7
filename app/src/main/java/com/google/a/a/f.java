...
public final class f
{
  private static void b(String paramString, Object paramObject, StringBuffer paramStringBuffer1, StringBuffer paramStringBuffer2)
  {
    if (paramObject != null)
    {
      ...
      if (paramString != null)
      {
        paramStringBuffer2.append(paramStringBuffer1).append(bF(paramString)).append(" <\n");
        ...
        if (((j & 0x1) == 1) && ((j & 0x8) != 8) && (!str.startsWith("_")) && (!str.endsWith("_")))
        {
          ...
          if ((((Class)localObject2).isArray()) && (((Class)localObject2).getComponentType() != Byte.TYPE))
          {
            ...
            for (j = 0;; j = Array.getLength(localObject3))
            {
              ...
              while (k < j)
              {
                b(str, Array.get(localObject3, k), paramStringBuffer1, paramStringBuffer2);
                k += 1;
              }
            }
          }
          b(str, localObject3, paramStringBuffer1, paramStringBuffer2);
        }
        i += 1;
      }
      ...
      while (i < j)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            b(str, ((Method)localObject2).invoke(paramObject, new Object[0]), paramStringBuffer1, paramStringBuffer2);
          }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/google/a/a/f.class
