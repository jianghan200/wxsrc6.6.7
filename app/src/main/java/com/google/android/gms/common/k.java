...
public final class k
{
  ...
  private static boolean a(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramPackageInfo = j.pJ(); paramPackageInfo.contains(localab); paramPackageInfo = j.pK()) {
      return true;
    }
    if (Log.isLoggable("GoogleSignatureVerifier", 2)) {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/google/android/gms/common/k.class
