  ...
  implements Parcelable.Creator<DataItemParcelable>
{
  static void a(DataItemParcelable paramDataItemParcelable, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 2, paramDataItemParcelable.aMJ, paramInt);
    Bundle localBundle = new Bundle();
    localBundle.setClassLoader(DataItemAssetParcelable.class.getClassLoader());
    Iterator localIterator = paramDataItemParcelable.ber.entrySet().iterator();
    ...
    b.a(paramParcel, 5, paramDataItemParcelable.bdf);
    b.u(paramParcel, i);
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/google/android/gms/wearable/internal/e.class
