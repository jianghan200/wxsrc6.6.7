...
public final class h
{
  ...
  public static void a(Context paramContext, String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, List<String> paramList)
  {
    ...
    int i;
    if (aPO.intValue() != d.LOG_LEVEL_OFF)
    {
      i = 1;
      if (i != 0) {
        break label42;
    ...
    Object localObject1 = paramContext.getApplicationContext().registerReceiver(null, aQg);
    label115:
    boolean bool;
    ...
    for (int j = 1;; j = 0)
    {
      ...
      try
      {
        paramContext.startService(new Intent().setComponent(aPM).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", paramString1));
        return;
      }
  ...
  private static int getLogLevel()
  {
    ...
    {
      if (u.qe()) {
        return ((Integer)c.b.aPQ.get()).intValue();
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/google/android/gms/common/stats/h.class
