  ...
  implements SafeParcelable
{
  ...
  BitmapTeleporter(int paramInt1, ParcelFileDescriptor paramParcelFileDescriptor, int paramInt2)
  {
    ...
    this.aMc = paramParcelFileDescriptor;
    this.aMd = paramInt2;
    this.aMe = null;
    this.aMf = false;
  }
  ...
  /* Error */
  private java.io.FileOutputStream oV()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 57	com/google/android/gms/common/data/BitmapTeleporter:aMg	Ljava/io/File;
    //   4: ifnonnull +13 -> 17
    ...
    //   19: ldc 68
    //   21: aload_0
    //   22: getfield 57	com/google/android/gms/common/data/BitmapTeleporter:aMg	Ljava/io/File;
    ...
    //   45: putfield 36	com/google/android/gms/common/data/BitmapTeleporter:aMc	Landroid/os/ParcelFileDescriptor;
    //   48: aload_1
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    if (this.aMc == null)
    {
      ...
      localObject = new DataOutputStream(oV());
    }
    try
    {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/google/android/gms/common/data/BitmapTeleporter.class
