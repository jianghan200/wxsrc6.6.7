...
public class Grammar
{
  ...
  private String a()
  {
    ...
    for (;;)
    {
      if (i >= this.e.size())
      {
        ...
        ((d)this.e.get(i)).bgp = a(((d)this.e.get(i)).userName);
        ((d)this.e.get(i)).bgq = a(((d)this.e.get(i)).bgn);
        ((d)this.e.get(i)).bgr = a(((d)this.e.get(i)).bgo);
        i += 1;
        break;
      }
  ...
  public int checkFiles(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      int j = this.a.f("/vendor/lib/", paramString2, paramString3);
      i = j;
      if (j >= 0) {}
    }
    for (int i = this.a.d(paramContext, paramString1, paramString2, paramString3);; i = this.a.f(paramString1, paramString2, paramString3))
    {
      if (i >= 0) {
        break label117;
      }
  ...
  public int getResult(a parama)
  {
    ...
    for (;;)
    {
      ...
      if (((d)this.e.get(j)).bgp.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).bgq.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).bgr.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/qq/wx/voice/embed/recognizer/Grammar.class
