...
public final class sg
{
  ...
  public sg(sl paramsl)
  {
    if (this.f.getAndIncrement() == 0) {
      a(sn.j());
    }
    this.d = sl.a();
    this.e = new WeakReference(paramsl);
  }
      ...
      try
      {
        ...
        while (i < paramString.length())
        {
          ...
          while (j < ((JSONArray)localObject2).length())
          {
            ...
            ((List)localObject1).add(new rp(n, i1, localJSONObject.getString("logo_name"), localJSONObject.getString("logo"), str));
            j += 1;
          }
          a.add(new rq(k, m, (List)localObject1));
          i += 1;
        }
        return;
      }
  ...
  private boolean a(String paramString, Bitmap paramBitmap)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   18: aload_0
    //   19: aload_1
    //   20: invokespecial 161	com/tencent/tencentmap/mapsdk/a/sg:b	(Ljava/lang/String;)Ljava/lang/String;
    //   23: astore_1
    ...
    //   39: ifeq +18 -> 57
    //   42: aconst_null
    //   43: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   46: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   76: istore_3
    //   77: aload_1
    //   78: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   81: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   94: astore_1
    //   95: aload_1
    //   96: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   99: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   113: astore_2
    //   114: aload_2
    //   115: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   118: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  {
    // Byte code:
    //   0: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   13: aload_0
    //   14: aload_1
    //   15: invokespecial 161	com/tencent/tencentmap/mapsdk/a/sg:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   28: ifne +18 -> 46
    //   31: aconst_null
    //   32: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   35: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   59: astore_3
    //   60: aload_1
    //   61: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   64: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   77: astore_1
    //   78: aload_1
    //   79: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   82: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   95: astore_3
    //   96: aload_3
    //   97: invokestatic 173	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/io/Closeable;)V
    //   100: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  public final void a()
  {
    ...
    //   9: getstatic 35	com/tencent/tencentmap/mapsdk/a/sg:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   12: invokevirtual 241	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   15: new 163	java/io/File
    //   18: dup
    //   19: aload_0
    //   20: invokespecial 195	com/tencent/tencentmap/mapsdk/a/sg:d	()Ljava/lang/String;
    ...
    //   45: aload_0
    //   46: getfield 72	com/tencent/tencentmap/mapsdk/a/sg:d	Landroid/content/Context;
    ...
    //   72: ifeq +25 -> 97
    //   75: new 249	com/tencent/tencentmap/mapsdk/a/sg$2
    //   78: dup
    //   79: aload_0
    //   80: aload_2
    //   81: invokespecial 252	com/tencent/tencentmap/mapsdk/a/sg$2:<init>	(Lcom/tencent/tencentmap/mapsdk/a/sg;Ljava/io/File;)V
    //   84: invokevirtual 255	com/tencent/tencentmap/mapsdk/a/sg$2:start	()V
    //   87: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   101: invokestatic 260	com/tencent/tencentmap/mapsdk/a/rv:a	(Ljava/lang/String;)Z
    //   104: pop
    //   105: goto -18 -> 87
    //   108: astore_1
    //   109: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   118: return
    //   119: astore_1
    //   120: getstatic 40	com/tencent/tencentmap/mapsdk/a/sg:g	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
  ...
  public final void a(rr paramrr)
  {
    ...
    do
    {
      ...
      localObject1 = (rq)((Iterator)localObject2).next();
    } while ((f1 < ((rq)localObject1).a()) || (f1 > ((rq)localObject1).b()));
    for (;;)
    {
      ...
      {
        return;
        localObject1 = ((rq)localObject1).a(paramrr);
        paramrr = localObject1[0];
        localObject1 = localObject1[1];
        if (paramrr != this.c) {}
        for (int i = 1; i != 0; i = 0)
        {
          localObject2 = (Bitmap)b.get(paramrr);
          ...
          ((sl)this.e.get()).a((Bitmap)localObject2);
          this.c = paramrr;
          return;
        }
      }
      ...
      this.c = null;
      new sg.1(this, (String)localObject1, paramrr).start();
      return;
      localObject1 = null;
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/tencentmap/mapsdk/a/sg.class
