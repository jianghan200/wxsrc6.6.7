...
public class bw
{
  ...
  public static ai<ArrayList<bb>, ArrayList<bb>> a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    String str = a(paramString);
    if (str == null) {
      ax.a("can not find cacheServerData " + paramString);
    }
    for (;;)
    {
      return null;
      ...
      try
      {
        ai localai = al.a(paramString, paramInt1, paramInt2, paramInt3, str);
        return localai;
      }
      catch (Exception localException)
      {
        ax.a("read cacheServerData " + paramString + " serviceList error " + str, localException);
      }
    }
  }
  
  public static lb a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    String str;
    int i;
    ...
    for (;;)
    {
      ...
      return new lb(paramString6, paramString9, paramString3, paramString4, paramString5, paramInt1, paramInt2, paramString2, paramString7, paramString8, "");
  ...
  public static void a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 32	com/tencent/tencentmap/mapsdk/a/bw:c	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   20: aconst_null
    //   21: astore_1
    //   22: invokestatic 210	com/tencent/tencentmap/mapsdk/a/bw:d	()Ljava/io/InputStream;
    //   25: astore_3
    //   26: aload_3
    //   27: astore_1
    //   28: aload_3
    //   29: astore_2
    //   30: getstatic 27	com/tencent/tencentmap/mapsdk/a/bw:b	Ljava/util/Properties;
    //   33: aload_3
    ...
    //   52: aload_3
    //   53: astore_2
    //   54: getstatic 27	com/tencent/tencentmap/mapsdk/a/bw:b	Ljava/util/Properties;
    ...
    //   143: aload_1
    //   144: astore_2
    //   145: new 250	com/tencent/tencentmap/mapsdk/a/bl
    //   148: dup
    //   149: new 77	java/lang/StringBuilder
    //   152: dup
    //   153: ldc -4
    //   155: invokespecial 80	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   158: getstatic 20	com/tencent/tencentmap/mapsdk/a/bw:a	Ljava/lang/String;
    ...
    //   176: invokespecial 258	com/tencent/tencentmap/mapsdk/a/bl:<init>	(Ljava/lang/String;)V
    //   179: athrow
    //   180: astore_1
    //   181: aload_2
    //   182: ifnull +7 -> 189
    ...
    //   240: aload_3
    //   241: astore_2
    //   242: getstatic 27	com/tencent/tencentmap/mapsdk/a/bw:b	Ljava/util/Properties;
    //   245: aload 5
    ...
    //   268: getstatic 20	com/tencent/tencentmap/mapsdk/a/bw:a	Ljava/lang/String;
    ...
    //   277: invokestatic 91	com/tencent/tencentmap/mapsdk/a/ax:a	(Ljava/lang/String;)V
    //   280: aload_3
    //   281: astore_1
    //   282: aload_3
    //   283: astore_2
    //   284: getstatic 32	com/tencent/tencentmap/mapsdk/a/bw:c	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   287: iconst_1
  ...
  public static void c()
  {
    ...
    //   4: aload_1
    //   5: astore_0
    //   6: invokestatic 139	com/tencent/tencentmap/mapsdk/a/bw:a	()V
    //   9: aload_1
    //   10: astore_0
    //   11: new 183	java/io/File
    //   14: dup
    //   15: getstatic 20	com/tencent/tencentmap/mapsdk/a/bw:a	Ljava/lang/String;
    ...
    //   55: astore_1
    //   56: getstatic 27	com/tencent/tencentmap/mapsdk/a/bw:b	Ljava/util/Properties;
    //   59: aload_1
    ...
    //   83: getstatic 20	com/tencent/tencentmap/mapsdk/a/bw:a	Ljava/lang/String;
    ...
    //   92: invokestatic 91	com/tencent/tencentmap/mapsdk/a/ax:a	(Ljava/lang/String;)V
    //   95: aload_1
    ...
    //   117: getstatic 20	com/tencent/tencentmap/mapsdk/a/bw:a	Ljava/lang/String;
    ...
    //   132: aload_2
    //   133: invokestatic 105	com/tencent/tencentmap/mapsdk/a/ax:a	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   136: aload_1
    //   137: ifnull -38 -> 99
    //   140: aload_1
  ...
  {
    File localFile = new File(a("TafUtils.class", bw.class));
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/tencentmap/mapsdk/a/bw.class
