...
public final class mg
{
  ...
  public static int a(mf[] paramArrayOfmf)
  {
    int k;
    if (paramArrayOfmf == null)
    {
      k = 629;
      return k;
    }
    ...
    {
      k = i;
      if (j >= paramArrayOfmf.length) {
        break;
      }
      i = i * 37 + paramArrayOfmf[j].hashCode();
      j += 1;
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/tencentmap/mapsdk/a/mg.class
