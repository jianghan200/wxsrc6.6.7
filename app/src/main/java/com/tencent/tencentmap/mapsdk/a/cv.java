...
public final class cv
{
  ...
  public cv(byte[] paramArrayOfByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
  }
  
  public cv(byte[] paramArrayOfByte, byte paramByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
    this.a.position(4);
  }
  ...
  private cx a(cx paramcx, int paramInt, boolean paramBoolean)
  {
    a locala = null;
    if (a(paramInt))
    {
      try
      {
        paramcx = (cx)paramcx.getClass().newInstance();
        locala = new a();
        a(locala, this.a);
        if (locala.a != 10) {
          throw new RuntimeException("type mismatch.");
      ...
      {
        throw new RuntimeException(paramcx.getMessage());
      }
      paramcx.a(this);
      a();
    }
  ...
  public final <T> Object a(T paramT, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramT instanceof cx)) {
      return a((cx)paramT, paramInt, paramBoolean);
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/tencentmap/mapsdk/a/cv.class
