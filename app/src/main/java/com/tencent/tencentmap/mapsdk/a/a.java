...
public class a
{
  ...
  public static String a(Context paramContext)
  {
    ...
    //   105: invokestatic 128	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   108: aload_3
    //   109: ldc 29
    ...
    //   185: invokestatic 128	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   188: aload_3
    //   189: astore 4
    //   191: ldc 29
    //   193: aload_2
    ...
    //   217: astore_0
    //   218: aload_0
    //   219: invokestatic 156	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/Throwable;)V
    //   222: aload_2
    //   223: astore_0
    //   224: goto -214 -> 10
    //   227: astore_0
    ...
    //   281: astore_3
    //   282: aload_3
    //   283: invokestatic 156	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/Throwable;)V
    //   286: goto -42 -> 244
    //   289: astore_3
    //   290: aconst_null
    //   291: astore_3
    ...
    //   331: invokestatic 188	com/tencent/tencentmap/mapsdk/a/ct:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   334: aload_2
    //   335: astore 4
    //   337: aload_3
    //   338: ifnull +71 -> 409
    ...
    //   348: astore_3
    //   349: aload_3
    //   350: invokestatic 156	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/Throwable;)V
    //   353: goto -109 -> 244
    //   356: astore_0
    //   357: aconst_null
    //   358: astore_2
    ...
    //   369: astore_2
    //   370: aload_2
    //   371: invokestatic 156	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/Throwable;)V
    //   374: goto -7 -> 367
    //   377: astore_0
    //   378: ldc -66
    //   380: iconst_0
    //   381: anewarray 4	java/lang/Object
    //   384: invokestatic 128	com/tencent/tencentmap/mapsdk/a/ct:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   387: aload_2
    //   388: astore_0
    //   389: goto -379 -> 10
    //   392: astore_0
  ...
  private static boolean e(Context paramContext, String paramString)
  {
    ...
    {
      ct.a(paramContext);
      ct.d("Failed to judge }[%s]", new Object[] { paramContext.getLocalizedMessage() });
    }
  }
  ...
  private static String j(Context paramContext)
  {
    ...
    for (Object localObject = null;; localObject = paramContext.getPackageName())
    {
      ...
      catch (Exception paramContext)
      {
        for (;;)
        {
          int m;
          ct.a(paramContext);
          ct.d(paramContext.toString(), new Object[0]);
          paramContext = "";
        }
      }
      finally {}
    ...
    for (int j = 0;; j = k)
    {
      ...
      else
      {
        if (j < 3)
        {
          ct.a("add versionCode: %s", new Object[] { Integer.valueOf(m) });
          paramContext = paramContext + "." + m;
        }
        for (;;)
        {
          ct.a("version: %s", new Object[] { paramContext });
          break;
        }
      }
      i += 1;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/tencentmap/mapsdk/a/a.class
