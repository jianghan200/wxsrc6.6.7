...
public final class a
{
  ...
  public static String act(String paramString)
  {
    ...
    //   264: invokestatic 124	com/tencent/c/f/h:cE	(Ljava/lang/Object;)V
    //   267: aload_0
    //   268: ifnull +7 -> 275
    //   271: aload_0
  ...
  public static List<byte[]> bJ(Context paramContext, String paramString)
  {
      ...
      if ((paramContext != null) && (paramContext.signatures != null) && (paramContext.signatures.length > 0))
      {
        ...
        for (;;)
        {
          if ((i < paramContext.length) && (i < 5))
          {
            ...
            try
            {
              localArrayList.add(e.bO(paramString.getEncoded()));
              i += 1;
            }
            catch (CertificateEncodingException paramString)
            {
              for (;;)
              {
                h.cE("extractPkgCertMd5s(), CertificateEncodingException: " + paramString);
              }
            }
          }
        }
    ...
    {
      h.cE("extractPkgCertMd5s(), Exception: " + paramContext);
    }
  }
  
  public static com.tencent.c.a.a bK(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      {
        paramContext = e.bO(paramContext.getEncoded());
        if (paramContext == null) {}
        for (paramContext = null;; paramContext = paramString.toString())
        {
          locala.vhN = paramContext;
          return locala;
  ...
  public static List<com.tencent.c.a.a> hs(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i = 1;
        locala = bK(paramContext, localApplicationInfo.packageName);
        locala.vhM = localPackageManager.getApplicationLabel(localApplicationInfo).toString();
        if (locala.vhM != null) {
          break label238;
        }
        locala.vhM = "";
      ...
      catch (Throwable paramContext)
      {
        ...
        h.cD("getAllAppInfos(), exception: " + paramContext);
      }
      locala.dPU = i;
      locala.fileSize = new File(localApplicationInfo.sourceDir).length();
      locala.vhO = localApplicationInfo.sourceDir;
      localArrayList.add(locala);
      h.cF("add app: " + localApplicationInfo.packageName);
      continue;
      label226:
      return localArrayList;
      label228:
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/c/f/a.class
