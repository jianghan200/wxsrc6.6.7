...
public class TXCYuvTextureRender
{
  ...
  public void drawFrame(long paramLong)
  {
    ...
    if (this.mVideoWidth % 8 != 0)
    {
      ...
      if (i != 0) {
        Matrix.scaleM(this.mTextureMatrix, 0, (this.mVideoWidth - 1) * 1.0F / i, 1.0F, 1.0F);
      }
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/liteav/renderer/TXCYuvTextureRender.class
