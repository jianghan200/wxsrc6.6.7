  ...
  extends TXIStreamDownloader
{
  ...
  public void startDownload(Vector<d> paramVector, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (this.mIsRunning) {}
    ...
    this.mPlayUrl = ((d)paramVector.get(0)).a;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/liteav/network/TXCFLVDownloader.class
