...
public class TXEAudioDef
{
  ...
  static
  {
    ...
    TXE_AUDIO_PLAY_ERR_INVALID_STATE = -101;
    TXE_AUDIO_PLAY_ERR_AUDIO_TYPE_NOT_SUPPORT = -102;
    TXE_AUDIO_PLAY_ERR_START_HW_DECODEC_FAILED = -103;
    TXE_AUDIO_PLAY_ERR_REPEAT_OPTION = -104;
    TXE_AUDIO_PLAY_ERR_NOT_CREATE_JIT = -105;
    TXE_AUDIO_RECORD_ERR_CUR_RECORDER_INVALID = -106;
    TXE_AUDIO_COMMON_ERR_OK = 0;
    TXE_AUDIO_COMMON_ERR_INVALID_PARAMS = 64635;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/liteav/audio/TXEAudioDef.class
