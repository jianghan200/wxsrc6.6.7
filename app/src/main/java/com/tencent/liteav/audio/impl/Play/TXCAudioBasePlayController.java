  ...
  implements d
{
  ...
  protected int mIsSmoothMode = com.tencent.liteav.audio.b.g;
  ...
  public void enableSmootheMode(int paramInt)
  {
    if (paramInt == this.mIsSmoothMode) {
      return;
    }
    TXCLog.i(TAG, "set careful mode to " + paramInt);
    this.mIsSmoothMode = paramInt;
    nativeEnableSmoothMode(this.mJitterBuffer, paramInt);
  }
  ...
  protected native void nativeEnableSmoothMode(long paramLong, int paramInt);
  ...
  public int stopPlay()
  {
    ...
    this.mIsSmoothMode = com.tencent.liteav.audio.b.g;
    return TXEAudioDef.TXE_AUDIO_PLAY_ERR_OK;
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/liteav/audio/impl/Play/TXCAudioBasePlayController.class
