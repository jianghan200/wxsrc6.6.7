  ...
  extends Resources
{
  ...
  private final b<WeakReference<Drawable.ConstantState>> dfM;
  
  private Drawable a(TypedValue paramTypedValue, int paramInt)
  {
    try
    {
      Drawable localDrawable1 = (Drawable)this.dfJ.invoke(this.dfI, new Object[] { paramTypedValue, Integer.valueOf(paramInt) });
    ...
    catch (StackOverflowError localStackOverflowError)
    {
      ...
      catch (Exception localException1)
      {
        ...
        Iterator localIterator = this.dfL.entrySet().iterator();
  ...
  private Drawable a(ZipFile paramZipFile, TypedValue paramTypedValue)
  {
    ...
    //   39: lstore 4
    //   41: aload_0
    //   42: getfield 136	com/tencent/mm/compatible/loader/PluginResourceLoader:dfM	Lcom/tencent/mm/compatible/loader/b;
    //   45: astore 6
    //   47: aload 6
    //   49: getfield 142	com/tencent/mm/compatible/loader/b:tC	[J
    //   52: aload 6
    //   54: getfield 145	com/tencent/mm/compatible/loader/b:fi	I
    //   57: lload 4
    ...
    //   64: iflt +16 -> 80
    //   67: aload 6
    //   69: getfield 152	com/tencent/mm/compatible/loader/b:tD	[Ljava/lang/Object;
    //   72: iload_3
    //   73: aaload
    //   74: getstatic 156	com/tencent/mm/compatible/loader/b:tA	Ljava/lang/Object;
    //   77: if_acmpne +56 -> 133
    //   80: aconst_null
    //   81: astore 6
    //   83: aload 6
    ...
    //   123: ldc 43
    //   125: ldc -87
    //   127: invokestatic 172	com/tencent/mm/sdk/platformtools/x:v	(Ljava/lang/String;Ljava/lang/String;)V
    //   130: aload 6
    //   132: areturn
    //   133: aload 6
    //   135: getfield 152	com/tencent/mm/compatible/loader/b:tD	[Ljava/lang/Object;
    //   138: iload_3
    //   139: aaload
    //   140: astore 6
    //   142: goto -59 -> 83
    //   145: aload_0
    //   146: getfield 136	com/tencent/mm/compatible/loader/PluginResourceLoader:dfM	Lcom/tencent/mm/compatible/loader/b;
    //   149: astore 6
    //   151: aload 6
    //   153: getfield 142	com/tencent/mm/compatible/loader/b:tC	[J
    //   156: aload 6
    //   158: getfield 145	com/tencent/mm/compatible/loader/b:fi	I
    //   161: lload 4
    ...
    //   168: iflt +32 -> 200
    //   171: aload 6
    //   173: getfield 152	com/tencent/mm/compatible/loader/b:tD	[Ljava/lang/Object;
    //   176: iload_3
    //   177: aaload
    //   178: getstatic 156	com/tencent/mm/compatible/loader/b:tA	Ljava/lang/Object;
    //   181: if_acmpeq +19 -> 200
    //   184: aload 6
    //   186: getfield 152	com/tencent/mm/compatible/loader/b:tD	[Ljava/lang/Object;
    //   189: iload_3
    //   190: getstatic 156	com/tencent/mm/compatible/loader/b:tA	Ljava/lang/Object;
    //   193: aastore
    //   194: aload 6
    //   196: iconst_1
    //   197: putfield 176	com/tencent/mm/compatible/loader/b:tB	Z
    //   200: aconst_null
    //   201: astore 6
    //   203: goto -85 -> 118
    //   206: aload_2
    ...
    //   240: aastore
    //   241: invokestatic 184	com/tencent/mm/sdk/platformtools/x:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   244: aload 6
    //   246: astore 7
    //   248: aload_1
    //   249: aload 10
    ...
    //   364: ifnull -345 -> 19
    //   367: aload_0
    //   368: getfield 136	com/tencent/mm/compatible/loader/PluginResourceLoader:dfM	Lcom/tencent/mm/compatible/loader/b;
    //   371: lload 4
  ...
  private XmlResourceParser b(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    try
    {
      paramString1 = (XmlResourceParser)this.dfK.invoke(this.dfI, new Object[] { paramString1, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramString2 });
      return paramString1;
    }
    catch (Exception paramString1)
    {
      x.printErrStackTrace("MicroMsg.PluginResourceLoader", paramString1, "", new Object[0]);
    }
    return null;
  }
  ...
  private static InputStream b(ZipFile paramZipFile, TypedValue paramTypedValue)
  {
    ...
    try
    {
      x.d("MicroMsg.PluginResourceLoader", "try load stream from zip, entry=%s, file=%s", new Object[] { paramTypedValue, paramZipFile.getName() });
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/compatible/loader/PluginResourceLoader.class
