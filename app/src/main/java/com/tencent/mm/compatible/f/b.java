...
public final class b
{
  ...
  public static boolean bv(Context paramContext)
  {
    ...
    while (i < 19) {
      try
      {
        ...
        x.i("MicroMsg.PermissionUtil", "isFloatWindowOpAllowed allowed: " + bool1);
        return bool1;
      }
      catch (Exception paramContext)
      {
        x.e("MicroMsg.PermissionUtil", "getDeclaredMethod:canDrawOverlays! Error:%s, etype:%s", new Object[] { paramContext.getMessage(), paramContext.getClass().getCanonicalName() });
        return true;
      }
    }
    Object localObject = ad.getContext().getSystemService("appops");
    try
    {
      ...
      try
      {
        i = ((Integer)paramContext.invoke(localObject, new Object[] { Integer.valueOf(24), Integer.valueOf(ad.getContext().getApplicationInfo().uid), ad.getPackageName() })).intValue();
        if (i != 0) {
          break label280;
        }
        bool1 = true;
      ...
      catch (Exception paramContext)
      {
        for (;;)
        {
          x.e("MicroMsg.PermissionUtil", "call checkOp failed: %s etype:%s", new Object[] { paramContext.getMessage(), paramContext.getClass().getCanonicalName() });
          bool1 = bool2;
        }
      }
      x.i("MicroMsg.PermissionUtil", "isFloatWindowOpAllowed allowed: " + bool1);
    ...
    catch (NoSuchMethodException paramContext)
    {
      for (;;)
      {
        x.e("MicroMsg.PermissionUtil", "NoSuchMethodException method:checkOp! Error:%s", new Object[] { paramContext.getMessage() });
        paramContext = null;
      }
    }
    catch (ClassNotFoundException paramContext)
    {
      for (;;)
      {
        x.e("MicroMsg.PermissionUtil", "ClassNotFoundException class:android.app.AppOpsManager! Error:%s", new Object[] { paramContext.getMessage() });
        paramContext = null;
        continue;
        label280:
        bool1 = false;
  ...
  private static boolean fQ(int paramInt)
  {
    ...
    //   4: iconst_1
    //   5: ireturn
    //   6: invokestatic 165	com/tencent/mm/sdk/platformtools/ad:getContext	()Landroid/content/Context;
    //   9: ldc -89
    ...
    //   68: dup
    //   69: iconst_1
    //   70: invokestatic 165	com/tencent/mm/sdk/platformtools/ad:getContext	()Landroid/content/Context;
    ...
    //   83: dup
    //   84: iconst_2
    //   85: invokestatic 203	com/tencent/mm/sdk/platformtools/ad:getPackageName	()Ljava/lang/String;
    //   88: aastore
    ...
    //   117: aastore
    //   118: invokestatic 159	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   121: iconst_0
    //   122: ireturn
    //   123: astore_1
    //   124: ldc 73
    ...
    //   138: aastore
    //   139: invokestatic 159	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   142: aconst_null
    //   143: astore_1
    //   144: goto -93 -> 51
    //   147: astore_1
    ...
    //   162: aastore
    //   163: invokestatic 159	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   166: aconst_null
    //   167: astore_1
    //   168: goto -117 -> 51
    //   171: astore_1
    ...
    //   186: aastore
    //   187: invokestatic 159	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: iconst_m1
    //   191: istore_0
    //   192: goto -93 -> 99
    //   195: iconst_1
  ...
  {
    return (bi.aG(Build.VERSION.INCREMENTAL, "").toLowerCase().contains("flyme")) || (bi.aG(Build.DISPLAY, "").toLowerCase().contains("flyme"));
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/compatible/f/b.class
