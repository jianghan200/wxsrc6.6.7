...
public final class j
{
  public static char a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong, int paramInt1, byte[] paramArrayOfByte3, int paramInt2)
  {
    ...
    locali4.bwe = 0;
    locali4.bwd = locali3.bwd;
    locali5.bwe = 28;
    locali5.bwd = locali3.bwd;
    locali6.bwe = 0;
    locali6.bwd = locali8.bwd;
    locali7.bwe = 32;
    locali7.bwd = locali8.bwd;
    a(locali2, 24);
    ...
    paramInt1 = paramArrayOfByte2.bwe;
    i = paramArrayOfByte1.bwe;
    if (paramInt2 == 0)
    {
    ...
    paramArrayOfByte2.bwe = paramInt1;
    paramArrayOfByte1.bwe = i;
    return '\001';
  }
  ...
  private static void a(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      byte[] arrayOfByte = parami1.bwd;
      int j = parami1.bwe + i;
      arrayOfByte[j] = ((byte)(arrayOfByte[j] ^ parami2.bwd[(parami2.bwe + i)]));
      i += 1;
    }
  }
  ...
  private static void a(i parami1, i parami2, i parami3)
  {
    ...
    while (i < 8)
    {
      parami1.bwd[(parami1.bwe + i)] = ((byte)(parami2.bwd[(parami2.bwe + i)] ^ parami3.bwd[(parami3.bwe + i)]));
      i += 1;
    }
  }
  ...
  private static void a(i parami1, i parami2, i parami3, i parami4)
  {
    ...
    parami2 = new byte[][] { { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7 }, { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 }, { 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 }, { 15, 12, 8, 2, 4, 9, 1, 7, 5, 11, 3, 14, 10, 0, 6, 13 } };
    ...
    localObject2 = new byte[][] { { 7, 13, 14, 3, 0, 6, 9, 10, 1, 2, 8, 5, 11, 12, 4, 15 }, { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 }, localObject2, localObject3 };
    localObject3 = new byte[][] { { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 }, { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 }, { 4, 2, 1, 11, 10, 13, 7, 8, 15, 9, 12, 5, 6, 3, 0, 14 }, { 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9, 10, 4, 5, 3 } };
    byte[][] arrayOfByte2 = { { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 }, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, { 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 1, 13, 11, 6 }, { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 } };
    Object localObject4 = { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 };
    Object localObject5 = { 13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 6 };
    byte[] arrayOfByte = { 6, 11, 13, 8, 1, 4, 10, 7, 9, 5, 0, 15, 14, 2, 3, 12 };
    localObject4 = new byte[][] { localObject4, localObject5, { 1, 4, 11, 13, 12, 3, 7, 14, 10, 15, 6, 8, 0, 5, 9, 2 }, arrayOfByte };
    localObject5 = new byte[][] { { 13, 2, 8, 4, 6, 15, 11, 1, 10, 9, 3, 14, 5, 0, 12, 7 }, { 1, 15, 13, 8, 10, 3, 7, 4, 12, 5, 6, 11, 0, 14, 9, 2 }, { 7, 11, 4, 1, 9, 12, 14, 2, 0, 6, 10, 13, 15, 3, 5, 8 }, { 2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11 } };
    int j = parami3.bwe;
    int k = parami1.bwe;
    while (i < 8)
    {
      int m = (byte)((parami3.bwd[(parami3.bwe + 0)] << 1) + parami3.bwd[(parami3.bwe + 5)]);
      int n = (byte)((parami3.bwd[(parami3.bwe + 1)] << 3) + (parami3.bwd[(parami3.bwe + 2)] << 2) + (parami3.bwd[(parami3.bwe + 3)] << 1) + parami3.bwd[(parami3.bwe + 4)]);
      b(parami1, new i(new byte[][][] { parami2, arrayOfByte1, localObject1, localObject2, localObject3, arrayOfByte2, localObject4, localObject5 }[i][m][n]), 4);
      i = (byte)(i + 1);
      parami3.bwe += 6;
      parami1.bwe += 4;
    }
  ...
  private static void a(i parami1, i parami2, byte[] paramArrayOfByte, int paramInt, i parami3)
  {
    ...
    while (i < paramInt)
    {
      parami3.bwd[(parami3.bwe + i)] = parami2.bwd[(parami2.bwe + paramArrayOfByte[i] - 1)];
      i += 1;
    }
  ...
  private static void a(i parami1, i parami2, i[] paramArrayOfi, int paramInt, i parami3, i parami4, i parami5, i parami6, i parami7, i parami8)
  {
    ...
    {
      parami2 = parami1.bwd;
      int i = parami1.bwe + (paramInt >> 3);
      parami2[i] = ((byte)(parami2[i] | parami3.bwd[(parami3.bwe + paramInt)] << (paramInt & 0x7)));
      paramInt += 1;
    }
  }
  ...
  private static void b(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      parami1.bwd[(parami1.bwe + i)] = ((byte)(parami2.bwd[((i >> 3) + parami2.bwe)] >> (i & 0x7) & 0x1));
      i += 1;
    }
  }
  ...
  private static void c(i parami1, i parami2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      parami1.bwd[(parami1.bwe + i)] = parami1.bwd[(parami1.bwe + i + paramInt)];
      i += 1;
    }
    while (j < paramInt)
    {
      parami1.bwd[(parami1.bwe + j + 28 - paramInt)] = parami2.bwd[(parami2.bwe + j)];
      j += 1;
    }
  }
  ...
  private static void d(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      parami1.bwd[(parami1.bwe + i)] = parami2.bwd[(parami2.bwe + i)];
      i += 1;
    }
  }
}
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/a/j.class
