  ...
  implements b
{
  ...
  private boolean od(String paramString)
  {
    ...
    {
      Assert.assertTrue(bool);
      x.d("MicroMsg.SpxFileOperator", "Open file:" + this.aBA + " mode:" + paramString);
      try
      {
      ...
      {
        x.e("MicroMsg.SpxFileOperator", "ERR: OpenFile[" + this.fileName + "] failed:[" + paramString.getMessage() + "]");
        this.aBA = null;
      }
      bool = false;
      break;
  ...
  public final g br(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      x.d("MicroMsg.SpxFileOperator", "DBG: ReadFile[" + this.fileName + "] readOffset:" + paramInt1 + " readRet:" + i + " fileNow:" + this.aBA.getFilePointer() + " fileSize:" + l);
      paramInt2 = i;
      if (i < 0) {
        paramInt2 = 0;
      }
    ...
    {
      x.e("MicroMsg.SpxFileOperator", "ERR: ReadFile[" + this.fileName + "] Offset:" + paramInt1 + "  failed:[" + localException.getMessage() + "] ");
      Tz();
      localg.ret = -1;
    }
    return localg;
  ...
  public final int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        x.e("MicroMsg.SpxFileOperator", "ERR: WriteFile[" + this.fileName + "] Offset:" + paramInt2 + " failed:[" + paramArrayOfByte.getMessage() + "]");
        Tz();
        return -3;
      }
      bool1 = false;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/modelvoice/l.class
