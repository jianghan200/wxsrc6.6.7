...
public final class c
{
  ...
  {
    String str = ((a)g.l(a.class)).AT().getValue("VoiceVOIPSwitch");
    x.d("MicroMsg.ConfigListDecoder", "voip is " + str);
    try
    {
      i = bi.getInt(str, 0);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        x.e("MicroMsg.ConfigListDecoder", "exception:%s", new Object[] { bi.i(localException) });
        int i = 0;
      }
    }
  }
  
  public static String fU(int paramInt)
  {
    return dgQ + "config_" + paramInt + ".xml";
  }
  ...
  private void load(int paramInt)
  {
    ...
    //   3: dup
    //   4: iload_1
    //   5: invokestatic 112	com/tencent/mm/k/c:fU	(I)Ljava/lang/String;
    ...
    //   106: iconst_0
    //   107: aload 4
    //   109: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   112: aastore
    //   113: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   116: aload_3
    //   117: ifnull +7 -> 124
    //   120: aload_3
    ...
    //   134: invokevirtual 153	com/tencent/mm/k/c:p	(ILjava/lang/String;)V
    //   137: aload_3
    //   138: astore_2
    //   139: aload 4
    ...
    //   170: iconst_0
    //   171: aload_2
    //   172: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   175: aastore
    //   176: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   179: return
    //   180: astore_2
    //   181: ldc 66
    //   183: ldc 90
    ...
    //   190: iconst_0
    //   191: aload_2
    //   192: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   195: aastore
    //   196: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   199: return
    //   200: astore_3
    //   201: aconst_null
    //   202: astore_2
    ...
    //   223: iconst_0
    //   224: aload_2
    //   225: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   228: aastore
    //   229: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   232: goto -21 -> 211
    //   235: astore_3
    //   236: goto -33 -> 203
    //   239: astore 4
  ...
  public final boolean AG()
  {
    ...
    for (;;)
    {
      x.d("MicroMsg.ConfigListDecoder", "disableWePkg : " + bool);
      return bool;
      bool = false;
    }
  }
  ...
  {
    String str = G("FreeWiFiConfig", "CheckURL");
    x.d("MicroMsg.ConfigListDecoder", "get check url for free wifi : %s", new Object[] { str });
    return str;
  }
  ...
  public final boolean AI()
  {
    ...
    for (;;)
    {
      x.d("MicroMsg.ConfigListDecoder", "isShowRecvTmpMsgBtn : " + bool);
      return bool;
      bool = false;
    }
  }
  ...
  public final List<String> AJ()
  {
    ...
    Object localObject3 = G("IBeacon", "Content");
    if (!bi.oW((String)localObject3))
    {
      ...
      {
        x.e("MicroMsg.ConfigListDecoder", "[oneliang] json parse exception: " + localJSONException.getMessage());
  ...
  public final String G(String paramString1, String paramString2)
  {
    d locald = AE();
    if (locald == null) {}
    while (!locald.dgS.containsKey(paramString1)) {
      return null;
    }
    return (String)((HashMap)locald.dgS.get(paramString1)).get(paramString2);
  }
  ...
  public final boolean d(java.io.File paramFile1, java.io.File paramFile2)
  {
    ...
    //   76: invokevirtual 292	com/tencent/mm/k/c:d	(Ljava/io/File;Ljava/io/File;)Z
    //   79: istore 4
    //   81: iload 4
    //   83: ifeq +8 -> 91
    //   86: aload_1
    ...
    //   196: iconst_0
    //   197: aload 8
    //   199: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   202: aastore
    //   203: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: aload 6
    //   208: ifnull +8 -> 216
    //   211: aload 6
    ...
    //   240: iconst_0
    //   241: aload_1
    //   242: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   245: aastore
    //   246: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   249: iconst_0
    //   250: ireturn
    //   251: aload 8
    //   253: astore 7
    ...
    //   297: iconst_0
    //   298: aload_1
    //   299: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   302: aastore
    //   303: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   306: goto -26 -> 280
    //   309: astore_1
    //   310: ldc 66
    //   312: ldc 90
    ...
    //   319: iconst_0
    //   320: aload_1
    //   321: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   324: aastore
    //   325: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   328: goto -43 -> 285
    //   331: astore_2
    //   332: ldc 66
    //   334: ldc 90
    ...
    //   341: iconst_0
    //   342: aload_2
    //   343: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   346: aastore
    //   347: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   350: goto -134 -> 216
    //   353: astore_1
    //   354: aconst_null
    //   355: astore 7
    ...
    //   389: iconst_0
    //   390: aload_2
    //   391: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   394: aastore
    //   395: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   398: goto -31 -> 367
    //   401: astore_2
    //   402: ldc 66
    //   404: ldc 90
    ...
    //   411: iconst_0
    //   412: aload_2
    //   413: invokestatic 94	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   416: aastore
    //   417: invokestatic 98	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   420: goto -43 -> 377
    //   423: astore_1
    //   424: aconst_null
    //   425: astore 7
  ...
  public final void p(int paramInt, String paramString)
  {
    ...
    locald.dgT = bl.z(paramString, "ConfigList");
    if (locald.dgT.containsKey(".ConfigList.$version")) {
      locald.version = Integer.valueOf((String)locald.dgT.get(".ConfigList.$version")).intValue();
    }
    int i = 0;
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        if (locald.dgT.get((String)localObject1 + ".$name") == null) {
          break;
        }
        str = (String)locald.dgT.get((String)localObject1 + ".$name");
      ...
      for (paramString = "";; paramString = Integer.valueOf(j))
      {
        ...
        if (!locald.dgT.containsKey(localObject2)) {
          break label529;
        }
        localObject3 = (String)locald.dgT.get(localObject3);
        localObject2 = (String)locald.dgT.get(localObject2);
        paramString = (String)locald.dgT.get(paramString);
        x.d("MicroMsg.ConfigListInfo", "itemKey " + (String)localObject3 + " itemValue " + (String)localObject2 + " itemLang " + paramString);
        if ((paramString == null) || (d.fk(paramString)))
        {
          if (!locald.dgS.containsKey(str)) {
            locald.dgS.put(str, new HashMap());
          }
          ((HashMap)locald.dgS.get(str)).put(localObject3, localObject2);
        }
        j += 1;
        break label182;
    ...
    this.dgP.put(Integer.valueOf(paramInt).intValue(), locald);
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/k/c.class
