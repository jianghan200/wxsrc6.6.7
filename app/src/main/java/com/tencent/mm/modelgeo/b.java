  ...
  implements e
{
  ...
  private void a(Addr paramAddr)
  {
    ...
    do
    {
      ...
      if (this.dRV.tag == null)
      {
        paramAddr = new Object();
        localAddr.tag = paramAddr;
        localAddr.dRS = ((float)this.dRV.lat);
        localAddr.dRT = ((float)this.dRV.lng);
        if (!bi.oW(localAddr.dRJ))
        {
          paramAddr = ad.getContext().getResources().getString(a.h.filter_city_name);
          x.d(TAG, "city %s", new Object[] { paramAddr });
          if ((bi.fU(ad.getContext())) || (bi.oW(paramAddr)) || (!localAddr.dRJ.endsWith(paramAddr))) {
            break label251;
          }
          localAddr.dRK = localAddr.dRJ;
          localAddr.dRJ = localAddr.dRJ.substring(0, localAddr.dRJ.length() - paramAddr.length());
        }
      }
      for (;;)
      {
        paramAddr = (LinkedList)this.dRX.get(this.dRV.toString());
        if (paramAddr == null) {
          break label317;
        }
        ...
        paramAddr = this.dRV.tag;
        break;
        if ((!bi.fU(ad.getContext())) && (!bi.oW(paramAddr)) && (localAddr.dRH.indexOf(paramAddr) >= 0)) {
          localAddr.dRK = (localAddr.dRJ + paramAddr);
        } else {
          localAddr.dRK = localAddr.dRJ;
        }
      }
      ...
      this.dRV = null;
      OA();
    } while ((this.dRV != null) || (this.dRW.size() <= 0));
    g.DF().b(655, this);
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 265	com/tencent/mm/sdk/platformtools/w:chP	()Ljava/lang/String;
    //   3: astore 12
    ...
    //   71: invokestatic 284	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   74: aconst_null
    //   75: astore 10
    //   77: aconst_null
    //   78: astore 9
    ...
    //   167: invokestatic 284	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   170: aload 6
    //   172: astore 7
    //   174: aload 6
    //   176: astore 10
    ...
    //   264: ldc_w 333
    //   267: invokestatic 284	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   270: aload 6
    //   272: astore 7
    ...
    //   285: iconst_0
    //   286: aload 10
    //   288: invokestatic 339	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   291: aastore
    //   292: invokestatic 342	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   295: aload 8
    //   297: astore 7
    //   299: aload 6
    //   301: ifnull +15 -> 316
    //   304: aload 6
    //   306: getfield 346	com/tencent/mm/network/u:aBv	Ljava/net/HttpURLConnection;
    ...
    //   392: invokestatic 284	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   395: aload 6
    //   397: astore 7
    ...
    //   445: putfield 217	com/tencent/mm/modelgeo/Addr:dRH	Ljava/lang/String;
    //   448: aload 6
    //   450: astore 7
    //   452: aload 10
    //   454: iconst_0
    ...
    //   547: aload 11
    //   549: aload 10
    //   551: putfield 393	com/tencent/mm/modelgeo/Addr:dRI	Ljava/lang/String;
    //   554: goto +568 -> 1122
    //   557: aload 6
    //   559: astore 7
    //   561: aload 14
    ...
    //   576: aload 11
    //   578: aload 10
    //   580: putfield 142	com/tencent/mm/modelgeo/Addr:dRJ	Ljava/lang/String;
    //   583: goto +539 -> 1122
    //   586: aload 6
    //   588: astore 7
    //   590: aload 14
    ...
    //   605: aload 11
    //   607: aload 10
    //   609: putfield 400	com/tencent/mm/modelgeo/Addr:dRL	Ljava/lang/String;
    //   612: goto +510 -> 1122
    //   615: astore 6
    //   617: aload 7
    //   619: ifnull +11 -> 630
    //   622: aload 7
    //   624: getfield 346	com/tencent/mm/network/u:aBv	Ljava/net/HttpURLConnection;
    ...
    //   652: aload 11
    //   654: aload 10
    //   656: putfield 405	com/tencent/mm/modelgeo/Addr:dRM	Ljava/lang/String;
    //   659: goto +463 -> 1122
    //   662: aload 6
    //   664: astore 7
    //   666: aload 14
    ...
    //   681: aload 11
    //   683: aload 10
    //   685: putfield 410	com/tencent/mm/modelgeo/Addr:dRN	Ljava/lang/String;
    //   688: goto +434 -> 1122
    //   691: aload 6
    //   693: astore 7
    //   695: aload 14
    ...
    //   710: aload 11
    //   712: aload 10
    //   714: putfield 415	com/tencent/mm/modelgeo/Addr:dRO	Ljava/lang/String;
    //   717: goto +405 -> 1122
    //   720: aload 6
    //   722: astore 7
    //   724: aload 14
    ...
    //   751: astore 7
    //   753: aload 11
    //   755: getfield 217	com/tencent/mm/modelgeo/Addr:dRH	Ljava/lang/String;
    //   758: ldc_w 421
    ...
    //   933: aload 12
    //   935: aastore
    //   936: invokestatic 172	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   939: aload 6
    //   941: astore 7
    //   943: getstatic 446	com/tencent/mm/plugin/report/service/h:mEJ	Lcom/tencent/mm/plugin/report/service/h;
    //   946: sipush 12886
    //   949: bipush 7
    ...
    //   987: aload 12
    //   989: aastore
    //   990: invokevirtual 450	com/tencent/mm/plugin/report/service/h:h	(I[Ljava/lang/Object;)V
    //   993: aload 6
    //   995: getfield 346	com/tencent/mm/network/u:aBv	Ljava/net/HttpURLConnection;
    ...
    //   1024: ldc_w 452
    //   1027: invokestatic 284	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   1030: aload 6
    //   1032: astore 7
    ...
    //   1045: iconst_0
    //   1046: aload 9
    //   1048: invokestatic 339	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   1051: aastore
    //   1052: invokestatic 342	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1055: aload 8
    //   1057: astore 7
    //   1059: aload 6
    //   1061: ifnull -745 -> 316
    //   1064: aload 6
    //   1066: getfield 346	com/tencent/mm/network/u:aBv	Ljava/net/HttpURLConnection;
    ...
    //   1092: iconst_0
    //   1093: aload 6
    //   1095: invokestatic 339	com/tencent/mm/sdk/platformtools/bi:i	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   1098: aastore
    //   1099: invokestatic 342	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1102: aload 11
    //   1104: areturn
    //   1105: astore 9
    //   1107: goto -90 -> 1017
    ...
    //   1131	1	7	localException1	Exception
    //   194	920	8	localInputStreamReader	java.io.InputStreamReader
    //   78	899	9	localObject6	Object
    //   1008	39	9	localException2	Exception
    //   1105	11	9	localException3	Exception
  ...
  {
    if (paraml.getType() == 655)
    {
      paramString = ((d)paraml).OE();
      if ((paramString == null) || (paramString.dRH == null) || (paramString.dRH.equals(""))) {
        this.dRY.c(new b());
      }
    }
    else
  ...
  public final boolean a(double paramDouble1, double paramDouble2, a parama, Object paramObject)
  {
    ...
    this.dRX.put(localc.toString(), paramObject);
    parama = this.dRW.iterator();
    ...
    if ((this.dRV != null) && (localc.equals(this.dRV))) {
      return false;
    }
    this.dRW.add(localc);
    ...
    while (this.dRW.size() > 30)
    {
      ...
      parama = (c)this.dRW.removeFirst();
      if (parama != null) {
        this.dRX.remove(parama.toString());
      }
    }
    OA();
    return true;
  ...
  public final boolean a(a parama)
  {
    ...
    Object localObject3 = this.dRX.keySet().iterator();
    while (((Iterator)localObject3).hasNext())
    {
      String str = (String)((Iterator)localObject3).next();
      LinkedList localLinkedList = (LinkedList)this.dRX.get(str);
      b(localLinkedList, parama);
      this.dRX.put(str, localLinkedList);
    ...
    while (parama.hasNext())
    {
      ...
      this.dRX.remove(localObject2);
    }
    parama = this.dRW.iterator();
    while (parama.hasNext())
    {
      localObject2 = (c)parama.next();
      localObject3 = (LinkedList)this.dRX.get(((c)localObject2).toString());
      if ((localObject3 == null) || (((LinkedList)localObject3).size() == 0))
      {
        ((LinkedList)localObject1).add(localObject2);
        this.dRX.remove(((c)localObject2).toString());
      }
    }
    ...
    implements at.a
  {
    ...
    public final boolean Kr()
    {
      ...
      if ((this.dSa == null) || (this.dSa.dRH == null) || (this.dSa.dRH.equals(""))) {
        this.dSa = b.c(b.a(b.this).lat, b.a(b.this).lng, b.b(b.this));
      }
      return true;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/modelgeo/b.class
