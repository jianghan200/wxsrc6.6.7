    ...
    for (;;)
    {
      ...
      for (int j = 1;; j = 0)
      {
        if (j != 0)
        {
          ...
          ShareTinkerInternals.ie(localApplicationLike.getApplication());
          com.tencent.tinker.lib.e.b.f(localApplicationLike);
          ShareTinkerInternals.ia(localApplicationLike.getApplication());
          return;
          i = 0;
          break label74;
        }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/app/p.class
