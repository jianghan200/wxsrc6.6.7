  ...
  implements SharedPreferences
{
  ...
  private List<SoftReference<SharedPreferences.OnSharedPreferenceChangeListener>> bX;
  ...
  private MultiProcessSharedPreferences(Context paramContext, String paramString, int paramInt)
  {
    ...
    this.mMode = paramInt;
    this.sHM = paramContext.getPackageManager().isSafeMode();
  }
  ...
  private void j(String paramString, ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty()))
    {
      ...
      localIntent.setAction(Wu(paramString));
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    label381:
    int j;
    switch (this.sHN.match(paramUri))
    {
    case 8: 
    case 9: 
    default: 
    ...
    case 10: 
      ciw();
      paramUri = (Integer)this.sHO.get(paramString1);
      if (paramUri == null)
      {
        i = 0;
        j = i + 1;
        this.sHO.put(paramString1, Integer.valueOf(j));
        paramUri = (Integer)this.sHO.get(paramString1);
        if (paramUri != null) {
          break label458;
        }
    ...
    if (paramUri == null)
    {
      ...
      this.sHO.remove(paramString1);
      if (this.sHO.containsKey(paramString1)) {
        break label547;
      }
    }
    for (;;)
  ...
  public void registerOnSharedPreferenceChangeListener(SharedPreferences.OnSharedPreferenceChangeListener paramOnSharedPreferenceChangeListener)
  {
    try
    {
      ...
      {
        this.bX.add(new SoftReference(paramOnSharedPreferenceChangeListener));
        if (this.hiJ == null)
        {
  ...
  public int update(Uri paramUri, ContentValues paramContentValues, String paramString, String[] paramArrayOfString)
  {
    ...
    int j = this.sHN.match(paramUri);
    switch (j)
    {
    default: 
      throw new IllegalArgumentException("This is Unknown Uri：" + paramUri);
    }
    if ((this.sHO != null) && (this.sHO.get(str1) != null) && (((Integer)this.sHO.get(str1)).intValue() > 0))
    {
      i = 1;
    ...
    implements SharedPreferences.Editor
  {
    ...
    private boolean setValue(String paramString)
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      ...
      //   11: ireturn
      //   12: aload_0
      //   13: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      //   16: astore 4
      //   18: aload 4
      //   20: monitorenter
      //   21: aload_0
      //   22: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      //   25: aload_0
      //   26: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      ...
      //   35: aload_0
      //   36: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      ...
      //   42: istore_2
      //   43: aload_0
      //   44: getfield 30	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHC	Z
      //   47: istore_3
      //   48: aload_0
      //   49: monitorenter
      //   50: invokestatic 53	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences:cix	()Landroid/net/Uri;
      //   53: aload_0
      //   54: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
      ...
      //   67: astore_1
      //   68: aload_0
      //   69: getfield 28	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHB	Ljava/util/Map;
      //   72: checkcast 25	java/util/HashMap
      //   75: invokestatic 68	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$c:o	(Ljava/util/HashMap;)Landroid/content/ContentValues;
      //   78: astore 5
      //   80: aload_0
      //   81: getfield 20	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHP	Lcom/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences;
    ...
    public final SharedPreferences.Editor putStringSet(String paramString, Set<String> paramSet)
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 28	com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences$b:sHB	Ljava/util/Map;
      //   6: astore_3
      //   7: aload_2
      //   8: ifnonnull +18 -> 26
      //   11: aconst_null
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/sdk/platformtools/MultiProcessSharedPreferences.class
