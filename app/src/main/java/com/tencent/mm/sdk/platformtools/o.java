...
public final class o
{
  public static boolean Wd(String paramString)
  {
    ...
    do
    {
      ...
      localOptions.inSampleSize = We(paramString);
      ...
      if (paramString != null)
      {
        x.i("MicroMsg.ImgUtil", "bitmap recycle %s", new Object[] { paramString });
        paramString.recycle();
      }
  ...
  private static int We(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 89	com/tencent/mm/vfs/d:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   7: astore 4
    //   9: aload 4
    ...
    //   17: ldc 14
    //   19: ldc 91
    //   21: invokestatic 94	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   24: aload 5
    //   26: astore_3
    //   27: aload_3
    //   28: ifnull +184 -> 212
    ...
    //   67: aastore
    //   68: invokestatic 105	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   71: aload 4
    //   73: astore_3
    //   74: iload_1
    //   75: iload_2
    //   76: invokestatic 109	com/tencent/mm/sdk/platformtools/o:eE	(II)I
    //   79: istore_1
    //   80: aload 4
    //   82: astore_3
    //   83: ldc 14
    ...
    //   97: aastore
    //   98: invokestatic 105	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   101: aload 4
    //   103: ifnull +8 -> 111
    //   106: aload 4
    ...
    //   197: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   200: aload 4
    //   202: ifnull +8 -> 210
    //   205: aload 4
    ...
    //   215: ldc 14
    //   217: ldc -128
    //   219: invokestatic 94	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   222: aload 4
    //   224: ifnull +8 -> 232
    //   227: aload 4
  ...
  {
    // Byte code:
    //   0: new 133	com/tencent/mm/vfs/c
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 134	com/tencent/mm/vfs/c:<init>	(Ljava/lang/String;)V
    //   8: astore_0
    //   9: bipush 6
  ...
  public static boolean b(String paramString, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    if ((paramString == null) || (paramString.length() == 0))
    {
      x.e("MicroMsg.ImgUtil", "isImgFile, invalid argument");
    ...
    do
    {
      ...
      x.v("MicroMsg.ImgUtil", "hy: isImgFile decode using: %d", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
      if (paramString != null)
      {
        x.i("MicroMsg.ImgUtil", "bitmap recycle %s", new Object[] { paramString });
        paramString.recycle();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/sdk/platformtools/o.class
