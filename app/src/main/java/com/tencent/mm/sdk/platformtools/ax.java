...
{
  static String[] sIF = { "sysfs", "rootfs", "binfmt_misc", "anon_inodefs", "bdev", "proc", "cgroup", "tmpfs", "debugfs", "sockfs", "pipefs", "rpc_pipefs", "devpts", "ramfs", "fuseblk", "fusectl", "selinuxfs" };
  static String[] sIG = { "vfat", "exfat", "fuse", "sdcardfs" };
  static String[] sIH = { "/mnt/secure", "/mnt/asec", "/mnt/obb", "/dev/mapper", "/data/" };
  static String[] sII = { "/dev/block/vold" };
  ...
  public static String Wz(String paramString)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            } while (!paramString.equals(((a)localObject1).sIK));
            localObject1 = ((a)localObject1).sIL;
            x.i("MicroMsg.SdcardUtil", "getFileSystem[%s] is [%s]", new Object[] { paramString, localObject1 });
        ...
        i = bi.getInt((String)localObject4, -1);
        x.i("MicroMsg.SdcardUtil", "getFileSystem multiuser uid[%s][%d]", new Object[] { localObject4, Integer.valueOf(i) });
        localObject2 = localObject1;
      } while (i == -1);
    ...
    } while (!((String)localObject4).equals(((a)localObject2).sIK));
    Object localObject1 = ((a)localObject2).sIL;
    x.i("MicroMsg.SdcardUtil", "getFileSystem[%s] fix[%s] is [%s]", new Object[] { paramString, localObject4, localObject1 });
  ...
  private static void a(a parama)
  {
    try
    {
      StatFs localStatFs = new StatFs(parama.sIK);
      parama.sIP = localStatFs.getBlockSize();
      parama.sIO = localStatFs.getAvailableBlocks();
      parama.sIM = localStatFs.getBlockCount();
      parama.sIN = localStatFs.getFreeBlocks();
      return;
    }
    catch (IllegalArgumentException parama)
    {
      x.e("MicroMsg.SdcardUtil", "statFsForStatMountParse", new Object[] { parama });
    }
  }
  ...
  private static boolean b(a parama)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: getfield 113	com/tencent/mm/sdk/platformtools/ax$a:sIK	Ljava/lang/String;
    //   8: ldc -44
    ...
    //   66: aload_0
    //   67: iload_1
    //   68: putfield 246	com/tencent/mm/sdk/platformtools/ax$a:bvO	Z
    //   71: iload_1
    //   72: ireturn
    //   73: astore_2
    //   74: ldc 122
    ...
    //   83: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   86: goto -20 -> 66
    //   89: astore 4
    //   91: aconst_null
    //   92: astore_3
    ...
    //   120: aload_0
    //   121: getfield 113	com/tencent/mm/sdk/platformtools/ax$a:sIK	Ljava/lang/String;
    ...
    //   130: invokestatic 270	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   133: aload_3
    //   134: ifnull +68 -> 202
    //   137: aload_3
    ...
    //   156: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   159: iconst_0
    //   160: istore_1
    //   161: goto -95 -> 66
    //   164: astore_0
    ...
    //   187: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: goto -15 -> 175
    //   193: astore_0
    //   194: goto -27 -> 167
    //   197: astore 4
  ...
  private static ArrayList<a> ciE()
  {
    ...
    //   84: invokestatic 270	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   87: goto -61 -> 26
    //   90: astore_2
    //   91: aload_1
    //   92: astore_0
    ...
    //   104: aload_2
    //   105: aastore
    //   106: invokestatic 204	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   109: aload_1
    //   110: ifnull +7 -> 117
    //   113: aload_1
    ...
    //   119: aload_1
    //   120: astore_0
    //   121: new 6	com/tencent/mm/sdk/platformtools/ax$a
    //   124: dup
    //   125: invokespecial 299	com/tencent/mm/sdk/platformtools/ax$a:<init>	()V
    //   128: astore 4
    //   130: aload_1
    //   131: astore_0
    //   132: aload 4
    ...
    //   135: iconst_0
    //   136: aaload
    //   137: putfield 302	com/tencent/mm/sdk/platformtools/ax$a:sIJ	Ljava/lang/String;
    //   140: aload_1
    //   141: astore_0
    //   142: aload 4
    //   144: aload_2
    //   145: iconst_1
    //   146: aaload
    //   147: putfield 113	com/tencent/mm/sdk/platformtools/ax$a:sIK	Ljava/lang/String;
    //   150: aload_1
    //   151: astore_0
    //   152: aload 4
    //   154: aload_2
    //   155: iconst_2
    //   156: aaload
    //   157: putfield 120	com/tencent/mm/sdk/platformtools/ax$a:sIL	Ljava/lang/String;
    //   160: aload_1
    //   161: astore_0
    //   162: aload_3
    //   163: aload 4
    ...
    //   203: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   206: aload_3
    //   207: areturn
    //   208: astore_0
    //   209: ldc 122
    ...
    //   218: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   221: aload_3
    //   222: areturn
    //   223: astore_1
    //   224: ldc 122
    ...
    //   233: invokestatic 250	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   236: goto -51 -> 185
    //   239: astore_0
    //   240: aconst_null
    //   241: astore_1
  ...
  private static a ciF()
  {
    ...
    } while (!((a)localObject1).sIK.equals(str));
    for (;;)
    {
      localObject2 = localObject1;
      ...
      {
        localObject2 = new a();
        ((a)localObject2).sIK = str;
        ((a)localObject2).sIJ = "Unknown";
        ((a)localObject2).sIL = "Unknown";
      }
      a((a)localObject2);
  ...
  {
    ArrayList localArrayList = ciE();
    int i = localArrayList.size();
    Object localObject1 = Arrays.asList(sIG);
    Object localObject2 = Arrays.asList(sIH);
    Object localObject3 = Arrays.asList(sII);
    i -= 1;
    if (i >= 0)
    {
      a locala = (a)localArrayList.get(i);
      if (!((List)localObject1).contains(locala.sIL))
      {
        localArrayList.remove(i);
        x.d("MicroMsg.SdcardUtil", "Remove with filesystem mismatch: " + locala.sIL);
      }
      for (;;)
      {
        i -= 1;
        ...
        String str;
        for (boolean bool = false; localIterator.hasNext(); bool = locala.sIK.startsWith(str) | bool) {
          str = (String)localIterator.next();
        }
        if (bool)
        {
          localArrayList.remove(i);
          x.d("MicroMsg.SdcardUtil", "Remove with bad mount dir1: " + locala.sIK);
        }
        else if ((locala.sIL.equals("fuse")) || (locala.sIL.equals("sdcardfs")))
        {
          if (locala.sIJ.startsWith("/data/"))
          {
            localArrayList.remove(i);
            x.d("MicroMsg.SdcardUtil", "Remove with bad mount dir2: " + locala.sIJ);
          }
        }
        else if ((!locala.sIL.equals("fuse")) && (!locala.sIL.equals("sdcardfs")))
        {
          localIterator = ((List)localObject3).iterator();
          for (bool = false; localIterator.hasNext(); bool = locala.sIJ.startsWith(str) | bool) {
            str = (String)localIterator.next();
          }
          if (!bool)
          {
            localArrayList.remove(i);
            x.d("MicroMsg.SdcardUtil", "Remove with bad device name: " + locala.sIJ);
          }
        }
      }
    }
    ...
    if (i >= 0)
    {
      ...
      if (((a)localObject2).sIK.equals(localObject1))
      {
        localArrayList.remove(i);
    ...
    for (i = 1;; i = 0)
    {
      ...
      {
        localObject2 = new a();
        ((a)localObject2).sIK = ((String)localObject1);
        ((a)localObject2).sIL = "unknown";
        ((a)localObject2).sIJ = "unknown";
        localArrayList.add(0, localObject2);
      }
      ...
      for (;;)
      {
        if (i >= 0)
        {
          ...
          localObject2 = new File(((a)localObject1).sIK);
          if ((!((File)localObject2).exists()) || (!((File)localObject2).isDirectory()))
          {
            x.d("MicroMsg.SdcardUtil", "Directory verify failed: " + localObject1);
            localArrayList.remove(i);
          }
          i -= 1;
          continue;
      ...
      while (i >= 0)
      {
        ...
        if (!b((a)localObject1))
        {
          x.d("MicroMsg.SdcardUtil", "Directory testPermissionForStatMountParse failed: " + localObject1);
          localArrayList.remove(i);
        }
        i -= 1;
      }
      ...
      if (!localArrayList.isEmpty())
      {
        ...
        {
          localObject2 = (a)localArrayList.get(i);
          if (!((a)localObject1).sIJ.equals(((a)localObject2).sIJ)) {
            break label915;
          }
          localArrayList.remove(i);
          x.d("MicroMsg.SdcardUtil", "Duplicate with same DevName:" + ((a)localObject1).sIJ);
          if ((((a)localObject1).bvO) || (!((a)localObject2).bvO)) {
            break label915;
          }
      ...
      for (;;)
      {
        ...
        while (!((ArrayList)localObject3).isEmpty())
        {
          ...
          while (i >= 0)
          {
            ...
            {
              x.d("MicroMsg.SdcardUtil", "Duplicate:" + ((a)localObject1).toString() + "---" + ((a)localObject2).toString());
  ...
  public static boolean ciK()
  {
    ...
    for (;;)
    {
      ...
      if ((localObject3 == null) && (((a)localObject2).sIK.equals(str2)))
      {
        if (localObject1 != null) {
          break label480;
        }
      ...
      {
        if ((localObject1 != null) || (!((a)localObject2).sIK.equals(str1))) {
          break label473;
        }
    ...
    {
      label132:
      if ((localObject4 != null) && (localObject2 == null) && (!bi.oW(str1)) && (str1.contains("emulated")))
      {
        localObject1 = str1.substring(str1.lastIndexOf('/') + 1);
        int i = bi.getInt((String)localObject1, -1);
        x.i("MicroMsg.SdcardUtil", "hasUnRemovableStorage multiuser uid[%s][%d]", new Object[] { localObject1, Integer.valueOf(i) });
        if (i != -1)
        {
          ...
          if (!bi.oW((String)localObject3))
          {
            ...
            } while (!((a)localObject1).sIK.equals(localObject3));
          }
        }
      }
      for (;;)
      {
        if ((localObject4 != null) && (localObject1 != null))
        {
          a((a)localObject4);
          a((a)localObject1);
          x.d("MicroMsg.SdcardUtil", "hasUnRemovableStorage stats dataStatMountParse[%s] storageStatMountParse[%s]", new Object[] { localObject4, localObject1 });
          if (((!((a)localObject1).sIL.equals("fuse")) && (!((a)localObject1).sIL.equals("sdcardfs")) && (!((a)localObject1).sIL.equals("esdfs"))) || (((a)localObject4).sIM < ((a)localObject1).sIM) || (((a)localObject1).sIM <= 0L) || (((a)localObject4).sIP < ((a)localObject1).sIP) || (((a)localObject1).sIP <= 0L) || (((a)localObject4).sIO < ((a)localObject1).sIO)) {}
        }
        for (boolean bool = true;; bool = false)
        {
          x.i("MicroMsg.SdcardUtil", "hasUnRemovableStorage ret[%b], take[%d]ms", new Object[] { Boolean.valueOf(bool), Long.valueOf(System.currentTimeMillis() - l) });
          return bool;
        }
        localObject1 = localObject2;
      }
  ...
  public static final class a
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      {
        return false;
        l1 = this.sIM - ((a)paramObject).sIM;
        l2 = this.sIN - ((a)paramObject).sIN;
        l3 = this.sIO - ((a)paramObject).sIO;
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("{DevName=").append(this.sIJ).append(", MountDir=").append(this.sIK).append(", FileSystem=").append(this.sIL).append(", TotalBlocks=").append(this.sIM).append(", FreeBlocks=").append(this.sIN).append(", AvailableBlocks=").append(this.sIO).append(", BlockSize=").append(this.sIP).append(", Shared=");
      if (this.sIQ != null) {}
      for (boolean bool = true;; bool = false) {
        return bool + "}";
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/sdk/platformtools/ax.class
