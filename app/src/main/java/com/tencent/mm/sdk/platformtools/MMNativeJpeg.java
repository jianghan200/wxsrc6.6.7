...
public class MMNativeJpeg
{
  ...
  public static boolean Convert2Baseline(String paramString, int paramInt)
  {
    ...
    //   17: aload_0
    //   18: aastore
    //   19: invokestatic 34	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   22: iconst_1
    //   23: ireturn
    //   24: aconst_null
    //   25: astore 7
    ...
    //   54: ldc 11
    //   56: ldc 42
    //   58: invokestatic 46	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: aload 4
    //   63: astore_3
    //   64: aload_0
    ...
    //   147: aload 8
    //   149: aastore
    //   150: invokestatic 83	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   153: aload 8
    //   155: aload_0
    //   156: iconst_1
    //   157: invokestatic 89	com/tencent/mm/sdk/platformtools/j:q	(Ljava/lang/String;Ljava/lang/String;Z)Z
    //   160: istore_2
    //   161: aload 4
    ...
    //   205: aastore
    //   206: invokestatic 34	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   209: aload_0
    //   210: ifnull -29 -> 181
    //   213: aload_0
    ...
    //   230: ldc 11
    //   232: ldc 100
    //   234: invokestatic 102	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   237: aload_0
    //   238: ifnull -57 -> 181
    //   241: aload_0
  ...
  public static boolean IsJpegFile(String paramString)
  {
    try
    {
      ...
      {
        x.e("MMJPEG.JAVA", "IsJpegFile : can't query jpeg parames.");
        return false;
      }
    }
    catch (Exception paramString)
    {
      x.e("MMJPEG.JAVA", "IsJpegFile exception:%s", new Object[] { exception2String(paramString) });
      return false;
    }
    return true;
  }
  ...
  private static boolean checkAndroidVersion()
  {
    ...
    {
      x.i("MMJPEG.JAVA", "early version before android 3.0  unsupported.");
      return false;
    }
    return true;
  }
  ...
  private static boolean checkFileExist(String paramString)
  {
    ...
    {
      x.e("MMJPEG.JAVA", "checkfileexist. exception:%s", new Object[] { exception2String(paramString) });
    }
    return false;
  }
  ...
  public static boolean convertToProgressive(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      x.d("MMJPEG.JAVA", "convert %s to %s use progressive.quality:%d", new Object[] { paramString, str, Integer.valueOf(paramInt) });
      paramInt = mmjpeg.convertToProgressive(paramString, str);
      if (paramInt != 0)
      {
        x.e("MMJPEG.JAVA", "convert failed. error:%d", new Object[] { Integer.valueOf(paramInt) });
        return false;
      }
    }
    catch (Exception paramString)
    {
      x.e("MMJPEG.JAVA", "convertToProgressive exception:%s", new Object[] { exception2String(paramString) });
      return false;
    }
    boolean bool = j.q(str, paramString, true);
    x.i("MMJPEG.JAVA", "convert ret:%b", new Object[] { Boolean.valueOf(bool) });
    return bool;
  }
  
  public static Bitmap decodeAsBitmap(String paramString)
  {
    x.v("MMJPEG.JAVA", "decodeAsBitmap:%s", new Object[] { paramString });
    try
    {
      Object localObject = mmjpeg.queryParams(paramString);
      if (localObject == null)
      {
        x.e("MMJPEG.JAVA", "can't query jpeg parames.");
        return null;
      }
      ...
      {
        x.i("MMJPEG.JAVA", "decode bitmap successed.");
        return (Bitmap)localObject;
      }
      x.e("MMJPEG.JAVA", "can't decode to bmp.");
      return null;
    }
    catch (Exception paramString)
    {
      x.e("MMJPEG.JAVA", "decodeAsBitmap exception:%s", new Object[] { exception2String(paramString) });
      return null;
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      x.e("MMJPEG.JAVA", "decodeAsBitmap OOM:%s", new Object[] { paramString });
    }
    return null;
  }
  ...
  {
    x.v("MMJPEG.JAVA", "isProgressive:%s", new Object[] { paramString });
    if (!checkAndroidVersion()) {}
    int i;
    do
    {
      ...
      x.d("MMJPEG.JAVA", "check progressive for file:%s", new Object[] { paramString });
      try
      {
        i = mmjpeg.isProgressiveFile(paramString);
        if ((1 != i) && (i != 0))
        {
          x.e("MMJPEG.JAVA", "check failed. error:%d", new Object[] { Integer.valueOf(i) });
          return false;
        }
      }
      catch (Exception paramString)
      {
        x.e("MMJPEG.JAVA", "isProgressive exception:%s", new Object[] { exception2String(paramString) });
        return false;
      }
      x.i("MMJPEG.JAVA", "file:%s progressive:%d", new Object[] { paramString, Integer.valueOf(i) });
    } while (i != 1);
    return true;
  }
  ...
  public static int queryQuality(String paramString)
  {
    ...
    try
    {
      ...
      x.i("MMJPEG.JAVA", "after query quality:%d", new Object[] { Integer.valueOf(i) });
      if ((i < 10000) && (i >= 24)) {
        return i;
      }
      ...
      x.w("MMJPEG.JAVA", "invalid jpeg file or too small quality.");
      return 0;
    }
    catch (Exception paramString)
    {
      x.e("MMJPEG.JAVA", "queryQuality failed. exception:%s", new Object[] { exception2String(paramString) });
      return 0;
    }
    catch (IncompatibleClassChangeError paramString)
    {
      x.printErrStackTrace("MicroMsg.Crash", paramString, "May cause dvmFindCatchBlock crash!", new Object[0]);
    ...
    {
      x.e("MMJPEG.JAVA", "queryQuality error. java.lang.UnsatisfiedLinkError: queryQuality, %s", new Object[] { paramString.toString() });
    }
    return 0;
  }
}
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/sdk/platformtools/MMNativeJpeg.class
