  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rQY != null)
      {
        paramVarArgs.fV(3, this.rQY.boi());
        this.rQY.a(paramVarArgs);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (int i = f.a.a.a.fS(1, this.six.boi()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.rQI != null) {
        paramInt = i + f.a.a.a.fS(2, this.rQI.boi());
      }
      i = paramInt;
      if (this.rQY != null) {
        i = paramInt + f.a.a.a.fS(3, this.rQY.boi());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/protocal/c/aoo.class
