  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rHg != null)
      {
        paramVarArgs.fV(4, this.rHg.boi());
        this.rHg.a(paramVarArgs);
      }
      if (this.rHh != null)
      {
        paramVarArgs.fV(5, this.rHh.boi());
    ...
    for (paramInt = f.a.a.a.fS(1, this.six.boi()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.rHg != null) {
        i = paramInt + f.a.a.a.fS(4, this.rHg.boi());
      }
      paramInt = i;
      if (this.rHh != null) {
        paramInt = i + f.a.a.a.fS(5, this.rHh.boi());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localacn.six = ((fl)localObject1);
            paramInt += 1;
          }
        case 2: 
          localacn.hwV = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        case 3: 
          localacn.hwW = ((f.a.a.a.a)localObject1).vHC.readString();
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
          i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/protocal/c/acn.class
