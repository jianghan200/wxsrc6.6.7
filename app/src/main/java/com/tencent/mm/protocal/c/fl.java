  ...
  extends com.tencent.mm.bk.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rgv != null)
      {
        paramVarArgs.fV(2, this.rgv.boi());
        this.rgv.a(paramVarArgs);
      }
      paramInt = 0;
    }
    int i;
    ...
    return i + f.a.a.a.fS(2, this.rgv.boi());
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      default: 
        return -1;
      case 1: 
        localfl.rfn = ((f.a.a.a.a)localObject1).vHC.rY();
        return 0;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mm/protocal/c/fl.class
