  ...
  extends bhd
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rcT != null)
      {
        paramVarArgs.fV(3, this.rcT.boi());
    ...
    for (paramInt = f.a.a.a.fS(1, this.shX.boi()) + 0;; paramInt = 0)
    {
      ...
      paramInt = i;
      if (this.rcT != null) {
        paramInt = i + f.a.a.a.fS(3, this.rcT.boi());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localcu.shX = ((fk)localObject1);
            paramInt += 1;
          }
        case 2: 
          localcu.hcE = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
        i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/protocal/c/cu.class
