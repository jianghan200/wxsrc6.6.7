    ...
    for (paramInt = f.a.a.b.b.a.h(1, this.hbL) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          return -1;
        case 1: 
          localbcu.hbL = locala.vHC.readString();
          return 0;
        case 2: 
          localbcu.rqY = locala.vHC.readString();
          return 0;
        case 3: 
          localbcu.seX = locala.vHC.rY();
          return 0;
        }
        localbcu.ruw = locala.vHC.rY();
        return 0;
      }
      return -1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/protocal/c/bcu.class
