  ...
  extends com.tencent.mm.bk.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rel != null)
      {
        paramVarArgs.fV(1, this.rel.boi());
    ...
    label305:
    for (paramInt = f.a.a.a.fS(1, this.rel.boi()) + 0;; paramInt = 0)
    {
      return paramInt;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/protocal/c/dy.class
