  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.riN != null)
      {
        paramVarArgs.fV(3, this.riN.boi());
    ...
    for (int i = f.a.a.a.fS(1, this.six.boi()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.riN != null) {
        i = paramInt + f.a.a.a.fS(3, this.riN.boi());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/protocal/c/blt.class
