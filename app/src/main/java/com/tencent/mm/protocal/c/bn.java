  ...
  extends bhd
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.fT(5, this.rbS);
      if (this.rbT != null) {
        paramVarArgs.g(6, this.rbT);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.fS(1, this.shX.boi()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt + f.a.a.a.fQ(5, this.rbS);
      paramInt = i;
      if (this.rbT != null) {
        paramInt = i + f.a.a.b.b.a.h(6, this.rbT);
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localbn.shX = ((fk)localObject1);
            paramInt += 1;
          }
        case 2: 
          localbn.hLg = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        case 3: 
          paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
          i = paramVarArgs.size();
        ...
        case 4: 
          ...
          while (paramInt < i)
          {
            ...
            localbn.rbR = ((bhz)localObject1);
            paramInt += 1;
          }
        case 5: 
          localbn.rbS = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        }
        localbn.rbT = ((f.a.a.a.a)localObject1).vHC.readString();
        return 0;
      }
      return -1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/protocal/c/bn.class
