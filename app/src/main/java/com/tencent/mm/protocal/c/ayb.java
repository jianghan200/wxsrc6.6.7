  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.saX != null)
      {
        paramVarArgs.fV(2, this.saX.boi());
        this.saX.a(paramVarArgs);
      }
      paramVarArgs.fT(3, this.saY);
      if (this.saW != null)
      {
        paramVarArgs.fV(4, this.saW.boi());
    ...
    for (paramInt = f.a.a.a.fS(1, this.six.boi()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.saX != null) {
        i = paramInt + f.a.a.a.fS(2, this.saX.boi());
      }
      i += f.a.a.a.fQ(3, this.saY);
      paramInt = i;
      if (this.saW != null) {
        paramInt = i + f.a.a.a.fS(4, this.saW.boi());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localayb.saX = ((pn)localObject1);
            paramInt += 1;
          }
        case 3: 
          localayb.saY = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
        i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/protocal/c/ayb.class
