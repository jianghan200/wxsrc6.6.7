  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.snQ != null)
      {
        paramVarArgs.fV(2, this.snQ.boi());
    ...
    for (paramInt = f.a.a.a.fS(1, this.six.boi()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.snQ != null) {
        i = paramInt + f.a.a.a.fS(2, this.snQ.boi());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/protocal/c/bpw.class
