  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rcB != null)
      {
        paramVarArgs.fV(2, this.rcB.boi());
        this.rcB.a(paramVarArgs);
      }
      if (this.sgK != null)
      {
        paramVarArgs.fV(3, this.sgK.boi());
    ...
    for (int i = f.a.a.a.fS(1, this.six.boi()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.rcB != null) {
        paramInt = i + f.a.a.a.fS(2, this.rcB.boi());
      }
      i = paramInt;
      if (this.sgK != null) {
        i = paramInt + f.a.a.a.fS(3, this.sgK.boi());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/protocal/c/boa.class
