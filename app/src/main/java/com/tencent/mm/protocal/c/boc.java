  ...
  extends com.tencent.mm.bk.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.slY != null)
      {
        paramVarArgs.fV(2, this.slY.boi());
        this.slY.a(paramVarArgs);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (paramInt = f.a.a.a.fS(1, this.slX.boi()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (this.slY != null) {
        i = paramInt + f.a.a.a.fS(2, this.slY.boi());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/protocal/c/boc.class
