  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rgR != null)
      {
        paramVarArgs.fV(5, this.rgR.boi());
    ...
    for (int i = f.a.a.a.fS(1, this.six.boi()) + 0;; i = 0)
    {
      ...
      i = paramInt;
      if (this.rgR != null) {
        i = paramInt + f.a.a.a.fS(5, this.rgR.boi());
      }
      return i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 3: 
          ...
          while (paramInt < i)
          {
            ...
            localbiv.rhl = ((aly)localObject1);
            paramInt += 1;
          }
        case 4: 
          localbiv.rgQ = ((f.a.a.a.a)localObject1).vHC.readString();
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
        i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/protocal/c/biv.class
