  ...
  extends bhd
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.slT != null)
      {
        paramVarArgs.fV(4, this.slT.boi());
        this.slT.a(paramVarArgs);
      }
      paramVarArgs.fT(5, this.rdq);
      if (this.slV != null)
      {
        paramVarArgs.fV(6, this.slV.boi());
    ...
    for (int i = f.a.a.a.fS(1, this.shX.boi()) + 0;; i = 0)
    {
      ...
      paramInt = i;
      if (this.slT != null) {
        paramInt = i + f.a.a.a.fS(4, this.slT.boi());
      }
      i = paramInt + f.a.a.a.fQ(5, this.rdq);
      paramInt = i;
      if (this.slV != null) {
        paramInt = i + f.a.a.a.fS(6, this.slV.boi());
      }
      return paramInt;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localbnz.slU = ((boi)localObject1);
            paramInt += 1;
          }
        case 3: 
          localbnz.rcc = ((f.a.a.a.a)localObject1).vHC.readString();
          return 0;
        case 4: 
          paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
          i = paramVarArgs.size();
          ...
          while (paramInt < i)
          {
            ...
            localbnz.slT = ((bhz)localObject1);
            paramInt += 1;
          }
        case 5: 
          localbnz.rdq = ((f.a.a.a.a)localObject1).vHC.rY();
          return 0;
        }
        paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
        i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/protocal/c/bnz.class
