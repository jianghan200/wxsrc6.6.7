  ...
  extends bhp
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (this.rhL != null)
      {
        paramVarArgs.fV(5, this.rhL.boi());
    ...
    for (int i = f.a.a.a.fS(1, this.six.boi()) + 0;; i = 0)
    {
      paramInt = i;
      if (this.rMt != null) {
        paramInt = i + f.a.a.b.b.a.h(2, this.rMt);
      }
      i = paramInt;
      if (this.rhK != null) {
      ...
      i = paramInt;
      if (this.rhL != null) {
        i = paramInt + f.a.a.a.fS(5, this.rhL.boi());
      }
      return i;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1: 
          ...
          while (paramInt < i)
          {
            ...
            localajs.six = ((fl)localObject1);
            paramInt += 1;
          }
        case 2: 
          localajs.rMt = ((f.a.a.a.a)localObject1).vHC.readString();
          return 0;
        case 3: 
          paramVarArgs = ((f.a.a.a.a)localObject1).IC(paramInt);
          i = paramVarArgs.size();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes7-dex2jar.jar!/com/tencent/mm/protocal/c/ajs.class
