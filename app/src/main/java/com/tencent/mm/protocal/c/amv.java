    ...
    for (paramInt = f.a.a.b.b.a.h(1, this.rxo) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          return -1;
        case 1: 
          localamv.rxo = locala.vHC.readString();
          return 0;
        case 2: 
          localamv.jPe = locala.vHC.readString();
          return 0;
        case 3: 
          localamv.hcy = locala.vHC.rY();
          return 0;
        case 4: 
          localamv.rwk = locala.vHC.readString();
          return 0;
        case 5: 
          localamv.rmC = locala.vHC.readString();
          return 0;
        case 6: 
          localamv.rmy = locala.vHC.readString();
          return 0;
        }
        localamv.jPK = locala.vHC.readString();
        return 0;
      }
      return -1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/protocal/c/amv.class
