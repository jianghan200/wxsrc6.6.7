...
public final class q
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, int paramInt5, String paramString)
  {
    int i;
    int j;
    if ((fv(paramInt1, paramInt2)) || (fw(paramInt1, paramInt2)) || (fx(paramInt1, paramInt2)) || (Ha(paramInt1)) || (fy(paramInt1, paramInt2)))
    {
      x.i("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the cmdType is for idkey report cmdType:" + paramInt1 + " cmdid:" + paramInt2);
      i = -1;
      if (paramInt5 != 4) {
        break label380;
      }
      ...
      if (i == -1)
      {
        x.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay get ID by scene is -1, the scene is " + paramInt5);
        paramInt5 = -1;
        j = paramInt5;
        if (paramInt1 == 385)
        {
      ...
      if (j == -1)
      {
        x.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the cmdType is for idkey report cmdType:" + paramInt1 + " cmdid:" + paramInt2 + " , ID is -1");
        paramInt5 = -1;
    ...
    for (;;)
    {
      ...
      x.e("MicroMsg.WalletReportUtil", "reportIDKeyWalletPay the processName is for idkey report processName:" + paramString + " , ID is -1");
      for (;;)
      {
        return;
    ...
    if (fv(paramInt1, paramInt2))
    {
      ...
      h.mEJ.b((ArrayList)localObject1, true);
      localObject1 = new ArrayList();
      if ((paramInt3 != 0) || (paramInt4 != 0))
      {
  ...
  public static void c(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        paramString3 = (String)localObject3;
        x.e("MicroMsg.WalletReportUtil", "", new Object[] { localException1 });
        localObject5 = localObject4;
        localObject6 = paramString3;
        h.mEJ.h(10756, new Object[] { paramString1, paramString2, localObject5, localObject6, Integer.valueOf(paramInt), paramString4 });
        return;
      }
      try
      {
  ...
  {
    return (int)((System.currentTimeMillis() - uXu) / 1000L);
  }
  
  public static void fu(int paramInt1, int paramInt2)
  {
    h.mEJ.h(12097, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis()) });
  }
  ...
  private static boolean fy(int paramInt1, int paramInt2)
  {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/wallet_core/c/q.class
