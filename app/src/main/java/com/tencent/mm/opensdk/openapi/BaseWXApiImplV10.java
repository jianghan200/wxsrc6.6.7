  ...
  private boolean handleWxInternalRespType(String paramString, IWXAPIEventHandler paramIWXAPIEventHandler)
  {
    ...
    try
    {
      ...
      if (("subscribeminiprogrammsg".equals(localObject)) || ("5".equals(localObject)))
      {
        ...
        String str = paramString.getQueryParameter("ret");
        if ((str != null) && (str.length() > 0)) {
          ((SubscribeMiniProgramMsg.Resp)localObject).errCode = d.b(str);
        }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/opensdk/openapi/BaseWXApiImplV10.class
