...
final class a
{
  ...
  public static void c(Throwable paramThrowable)
  {
    ...
    //   14: aastore
    //   15: invokestatic 69	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   18: getstatic 16	com/tencent/mm/lib/riskscanner/a:duH	Ljava/lang/ThreadLocal;
    //   21: invokevirtual 72	java/lang/ThreadLocal:remove	()V
    //   24: getstatic 34	com/tencent/mm/plugin/report/f:mDy	Lcom/tencent/mm/plugin/report/f;
    //   27: ldc2_w 35
    //   30: ldc2_w 73
    //   33: lconst_1
    //   34: iconst_1
    ...
    //   75: astore_0
    //   76: getstatic 34	com/tencent/mm/plugin/report/f:mDy	Lcom/tencent/mm/plugin/report/f;
    //   79: sipush 14177
    ...
    //   165	1	1	localThrowable1	Throwable
    //   173	8	1	localThrowable2	Throwable
    //   183	11	1	localObject1	Object
    //   54	92	2	localPrintWriter	java.io.PrintWriter
    //   169	1	2	localThrowable3	Throwable
  ...
  {
    x.i("MicroMsg.RiskScannerReportService", "Report scan result, %d", new Object[] { Integer.valueOf(paramInt) });
    switch (paramInt)
    {
    default: 
      f.mDy.a(590L, 3L, 1L, true);
      return;
    case 0: 
      Long localLong = (Long)duH.get();
      if (localLong != null)
      {
        long l = bi.VG() - localLong.longValue();
        x.i("MicroMsg.RiskScannerReportService", "Scan cost: %d ms", new Object[] { Long.valueOf(l) });
        f.mDy.e(590, 5, 1, (int)l, true);
        return;
      }
      f.mDy.a(590L, 1L, 1L, true);
      return;
    }
    f.mDy.a(590L, 2L, 1L, true);
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/lib/riskscanner/a.class
