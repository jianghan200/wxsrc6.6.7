  ...
  extends c
{
  ...
  protected final int b(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject).cubicTo(23.340136F, 58.30629F, 15.0F, 49.33082F, 15.0F, 38.407406F);
      ...
      ((Path)localObject).cubicTo(57.0F, 49.33082F, 48.659866F, 58.30629F, 38.0F, 59.313408F);
      ((Path)localObject).lineTo(38.0F, 62.95062F);
      ((Path)localObject).lineTo(34.0F, 62.95062F);
      ((Path)localObject).lineTo(34.0F, 59.313408F);
      ((Path)localObject).close();
      ((Path)localObject).moveTo(23.0F, 62.95062F);
      ((Path)localObject).lineTo(49.0F, 62.95062F);
      ((Path)localObject).lineTo(49.0F, 67.0F);
      ((Path)localObject).lineTo(23.0F, 67.0F);
      ((Path)localObject).lineTo(23.0F, 62.95062F);
      ((Path)localObject).close();
      ...
      ((Path)localObject).lineTo(36.0F, 50.802467F);
      ((Path)localObject).cubicTo(28.8203F, 50.802467F, 23.0F, 44.98217F, 23.0F, 37.802467F);
      ((Path)localObject).lineTo(23.0F, 19.25926F);
      ((Path)localObject).cubicTo(23.0F, 12.079557F, 28.8203F, 6.259259F, 36.0F, 6.259259F);
      ((Path)localObject).lineTo(36.0F, 6.259259F);
      ((Path)localObject).close();
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/boot/svg/a/a/w.class
