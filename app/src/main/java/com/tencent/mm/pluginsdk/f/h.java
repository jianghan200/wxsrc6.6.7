...
public final class h
{
  ...
  public static String V(Context paramContext, int paramInt)
  {
    ...
    if ((l2 >= 0L) && (l2 < 86400000L)) {
      return p(paramContext, l2) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() - 86400000L);
    if ((l2 >= 0L) && (l2 < 86400000L)) {
      return paramContext.getString(a.h.fmt_pre_yesterday) + " " + p(paramContext, l2) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() - 172800000L);
    if ((l2 >= 0L) && (l2 < 86400000L)) {
      return paramContext.getString(a.h.fmt_pre_daybeforyesterday) + " " + p(paramContext, l2) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() + 86400000L);
    if ((l2 >= 0L) && (l2 < 86400000L)) {
      return paramContext.getString(a.h.fmt_pre_tomorrow) + " " + p(paramContext, l2) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    l2 = l1 - (((GregorianCalendar)localObject2).getTimeInMillis() + 172800000L);
    if ((l2 >= 0L) && (l2 < 86400000L)) {
      return paramContext.getString(a.h.fmt_pre_dayaftertomorrow) + " " + p(paramContext, l2) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    ...
    if ((((GregorianCalendar)localObject1).get(1) == ((GregorianCalendar)localObject2).get(1)) && (((GregorianCalendar)localObject1).get(3) == ((GregorianCalendar)localObject2).get(3)))
    {
      ...
      return W(paramContext, i) + " " + X(paramContext, paramInt) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    if ((((GregorianCalendar)localObject1).get(1) == ((GregorianCalendar)localObject2).get(1)) && (((GregorianCalendar)localObject1).get(3) + 1 == ((GregorianCalendar)localObject2).get(3)))
    {
      ...
      for (;;)
      {
        return (String)localObject1 + " " + X(paramContext, paramInt) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    ...
    if (((GregorianCalendar)localObject1).get(1) == ((GregorianCalendar)localObject2).get(1)) {
      return android.text.format.DateFormat.format(paramContext.getString(a.h.fmt_date), l1) + " " + X(paramContext, paramInt) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
    }
    return android.text.format.DateFormat.format(paramContext.getString(a.h.fmt_longdate), l1) + " " + X(paramContext, paramInt) + ";" + an(paramContext.getString(a.h.fmt_normal_time), l1);
  }
  ...
  private static CharSequence X(Context paramContext, int paramInt)
  {
    if (paramInt < 0) {
      return "";
    }
  ...
  public static String an(String paramString, long paramLong)
  {
  ...
  public static CharSequence c(Context paramContext, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((((Time)localObject3).year == ((Time)localObject1).year) && (((Time)localObject3).yearDay == ((Time)localObject1).yearDay))
      {
        ...
        return X(paramContext, ((Time)localObject3).hour) + g.a(paramContext.getString(a.h.fmt_normal_time), (Time)localObject3);
      }
      if ((((Time)localObject3).year == ((Time)localObject1).year) && (((Time)localObject1).yearDay - ((Time)localObject3).yearDay == 1))
      {
        ...
        if (bool) {}
        for (paramContext = g.a(paramContext.getString(a.h.fmt_normal_time_24), (Time)localObject3);; paramContext = X(paramContext, ((Time)localObject3).hour) + g.a(paramContext.getString(a.h.fmt_normal_time), (Time)localObject3)) {
          return paramContext;
        }
      }
  ...
  {
    if (System.currentTimeMillis() - qBp > 30000L) {
      qBq = android.text.format.DateFormat.is24HourFormat(ad.getContext());
    }
    return qBq;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/pluginsdk/f/h.class
