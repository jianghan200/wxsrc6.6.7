  ...
  extends l
{
  ...
  {
    // Byte code:
    //   0: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   3: invokevirtual 23	com/tencent/mm/memory/h:bW	()Ljava/lang/Object;
    ...
    //   25: aload_3
    //   26: ifnull +83 -> 109
    //   29: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   32: aload_3
    //   33: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   36: pop
    //   37: aload_0
    //   38: areturn
    //   39: astore_1
    ...
    //   56: aastore
    //   57: invokestatic 51	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   60: aload_0
    //   61: ifnull +46 -> 107
    //   64: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   67: aload_0
    //   68: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   71: pop
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    ...
    //   77: aload_0
    //   78: ifnull +11 -> 89
    //   81: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   84: aload_0
    //   85: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   88: pop
    //   89: aload_1
    //   90: athrow
    //   91: astore_1
  ...
  private static Bitmap a(InputStream paramInputStream, Rect paramRect, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramRect)
      {
        ...
        x.e("MicroMsg.InBitmapFactory", "decodeInternal error: %s", new Object[] { paramRect.getMessage() });
      ...
      try
      {
        if (paramInputStream.getWidth() > paramRect.right - paramRect.left)
        {
          ...
          {
            x.i("MicroMsg.InBitmapFactory", "fuck region decode size not match, clip it, reqWidth: %s, reqHeight: %s, resultWidth: %s, resultHeight: %s", new Object[] { Integer.valueOf(paramRect.right - paramRect.left), Integer.valueOf(paramRect.bottom - paramRect.top), Integer.valueOf(paramInputStream.getWidth()), Integer.valueOf(paramInputStream.getHeight()) });
            paramOptions = Bitmap.createBitmap(paramInputStream, 0, 0, paramRect.right - paramRect.left, paramRect.bottom - paramRect.top);
          }
        }
        if (paramOptions != null) {
          x.i("MicroMsg.InBitmapFactory", "finish decode, decodedBitmap: %s, width: %s, height: %s", new Object[] { paramOptions, Integer.valueOf(paramOptions.getWidth()), Integer.valueOf(paramOptions.getHeight()) });
        }
        return paramOptions;
      }
      catch (Exception paramRect)
      ...
      x.printErrStackTrace("MicroMsg.InBitmapFactory", localException, "decode with inBitmap error: %s, outWidth: %s, outHeight: %s, sampleSize: %s, reuseBitmapWidth: %s, reuseBitmapHeight: %s", new Object[] { str, Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i), Integer.valueOf(j) });
    }
  }
  ...
  private static BitmapFactory.Options a(InputStream paramInputStream, BitmapFactory.Options paramOptions, ByteBuffer paramByteBuffer, boolean paramBoolean, Rect paramRect)
  {
    ...
    if (paramRect == null)
    {
      x.i("MicroMsg.InBitmapFactory", "options.outWidth: %s, options.outHeight: %s, sampleSize: %s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Integer.valueOf(localOptions.inSampleSize) });
      if (!paramBoolean) {
        break label399;
      }
      paramInputStream = c.duT;
      paramOptions = c.duT;
    ...
    {
      x.i("MicroMsg.InBitmapFactory", "bitmapToReuse: %s, isRecycle: %s, isRegionDecode: %s, width: %s, height: %s", new Object[] { paramInputStream, Boolean.valueOf(bool), Boolean.valueOf(paramBoolean), Integer.valueOf(i), Integer.valueOf(j) });
      ...
      x.i("MicroMsg.InBitmapFactory", "mimetype: %s", new Object[] { localOptions.outMimeType });
      return localOptions;
      j = paramRect.right - paramRect.left;
      i = paramRect.bottom - paramRect.top;
      x.i("MicroMsg.InBitmapFactory", "region decode, width: %s, height: %s, rect: %s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramRect });
      break;
      paramInputStream = c.duT;
      paramOptions = c.duT;
  ...
  public final Bitmap a(String paramString, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 241	com/tencent/mm/modelsfs/FileOp:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   4: astore 4
    //   6: aload 4
    //   8: astore_1
    //   9: aload 4
    //   11: aload_2
    //   12: aload_3
    //   13: invokestatic 243	com/tencent/mm/memory/j:a	(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lcom/tencent/mm/sdk/platformtools/MMBitmapFactory$DecodeResultLogger;)Landroid/graphics/Bitmap;
    //   16: astore_2
    //   17: aload 4
    //   19: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   22: aload_2
    //   23: areturn
    //   24: astore_2
    //   25: aconst_null
    ...
    //   46: aastore
    //   47: invokestatic 137	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   50: aload 4
    //   52: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   55: aconst_null
    //   56: areturn
    //   57: astore_2
    //   58: aconst_null
    //   59: astore_1
    //   60: aload_1
    //   61: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   64: aload_2
    //   65: athrow
    //   66: astore_2
    //   67: goto -7 -> 60
  ...
  public final Bitmap a(String paramString, Rect paramRect, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    //   1: invokestatic 241	com/tencent/mm/modelsfs/FileOp:openRead	(Ljava/lang/String;)Ljava/io/InputStream;
    //   4: astore_1
    //   5: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   8: invokevirtual 23	com/tencent/mm/memory/h:bW	()Ljava/lang/Object;
    ...
    //   33: aload 5
    //   35: ifnull +12 -> 47
    //   38: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   41: aload 5
    //   43: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   46: pop
    //   47: aload_1
    //   48: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   51: aload_2
    //   52: areturn
    //   53: astore_2
    //   54: aconst_null
    ...
    //   72: aastore
    //   73: invokestatic 51	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   76: aload_1
    //   77: ifnull +11 -> 88
    //   80: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   83: aload_1
    //   84: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   87: pop
    //   88: aload_3
    //   89: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   92: aconst_null
    //   93: areturn
    //   94: astore_2
    //   95: aconst_null
    ...
    //   99: aload_1
    //   100: ifnull +11 -> 111
    //   103: getstatic 19	com/tencent/mm/memory/h:dvb	Lcom/tencent/mm/memory/h;
    //   106: aload_1
    //   107: invokevirtual 35	com/tencent/mm/memory/h:j	(Ljava/lang/Object;)Z
    //   110: pop
    //   111: aload_3
    //   112: invokestatic 248	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   115: aload_2
    //   116: athrow
    //   117: astore_2
    //   118: aconst_null
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/memory/j.class
