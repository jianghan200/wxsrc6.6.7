...
public final class a
{
  ...
  public static void a(android.widget.TextView paramTextView, JSONObject paramJSONObject)
  {
    ...
    //   15: astore_3
    //   16: aload_3
    //   17: invokestatic 22	com/tencent/mm/sdk/platformtools/bi:oW	(Ljava/lang/String;)Z
    //   20: ifne +11 -> 31
    //   23: aload_0
    //   24: aload_3
    //   25: invokestatic 28	com/tencent/mm/plugin/appbrand/q/f:vO	(Ljava/lang/String;)I
    ...
    //   39: d2f
    //   40: invokestatic 44	com/tencent/mm/plugin/appbrand/q/f:ae	(F)F
    ...
    //   104: invokestatic 91	com/tencent/mm/plugin/appbrand/q/f:a	(Lorg/json/JSONObject;Ljava/lang/String;I)I
    //   107: istore_2
    //   108: aload_0
    //   109: instanceof 93
    //   112: ifeq +11 -> 123
  ...
  public static void a(p paramp, ImageView paramImageView, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        String str = paramJSONObject.getString("iconPath");
        if (!TextUtils.isEmpty(str))
        {
          if (str.startsWith("wxfile://"))
          {
            paramJSONObject = AppBrandLocalMediaObjectManager.getItemByLocalId(paramp.mAppId, str);
            paramp = (p)localObject;
            if (paramJSONObject != null)
            {
              paramp = (p)localObject;
              if (!TextUtils.isEmpty(paramJSONObject.dDG))
              {
                paramJSONObject = paramJSONObject.dDG;
                paramp = paramJSONObject;
                if (!paramJSONObject.startsWith("file://")) {
                  paramp = "file://" + paramJSONObject;
                }
                paramp = b.Ka().a(paramp, null);
              }
            }
          }
          while ((paramp == null) || (paramp.isRecycled()))
          {
            ...
            {
              paramJSONObject = b.Ka().a(str, null);
              paramp = paramJSONObject;
              if (paramJSONObject == null)
              {
                b.Ka().a(paramImageView, str, null, null);
                paramp = paramJSONObject;
              }
            }
            else
            {
              paramp = o.j(paramp.fdO, str);
            }
          }
          paramImageView.setImageBitmap(paramp);
          return;
        }
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/o/a.class
