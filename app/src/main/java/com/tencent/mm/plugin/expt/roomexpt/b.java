  ...
  extends i<e>
{
  ...
  public static final String[] diD = { i.a(e.dhO, "RoomMuteExpt"), "CREATE UNIQUE INDEX IF NOT EXISTS namedayIndex ON RoomMuteExpt( chatroom,daySec )" };
  com.tencent.mm.sdk.e.e diF;
  
  public b(com.tencent.mm.sdk.e.e parame)
  {
    super(parame, e.dhO, "RoomMuteExpt", ciG);
    this.diF = parame;
  }
  ...
  public final Cursor aIC()
  {
    try
    {
      Cursor localCursor = this.diF.rawQuery("SELECT chatroom, nickname, isMute, count(daySec), sum(score) FROM RoomMuteExpt group by chatroom", null);
      return localCursor;
    }
    catch (Exception localException)
    {
      x.printErrStackTrace("MicroMsg.ChatRoomExptStorage", localException, "get calc cursor", new Object[0]);
    }
    return null;
  }
  
  /* Error */
  public final java.util.List<e> aID()
  {
    // Byte code:
    ...
    //   7: astore 4
    //   9: aload_0
    //   10: getfield 40	com/tencent/mm/plugin/expt/roomexpt/b:diF	Lcom/tencent/mm/sdk/e/e;
    //   13: ldc 22
    //   15: aconst_null
    //   16: aconst_null
    //   17: aconst_null
    ...
    //   86: invokestatic 64	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   89: aload_2
    //   90: ifnull +9 -> 99
    //   93: aload_2
  ...
  /* Error */
  public final e cG(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	com/tencent/mm/plugin/expt/roomexpt/b:diF	Lcom/tencent/mm/sdk/e/e;
    //   4: ldc 22
    //   6: aconst_null
    //   7: ldc 117
    //   9: iconst_2
    ...
    //   101: aastore
    //   102: invokestatic 130	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   105: aload_1
    //   106: astore_3
    //   107: aload_2
    //   108: ifnull -32 -> 76
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/plugin/expt/roomexpt/b.class
