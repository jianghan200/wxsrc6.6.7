...
public final class d
{
  ...
  public static String IO(String paramString)
  {
    ...
    //   16	72	4	k	int
    //   26	32	5	m	int
    //   11	102	6	localStringBuilder	StringBuilder
    // Exception table:
    //   from	to	target	type
    //   64	71	77	finally
    //   78	80	80	finally
  ...
  public static String q(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      int k = i + 1;
      arrayOfChar[i] = aca[(j >>> 4 & 0xF)];
      i = k + 1;
      arrayOfChar[k] = aca[(j & 0xF)];
      paramInt1 += 1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/normsg/b/d.class
