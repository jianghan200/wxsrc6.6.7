  ...
  extends LinearLayout
{
  ...
  public MallProductItemView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.lSS = paramAttributeSet.getInt(a.k.MallProductItemView_android_lines, 1);
    ...
    this.lSl = ((ImageView)paramContext.findViewById(a.f.indecator_iv));
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/product/ui/MallProductItemView.class
