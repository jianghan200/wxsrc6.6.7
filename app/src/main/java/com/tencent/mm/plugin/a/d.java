...
{
  private static final int eyB = S(new byte[] { 102, 114, 101, 101 });
  private static final int eyC = S(new byte[] { 106, 117, 110, 107 });
  private static final int eyD = S(new byte[] { 109, 100, 97, 116 });
  private static final int eyE = S(new byte[] { 109, 111, 111, 118 });
  private static final int eyF = S(new byte[] { 112, 110, 111, 116 });
  private static final int eyG = S(new byte[] { 115, 107, 105, 112 });
  private static final int eyH = S(new byte[] { 119, 105, 100, 101 });
  private static final int eyI = S(new byte[] { 80, 73, 67, 84 });
  private static final int eyJ = S(new byte[] { 102, 116, 121, 112 });
  private static final int eyK = S(new byte[] { 117, 117, 105, 100 });
  private static final int eyL = S(new byte[] { 99, 109, 111, 118 });
  private static final int eyM = S(new byte[] { 115, 116, 99, 111 });
  private static final int eyN = S(new byte[] { 99, 111, 54, 52 });
  ...
  private static boolean aI(String paramString1, String paramString2)
  {
    ...
    //   34: ldc -112
    //   36: ldc -16
    //   38: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   41: iconst_0
    //   42: ireturn
    ...
    //   50: aload_0
    //   51: invokevirtual 248	com/tencent/mm/plugin/a/b:oY	(Ljava/lang/String;)J
    //   54: lstore 4
    ...
    //   67: aload_0
    //   68: lload 4
    //   70: invokevirtual 255	com/tencent/mm/plugin/a/f:s	(Ljava/lang/String;J)Z
    //   73: pop
    //   74: aload 9
    //   76: getfield 258	com/tencent/mm/plugin/a/f:eyV	I
    //   79: istore_3
    //   80: new 242	com/tencent/mm/plugin/a/b
    //   83: dup
    //   84: invokespecial 244	com/tencent/mm/plugin/a/b:<init>	()V
    //   87: aload_1
    //   88: invokevirtual 248	com/tencent/mm/plugin/a/b:oY	(Ljava/lang/String;)J
    //   91: lstore 4
    ...
    //   104: aload_1
    //   105: lload 4
    //   107: invokevirtual 255	com/tencent/mm/plugin/a/f:s	(Ljava/lang/String;J)Z
    //   110: pop
    //   111: aload 8
    //   113: getfield 258	com/tencent/mm/plugin/a/f:eyV	I
    //   116: istore_2
    //   117: iload_2
    //   118: iload_3
    ...
    //   122: ldc -112
    //   124: ldc_w 260
    //   127: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   130: iconst_0
    //   131: ireturn
    //   132: ldc -112
    ...
    //   161: invokestatic 157	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   256: ldc -112
    //   258: ldc_w 290
    //   261: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   264: iconst_0
    //   265: ireturn
    //   266: iload_3
    //   267: iconst_1
    ...
    //   352: ldc -112
    //   354: ldc_w 309
    //   357: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   360: aload 6
    ...
    //   410: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   413: aload 6
    //   415: ifnull +8 -> 423
    //   418: aload 6
    ...
    //   0	529	0	paramString1	String
    //   0	529	1	paramString2	String
    //   116	154	2	i	int
    //   79	190	3	j	int
    //   54	52	4	l	long
  ...
  public static boolean b(String paramString1, String paramString2, PInt paramPInt)
  {
    ...
    //   90: aload_0
    //   91: aload_1
    //   92: invokestatic 329	com/tencent/mm/plugin/a/d:aI	(Ljava/lang/String;Ljava/lang/String;)Z
    //   95: istore 4
    //   97: aload 5
    //   99: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   102: aload 8
    //   104: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   107: iload 4
    //   109: ifne +9 -> 118
    //   112: aload 9
    ...
    //   156: invokestatic 152	com/tencent/mm/sdk/platformtools/x:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   159: aload 5
    //   161: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   164: aload_1
    //   165: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   168: iload_3
    //   169: istore 4
    //   171: goto -64 -> 107
    //   174: astore_0
    ...
    //   179: astore 5
    //   181: aload 5
    //   183: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   186: aload 7
    //   188: invokestatic 333	com/tencent/mm/plugin/a/d:e	(Ljava/io/Closeable;)V
    //   191: aload_0
    //   192: athrow
    //   193: astore_0
    //   194: aconst_null
  ...
  private static int bJ(long paramLong)
  {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/a/d.class
