  ...
  implements a
{
  ...
  /* Error */
  static String Cc(String paramString)
  {
    // Byte code:
    ...
    //   60: aload_2
    //   61: aastore
    //   62: invokestatic 69	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   65: aload_0
    //   66: ifnull +7 -> 73
    //   69: aload_0
    ...
    //   102: aastore
    //   103: invokestatic 82	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   106: aload_0
    //   107: ifnull -24 -> 83
    //   110: aload_0
  ...
  private void aPj()
  {
    this.jkG.a(FreeWifiFrontPageUI.d.jnj, FreeWifiFrontPageUI.a.jnf);
  }
  
  static String cQ(String paramString1, String paramString2)
  {
      ...
      for (;;)
      {
        ...
        while (i < j)
        {
          ...
          if (((String)localObject).startsWith(paramString2)) {
            return ((String)localObject).substring(paramString2.length());
          }
          i += 1;
        }
        break;
  ...
  {
    j.aON().aOv().post(new g.1(this));
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/plugin/freewifi/e/g.class
