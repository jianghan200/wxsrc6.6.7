  ...
  extends i
{
  ...
  public int pfo = 0;
  public com.tencent.mm.plugin.wallet.pay.a.c pfp = null;
  private int scene = 0;
  ...
  public e(PayInfo paramPayInfo, int paramInt)
  {
    ...
    {
      if (paramPayInfo != null) {
        this.bVY = paramPayInfo.bVY;
      }
      a(paramPayInfo, localHashMap1, localHashMap2);
      F(localHashMap1);
      aC(localHashMap2);
      return;
      this.pfn = paramPayInfo.bOd;
      break;
      label253:
  ...
  public final void a(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    for (;;)
    {
      try
      {
        ...
        if (l > 0L)
        {
          ...
          if (paramString != null)
          {
            ...
            com.tencent.mm.plugin.wallet_core.model.o.bOW().prL = (paramString.optInt("query_order_time", 5) * 1000);
            com.tencent.mm.plugin.wallet_core.model.o.bOW().mRetryCount = paramString.optInt("query_order_count", 0);
            com.tencent.mm.plugin.wallet_core.model.o.bOW().prM = paramString.optString("default_query_order_wording", "");
          }
          paramString = paramJSONObject.optString("pay_remind_wording");
          com.tencent.mm.plugin.wallet_core.model.o.bOW().prN = paramString;
          ab.a(paramJSONObject.optJSONObject("bindqueryresp"), this.bVY);
          ...
          if (paramString != null)
          {
            ...
            if (paramJSONObject.has("real_name_info"))
            {
              ...
              this.pfo = paramString.optInt("guide_type", 0);
            }
      ...
      {
        x.e("MicroMsg.NetSceneTenpayQueryOrderInfoByQRCode", "hy: " + paramString.toString());
        return;
      }
      continue;
      label336:
      ...
      else
      {
        ...
        paramString.peW = paramInt;
        paramString.peX = paramJSONObject;
        paramString.kRu = str1;
        paramString.kRv = str2;
        paramString.peY = str3;
      }
    }
  }
  ...
  public final void a(com.tencent.mm.wallet_core.c.c paramc, JSONObject paramJSONObject)
  {
    ...
    int i = this.bVY;
    paramJSONObject = this.pfn;
    int j = paramc.errCode;
    x.v("Micromsg.WalletPayLinkReport", "kvQrcode scene %s reqKey %s errcode %s", new Object[] { Integer.valueOf(i), paramJSONObject, Integer.valueOf(j) });
    h.mEJ.h(15000, new Object[] { Integer.valueOf(i), paramJSONObject, Integer.valueOf(j) });
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/plugin/wallet/pay/a/c/e.class
