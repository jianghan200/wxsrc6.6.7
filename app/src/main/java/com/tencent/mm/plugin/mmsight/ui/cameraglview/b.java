  ...
  implements GLSurfaceView.Renderer
{
  ...
  public final void b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        if ((this.fav != paramInt2) || (this.fau != paramInt1) || (this.bYE != paramInt3)) {
          break label315;
        }
        if (this.faL == paramBoolean) {
          break label309;
        }
      }
      catch (Exception paramArrayOfByte)
      {
        x.e("MicroMsg.MMSightCameraGLRenderer", "setDrawFrame error: %s", new Object[] { paramArrayOfByte.getMessage() });
        return;
      }
      if (i != 0) {
        x.d("MicroMsg.MMSightCameraGLRenderer", "setDrawFrame, frameData: %s, frameWidth: %s, frameHeight: %s, rotate: %s, isLandScape, frameSizeChange: %s, this %s", new Object[] { paramArrayOfByte, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Boolean.valueOf(paramBoolean), Boolean.valueOf(true), this });
      }
      this.fat = paramArrayOfByte;
      this.fau = paramInt1;
      this.fav = paramInt2;
      this.bYE = paramInt3;
      ...
      if (i != 0)
      {
        this.faw = ByteBuffer.allocateDirect(paramInt2 * paramInt1);
        this.fax = ByteBuffer.allocateDirect(paramInt1 * paramInt2 / 2);
      ...
      this.faw.put(paramArrayOfByte, 0, paramInt1 * paramInt2);
      this.faw.position(0);
      this.fax.put(paramArrayOfByte, paramInt1 * paramInt2, paramInt1 * paramInt2 / 2);
      this.fax.position(0);
      return;
      this.faK = fap;
      continue;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes7-dex2jar.jar!/com/tencent/mm/plugin/mmsight/ui/cameraglview/b.class
