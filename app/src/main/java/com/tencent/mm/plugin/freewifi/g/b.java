...
public final class b
  extends i<a>
{
  public static final String[] diD = { i.a(a.dhO, "FreeWifiConfig"), "CREATE INDEX IF NOT EXISTS idx_freewificonfig_key  on FreeWifiConfig  (  key )" };
  public static Map<String, String> jlN = new ConcurrentHashMap();
  
  public b(e parame)
  {
    super(parame, a.dhO, "FreeWifiConfig", null);
  }
  ...
  public final String Ce(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (jlN != null)
        {
          localObject2 = (String)jlN.get(paramString);
      ...
      catch (Exception localException)
      {
        ...
        for (;;)
        {
          x.e("MicroMsg.FreeWifi.FreeWifiConfigStorage", "Map get error!");
        }
        try
        {
  ...
  public final String aPl()
  {
    ...
    //   107: invokestatic 141	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   110: aload_2
    ...
    //   144: invokestatic 141	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: aload_2
    ...
    //   7	29	2	localStringBuilder	StringBuilder
  ...
  public final void cR(String paramString1, String paramString2)
  {
    ...
    //   11: ifeq +4 -> 15
    //   14: return
    //   15: getstatic 37	com/tencent/mm/plugin/freewifi/g/b:jlN	Ljava/util/Map;
    //   18: ifnull +28 -> 46
    //   21: getstatic 37	com/tencent/mm/plugin/freewifi/g/b:jlN	Ljava/util/Map;
    //   24: invokeinterface 156 1 0
    //   29: sipush 1000
    //   32: if_icmpge +96 -> 128
    //   35: getstatic 37	com/tencent/mm/plugin/freewifi/g/b:jlN	Ljava/util/Map;
    //   38: aload_1
    //   39: aload_2
    ...
    //   127: return
    //   128: getstatic 37	com/tencent/mm/plugin/freewifi/g/b:jlN	Ljava/util/Map;
    //   131: invokeinterface 145 1 0
    //   136: getstatic 37	com/tencent/mm/plugin/freewifi/g/b:jlN	Ljava/util/Map;
    //   139: aload_1
    //   140: aload_2
    ...
    //   151: ldc 88
    //   153: ldc -74
    //   155: invokestatic 96	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   158: goto -112 -> 46
    //   161: aload_0
    //   162: aload 4
    //   164: iconst_0
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/plugin/freewifi/g/b.class
