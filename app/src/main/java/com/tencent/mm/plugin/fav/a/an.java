...
public final class an
{
  ...
  public static int Oe()
  {
    ...
    //   7: dup
    //   8: invokestatic 32	com/tencent/mm/plugin/fav/a/an:aLR	()Ljava/lang/String;
    //   11: ldc 34
    ...
    //   117: aastore
    //   118: invokestatic 92	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   121: aload_2
    //   122: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   125: iload_0
    //   126: ireturn
    //   127: astore_3
    //   128: aconst_null
    ...
    //   134: aload_3
    //   135: aload_3
    //   136: invokevirtual 100	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   139: iconst_0
    //   140: anewarray 4	java/lang/Object
    //   143: invokestatic 104	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   146: aload_2
    //   147: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   150: iconst_1
    //   151: ireturn
    //   152: astore_2
    //   153: aconst_null
    //   154: astore_1
    //   155: aload_1
    //   156: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   159: aload_2
    //   160: athrow
    //   161: astore_2
    //   162: goto -7 -> 155
  ...
  {
    // Byte code:
    //   0: invokestatic 111	com/tencent/mm/sdk/platformtools/ad:getContext	()Landroid/content/Context;
    //   3: invokevirtual 117	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   6: astore_1
    //   7: aload_1
    //   8: ldc 119
    //   10: invokevirtual 125	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   13: astore_2
    ...
    //   143: aastore
    //   144: invokestatic 92	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   147: aload_2
    //   148: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   151: aload 4
    //   153: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   156: aload_1
    //   157: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   160: iload_0
    //   161: ireturn
    //   162: astore_3
    //   163: aconst_null
    ...
    //   182: aload_3
    //   183: aload_3
    //   184: invokevirtual 100	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   187: iconst_0
    //   188: anewarray 4	java/lang/Object
    //   191: invokestatic 104	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   194: aload_2
    //   195: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   198: aload 4
    //   200: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   203: aload_1
    //   204: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   207: iconst_1
    //   208: ireturn
    //   209: astore_1
    //   210: aconst_null
    ...
    //   216: astore_2
    //   217: aload_2
    //   218: invokestatic 97	com/tencent/mm/a/e:f	(Ljava/io/InputStream;)V
    //   221: aload 4
    //   223: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   226: aload_3
    //   227: invokestatic 128	com/tencent/mm/a/e:a	(Ljava/io/Reader;)V
    //   230: aload_1
    //   231: athrow
    //   232: astore_1
    //   233: aconst_null
  ...
  {
    if (ax.ciI() > 1048576L) {}
    for (File localFile = new File(eO(false), "wenote/res");; localFile = new File(com.tencent.mm.compatible.util.e.bnE, "wenote/res")) {
  ...
  {
    File localFile = new File(eO(false), "wenote/res");
    if (new File(localFile, "WNNote.zip").exists()) {
      return localFile.getAbsolutePath();
    }
    localFile = new File(com.tencent.mm.compatible.util.e.bnE, "wenote/res");
    if (new File(localFile, "WNNote.zip").exists()) {
      return localFile.getAbsolutePath();
    }
    return "";
  ...
  {
    File localFile = new File(eO(true), "wenote/loc/data");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return localFile.getAbsolutePath();
  ...
  public static String aLT()
  {
    ...
    File localFile = new File(eO(false), "wenote/html/upload");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  {
    File localFile = new File(eO(true), "wenote/image/localpath");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return localFile.getAbsolutePath();
  ...
  {
    File localFile = new File(eO(true), "wenote/voice/data");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return localFile.getAbsolutePath();
  ...
  private static String eO(boolean paramBoolean)
  {
    if (paramBoolean) {
      return g.Ei().dqp;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/plugin/fav/a/an.class
