...
public final class b
  extends i<a>
{
  public static final String[] ciG = { "CREATE  INDEX IF NOT EXISTS msgid_username_index ON WxFileIndex2 ( msgId,username,msgSubType ) ", "CREATE  INDEX IF NOT EXISTS username_type_index ON WxFileIndex2 ( username,msgtime,msgSubType ) " };
  public static final String[] diD = { i.a(a.dhO, "WxFileIndex2"), "DROP TABLE IF EXISTS WxFileIndex" };
  public e diF;
  
  public b(e parame)
  {
    super(parame, a.dhO, "WxFileIndex2", ciG);
    this.diF = parame;
  }
  
  /* Error */
  public final List<a> O(com.tencent.mm.storage.bd parambd)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   19: aload_1
    //   20: getfield 61	com/tencent/mm/g/c/cm:field_msgId	J
    ...
    //   31: aload_1
    //   32: getfield 74	com/tencent/mm/g/c/cm:field_talker	Ljava/lang/String;
    ...
    //   58: astore_1
    //   59: aload_0
    //   60: getfield 44	com/tencent/mm/plugin/j/b/b:diF	Lcom/tencent/mm/sdk/e/e;
    //   63: aload 5
    //   65: aconst_null
    ...
    //   87: aload_3
    //   88: astore_2
    //   89: new 16	com/tencent/mm/plugin/j/b/a
    //   92: dup
    //   93: invokespecial 97	com/tencent/mm/plugin/j/b/a:<init>	()V
    //   96: astore 5
    //   98: aload_3
    //   99: astore_1
    //   100: aload_3
    ...
    //   102: aload 5
    //   104: aload_3
    //   105: invokevirtual 101	com/tencent/mm/plugin/j/b/a:d	(Landroid/database/Cursor;)V
    //   108: aload_3
    //   109: astore_1
    //   110: aload_3
    //   111: astore_2
    ...
    //   0	165	0	this	b
    //   0	165	1	parambd	com.tencent.mm.storage.bd
  ...
  public final long avB()
  {
    ...
    try
    {
      Cursor localCursor = this.diF.rawQuery("select sum(size)  from WxFileIndex2 where msgSubType in (1,20,23,30,32,34 )", null);
      long l1 = l2;
      if (localCursor != null)
      {
        l1 = l2;
  ...
  public final Cursor avC()
  {
    try
    {
      Cursor localCursor = this.diF.rawQuery("select username,  sum(size) as total from WxFileIndex2 where size > 0  and msgSubType in (1,20,23,30,32,34 ) group by username order by total desc", null);
      return localCursor;
    }
  ...
  public final int aw(List<a> paramList)
  {
    ...
    x.d("MicroMsg.WxFileIndexStorage", "insert list result[%d %d] cost[%d]", new Object[] { Integer.valueOf(i), Integer.valueOf(paramList.size()), Long.valueOf(bi.bI(l)) });
    return i;
  }
  
  public final int ax(List<a> paramList)
  {
    if (paramList.isEmpty()) {
      return 0;
    }
    ...
    x.d("MicroMsg.WxFileIndexStorage", "update list result[%d %d] cost[%d]", new Object[] { Integer.valueOf(i), Integer.valueOf(paramList.size()), Long.valueOf(bi.bI(l)) });
    return i;
  }
  ...
  public final boolean delete()
  {
    try
    {
      int i = this.diF.delete("WxFileIndex2", null, null);
      l = i;
    }
    catch (Exception localException)
    {
  ...
  /* Error */
  public final List<a> i(String paramString, long paramLong1, long paramLong2)
  {
    // Byte code:
    //   0: invokestatic 137	com/tencent/mm/sdk/platformtools/bi:VG	()J
    //   3: lstore 6
    ...
    //   60: astore 8
    //   62: aload_0
    //   63: getfield 44	com/tencent/mm/plugin/j/b/b:diF	Lcom/tencent/mm/sdk/e/e;
    //   66: aload 11
    //   68: aconst_null
    ...
    //   103: aload 10
    //   105: astore 9
    //   107: new 16	com/tencent/mm/plugin/j/b/a
    //   110: dup
    //   111: invokespecial 97	com/tencent/mm/plugin/j/b/a:<init>	()V
    //   114: astore 13
    //   116: aload 10
    //   118: astore 8
    //   120: aload 10
    ...
    //   124: aload 13
    //   126: aload 10
    //   128: invokevirtual 101	com/tencent/mm/plugin/j/b/a:d	(Landroid/database/Cursor;)V
    //   131: aload 10
    //   133: astore 8
    //   135: aload 10
    //   137: astore 9
    ...
    //   162: ldc -47
    //   164: iconst_1
    //   165: anewarray 159	java/lang/Object
    //   168: dup
    //   169: iconst_0
    //   170: aload 11
    //   172: aastore
    //   173: invokestatic 213	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   176: aload 8
    //   178: ifnull +10 -> 188
    //   181: aload 8
    ...
    //   190: ldc -41
    //   192: iconst_3
    //   193: anewarray 159	java/lang/Object
    //   196: dup
    //   197: iconst_0
    //   198: aload_1
    //   199: aastore
    ...
    //   201: iconst_1
    //   202: aload 12
    //   204: invokeinterface 169 1 0
    //   209: invokestatic 165	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   212: aastore
    //   213: dup
    //   214: iconst_2
    //   215: lload 6
    //   217: invokestatic 173	com/tencent/mm/sdk/platformtools/bi:bI	(J)J
    //   220: invokestatic 178	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   223: aastore
    //   224: invokestatic 217	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   227: aload 12
    //   229: areturn
    //   230: aload 10
    //   232: ifnull -44 -> 188
  ...
  public final long nC(int paramInt)
  {
    Object localObject1 = null;
    long l2 = 0L;
    ...
    try
    {
      localObject2 = this.diF.rawQuery((String)localObject2, null);
      long l1 = l2;
  ...
  public final long nD(int paramInt)
  {
    Object localObject1 = null;
    long l2 = 0L;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/j/b/b.class
