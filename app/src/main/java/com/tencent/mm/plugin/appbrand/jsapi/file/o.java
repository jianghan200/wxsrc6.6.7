  ...
  extends a
{
  ...
  /* Error */
  static String B(java.io.File paramFile)
  {
    // Byte code:
    //   0: ldc 26
    ...
    //   60: aload_0
    //   61: aastore
    //   62: invokestatic 64	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   65: ldc 52
    //   67: areturn
    //   68: astore_0
    //   69: ldc 54
    ...
    //   79: aload_0
    //   80: aastore
    //   81: invokestatic 64	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   84: ldc 52
    //   86: areturn
    ...
    //   122: aload_0
    //   123: aastore
    //   124: invokestatic 64	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   127: aload_2
    //   128: areturn
    //   129: astore_0
    //   130: ldc 54
    ...
    //   140: aload_0
    //   141: aastore
    //   142: invokestatic 64	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   145: ldc 52
    //   147: areturn
    //   148: astore_2
    //   149: aload_0
    ...
    //   166: aload_0
    //   167: aastore
    //   168: invokestatic 64	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   171: goto -18 -> 153
  ...
  {
    String str1 = paraml.mAppId;
    String str2 = paramJSONObject.optString("filePath", "");
    if (!"sha1".equalsIgnoreCase(paramJSONObject.optString("digestAlgorithm", "md5"))) {}
    for (paramJSONObject = "md5"; bi.oW(str2); paramJSONObject = "sha1")
    {
      paraml.E(paramInt, f("fail:invalid data", null));
      return;
    }
    com.tencent.mm.sdk.f.e.post(new o.1(this, str1, str2, paraml, paramInt, paramJSONObject), "AppBrandJsApiGetFileInfo");
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/file/o.class
