  ...
  extends i<b>
{
  ...
  public static final String[] diD = { i.a(b.dhO, "ExptKeyMapId") };
  private e diF;
  
  public c(e parame)
  {
    super(parame, b.dhO, "ExptKeyMapId", ciG);
    this.diF = parame;
  }
  
  /* Error */
  public final int AD(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	com/tencent/mm/plugin/expt/c/c:diF	Lcom/tencent/mm/sdk/e/e;
    //   4: ldc 22
    //   6: iconst_1
    ...
    //   106: aastore
    //   107: invokestatic 81	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload 4
    //   112: ifnull +10 -> 122
    //   115: aload 4
  ...
  /* Error */
  public final b AE(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	com/tencent/mm/plugin/expt/c/c:diF	Lcom/tencent/mm/sdk/e/e;
    ...
    //   110: aastore
    //   111: invokestatic 81	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   114: aload_2
    //   115: astore 4
    //   117: aload_3
    //   118: ifnull -39 -> 79
  ...
  public final int aIG()
  {
    try
    {
      int i = this.diF.delete("ExptKeyMapId", null, null);
      return i;
    }
    catch (Exception localException)
    {
      x.e("MicroMsg.ExptKeyMapIdStorage", "delete all expt error[%s]", new Object[] { localException.toString() });
    }
    return 0;
  }
  
  public final int aW(List<b> paramList)
  {
    long l = -1L;
    if (paramList.size() <= 0) {
      return 0;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        i = 0;
        x.e("MicroMsg.ExptKeyMapIdStorage", "insert expt key map id [%s]", new Object[] { localException1.toString() });
        j = i;
        if (localh != null)
        {
          localh.gp(l);
  ...
  public final int aX(List<b> paramList)
  {
    long l = -1L;
    if (paramList.size() <= 0) {
      return 0;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        localException1 = localException1;
        i = 0;
        x.e("MicroMsg.ExptKeyMapIdStorage", "update expt key map id [%s]", new Object[] { localException1.toString() });
        j = i;
        if (localh != null)
        {
          localh.gp(l);
  ...
  public final int aY(List<Integer> paramList)
  {
    long l = -1L;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        localException1 = localException1;
        i = 0;
        x.e("MicroMsg.ExptKeyMapIdStorage", "delete expt by id id [%s] ret[%d]", new Object[] { localException1.toString(), Integer.valueOf(i) });
        j = i;
        if (localh != null)
        {
          localh.gp(l);
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/plugin/expt/c/c.class
