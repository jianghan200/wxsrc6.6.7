...
{
  /* Error */
  private static String N(LinkedList<s.h> paramLinkedList)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 14	com/tencent/mm/sdk/platformtools/bi:cX	(Ljava/util/List;)Z
    //   4: ifeq +6 -> 10
    //   7: ldc 16
    //   9: areturn
    ...
    //   52: checkcast 56	com/tencent/mm/plugin/game/model/s$h
    //   55: astore_3
    //   56: aload_2
    //   57: aconst_null
    //   58: ldc 58
    ...
    //   68: ldc 64
    //   70: aload_3
    //   71: getfield 68	com/tencent/mm/plugin/game/model/s$h:jNs	Ljava/lang/String;
    ...
    //   90: aload_2
    //   91: aload_3
    //   92: getfield 77	com/tencent/mm/plugin/game/model/s$h:userName	Ljava/lang/String;
    //   95: ldc 16
    //   97: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   126: aload_2
    //   127: aload_3
    //   128: getfield 93	com/tencent/mm/plugin/game/model/s$h:bgn	Ljava/lang/String;
    //   131: ldc 16
    //   133: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   162: aload_2
    //   163: aload_3
    //   164: getfield 98	com/tencent/mm/plugin/game/model/s$h:jNp	Ljava/lang/String;
    //   167: ldc 16
    //   169: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   198: aload_2
    //   199: aload_3
    //   200: getfield 103	com/tencent/mm/plugin/game/model/s$h:jNq	Ljava/lang/String;
    //   203: ldc 16
    //   205: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   234: aload_2
    //   235: aload_3
    //   236: getfield 108	com/tencent/mm/plugin/game/model/s$h:jNr	Ljava/lang/String;
    //   239: ldc 16
    //   241: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   280: invokestatic 120	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   283: ldc 16
    //   285: areturn
    //   286: astore 4
    //   288: aload_2
    ...
    //   0	377	0	paramLinkedList	LinkedList<s.h>
  ...
  public static String a(String paramString, LinkedList<s.h> paramLinkedList, HashMap<String, s.d> paramHashMap)
  {
    if ((bi.oW(paramString)) || (bi.cX(paramLinkedList))) {}
    String str1;
    do
    {
      return paramString;
      str1 = N(paramLinkedList);
    } while (bi.oW(str1));
    ...
    try
    {
      ...
      if ((paramHashMap.lastIndexOf("</jump>") != -1) && (!bi.oW(str2))) {
    ...
    catch (Exception paramLinkedList)
    {
      for (;;)
      {
        x.e("MicroMsg.GameXmlProcess", paramLinkedList.getMessage());
        x.e("MicroMsg.GameXmlProcess", "xml is invalid : " + paramString);
      }
    }
  ...
  /* Error */
  private static String a(LinkedList<s.h> paramLinkedList, HashMap<String, s.d> paramHashMap)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 14	com/tencent/mm/sdk/platformtools/bi:cX	(Ljava/util/List;)Z
    ...
    //   59: checkcast 56	com/tencent/mm/plugin/game/model/s$h
    //   62: astore 5
    //   64: aload_1
    //   65: aload 5
    //   67: getfield 68	com/tencent/mm/plugin/game/model/s$h:jNs	Ljava/lang/String;
    //   70: invokevirtual 202	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   73: checkcast 204	com/tencent/mm/plugin/game/model/s$d
    //   76: astore 4
    //   78: aload 4
    //   80: ifnull -36 -> 44
    //   83: aload_3
    ...
    //   95: ldc -48
    //   97: aload 5
    //   99: getfield 68	com/tencent/mm/plugin/game/model/s$h:jNs	Ljava/lang/String;
    ...
    //   118: aload_3
    //   119: aload 4
    //   121: getfield 214	com/tencent/mm/plugin/game/model/s$d:jNj	I
    ...
    //   153: aload_3
    //   154: aload 4
    //   156: getfield 225	com/tencent/mm/plugin/game/model/s$d:iCI	Ljava/lang/String;
    //   159: ldc 16
    //   161: invokestatic 81	com/tencent/mm/sdk/platformtools/bi:aG	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   200: invokestatic 120	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   203: ldc 16
    //   205: areturn
    //   206: astore 5
    //   208: aload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	256	0	paramLinkedList	LinkedList<s.h>
    //   0	256	1	paramHashMap	HashMap<String, s.d>
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/model/ao.class
