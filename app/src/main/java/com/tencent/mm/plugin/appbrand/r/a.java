...
public enum a
{
  ...
  private static boolean a(String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Bitmap.CompressFormat paramCompressFormat, int paramInt5, String paramString2)
  {
    ...
    try
    {
      x.i("MicroMsg.AppBrandImgUtil", "createThumbNailUnScale, srcWidth: %s, srcHeight: %s, width: %s, height: %s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt4), Integer.valueOf(paramInt3) });
      localObject3 = localObject4;
    ...
    catch (IOException paramString1)
    {
      for (;;)
      {
        ...
        label176:
        Object localObject1;
        x.printErrStackTrace("MicroMsg.AppBrandImgUtil", paramString1, "create thumbnail from orig failed: %s", new Object[] { paramString2 });
        ...
        do
        {
          try
          {
            ...
            break label176;
            localObject3 = localObject4;
            x.i("MicroMsg.AppBrandImgUtil", "createThumbNailUnScale, sampleSize: %s", new Object[] { Integer.valueOf(((BitmapFactory.Options)localObject2).inSampleSize) });
            localObject3 = localObject4;
            localObject2 = b(paramString1, (BitmapFactory.Options)localObject2, (MMBitmapFactory.DecodeResultLogger)localObject5);
            break;
            localObject3 = localObject4;
            x.i("MicroMsg.AppBrandImgUtil", "createThumbNailUnScale, bm.width: %s, bm.height: %s", new Object[] { Integer.valueOf(((Bitmap)localObject2).getWidth()), Integer.valueOf(((Bitmap)localObject2).getHeight()) });
            if (d2 < d3)
            {
              localObject3 = localObject4;
            ...
            {
              localObject3 = localObject4;
              paramInt4 = BackwardSupportUtil.ExifHelper.VX(paramString1);
              ...
              localObject3 = localObject4;
              x.i("MicroMsg.AppBrandImgUtil", "createThumbNailUnScalebyUpload, degree %d, bm.width: %s, bm.height: %s", new Object[] { Integer.valueOf(paramInt4), Integer.valueOf(((Bitmap)localObject2).getWidth()), Integer.valueOf(((Bitmap)localObject2).getHeight()) });
              localObject3 = localObject4;
              paramString1 = FileOp.jx(paramString2);
    ...
    localObject3 = localObject4;
    x.i("MicroMsg.AppBrandImgUtil", "createThumbNailUnScale, result bm: %s", new Object[] { localObject2 });
  ...
  private static Bitmap b(String paramString, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    try
    {
      paramString = l.Fu().a(paramString, paramOptions, paramDecodeResultLogger);
      x.d("MicroMsg.AppBrandImgUtil", "decodeWithRotateByExif used %dms bitmap: %s", new Object[] { Long.valueOf(System.currentTimeMillis() - l), paramString });
      return paramString;
    }
    catch (OutOfMemoryError paramString)
    {
      b.cou();
      x.e("MicroMsg.AppBrandImgUtil", "OutOfMemoryError e " + paramString.getMessage());
    }
    return null;
  }
  ...
  {
    paramOptions = paramOptions.outMimeType;
    x.d("MicroMsg.AppBrandImgUtil", "mimetype: " + paramOptions);
    if (paramOptions == null) {
      return "unknown";
    }
    paramOptions = paramOptions.toLowerCase();
  ...
  public static boolean bP(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 215	com/tencent/mm/modelsfs/FileOp:mI	(Ljava/lang/String;)J
    //   4: l2i
    //   5: istore 9
    //   7: aload_1
    //   8: invokestatic 142	com/tencent/mm/sdk/platformtools/c:VZ	(Ljava/lang/String;)Landroid/graphics/BitmapFactory$Options;
    //   11: astore 15
    //   13: aload 15
    //   15: ifnonnull +24 -> 39
    //   18: ldc 39
    ...
    //   28: aload_1
    //   29: aastore
    //   30: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   33: iconst_0
    //   34: istore 10
    //   36: iload 10
    //   38: ireturn
    ...
    //   70: invokestatic 201	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   73: aload 16
    //   75: ifnull +342 -> 417
    //   78: aload 16
    ...
    //   96: istore 11
    //   98: aload 15
    //   100: invokestatic 219	com/tencent/mm/plugin/appbrand/r/a:a	(Landroid/graphics/BitmapFactory$Options;)Z
    //   103: istore 10
    //   105: iconst_m1
    //   106: istore 4
    //   108: iload 10
    ...
    //   207: aastore
    //   208: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   211: iload 6
    //   213: istore_3
    //   214: iload_3
    //   215: istore 6
    ...
    //   297: invokestatic 255	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   300: aload 15
    ...
    //   365: ldc 39
    //   367: ldc_w 259
    //   370: invokestatic 255	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   373: aload_1
    //   374: aload_0
    //   375: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   378: lconst_0
    //   379: lcmp
    //   380: iflt +77 -> 457
    //   383: iconst_1
    ...
    //   448: invokestatic 196	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   451: iload_3
    //   452: istore 6
    //   454: goto -237 -> 217
    //   457: iconst_0
    ...
    //   591: ifne +126 -> 717
    //   594: aload_0
    //   595: invokestatic 215	com/tencent/mm/modelsfs/FileOp:mI	(Ljava/lang/String;)J
    //   598: lstore 13
    //   600: ldc 39
    //   602: ldc_w 313
    //   605: iconst_3
    ...
    //   632: aastore
    //   633: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   636: iload 9
    //   638: i2l
    //   639: lload 13
    //   641: lsub
    ...
    //   661: aload_1
    //   662: aload_0
    //   663: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   666: lstore 13
    //   668: lload 13
    //   670: lconst_0
    //   671: lcmp
    ...
    //   758: invokestatic 78	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   761: aload_0
    //   762: ifnull +7 -> 769
    //   765: aload_0
    ...
    //   802: ldc 39
    //   804: ldc_w 324
    //   807: invokestatic 255	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   810: aload_1
    //   811: aload_0
    //   812: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   815: lconst_0
    //   816: lcmp
    //   817: iflt +5 -> 822
    //   820: iconst_1
    ...
    //   906: aastore
    //   907: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   910: aload_1
    //   911: invokestatic 215	com/tencent/mm/modelsfs/FileOp:mI	(Ljava/lang/String;)J
    //   914: ldc2_w 327
    //   917: lcmp
    //   918: ifge +81 -> 999
    //   921: iload 11
    ...
    //   937: aload_1
    //   938: aastore
    //   939: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   942: aload_1
    //   943: aload_0
    //   944: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   947: lconst_0
    //   948: lcmp
    //   949: iflt +5 -> 954
    //   952: iconst_1
    ...
    //   992: iload 5
    //   994: aload_0
    //   995: invokestatic 335	com/tencent/mm/plugin/appbrand/r/a:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   998: ireturn
    //   999: aload_1
    //   1000: aload 15
    ...
    //   1013: iload 5
    //   1015: aload_0
    //   1016: invokestatic 335	com/tencent/mm/plugin/appbrand/r/a:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   1019: istore 12
    //   1021: iload 12
    //   1023: istore 10
    //   1025: iload 11
    ...
    //   1036: ifne -1000 -> 36
    //   1039: aload_0
    //   1040: invokestatic 215	com/tencent/mm/modelsfs/FileOp:mI	(Ljava/lang/String;)J
    //   1043: lstore 13
    //   1045: ldc 39
    //   1047: ldc_w 313
    //   1050: iconst_3
    ...
    //   1077: aastore
    //   1078: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1081: iload 12
    //   1083: istore 10
    //   1085: iload 9
    //   1087: i2l
    ...
    //   1110: aload_1
    //   1111: aload_0
    //   1112: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   1115: lconst_0
    //   1116: lcmp
    //   1117: iflt +5 -> 1122
    //   1120: iconst_1
    ...
    //   1225: invokestatic 255	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1228: aload 15
    ...
    //   1361: invokestatic 255	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1364: aload_1
    //   1365: iload_3
    //   1366: iload 4
    ...
    //   1371: iload 5
    //   1373: aload_0
    //   1374: invokestatic 335	com/tencent/mm/plugin/appbrand/r/a:a	(Ljava/lang/String;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   1377: istore 12
    //   1379: iload 12
    //   1381: istore 10
    //   1383: iload 11
    ...
    //   1394: ifne -1358 -> 36
    //   1397: aload_0
    //   1398: invokestatic 215	com/tencent/mm/modelsfs/FileOp:mI	(Ljava/lang/String;)J
    //   1401: lstore 13
    //   1403: ldc 39
    //   1405: ldc_w 313
    //   1408: iconst_3
    ...
    //   1435: aastore
    //   1436: invokestatic 55	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   1439: iload 12
    //   1441: istore 10
    //   1443: iload 9
    //   1445: i2l
    ...
    //   1468: aload_1
    //   1469: aload_0
    //   1470: invokestatic 263	com/tencent/mm/modelsfs/FileOp:y	(Ljava/lang/String;Ljava/lang/String;)J
    //   1473: lconst_0
    //   1474: lcmp
    //   1475: iflt +50 -> 1525
    //   1478: iconst_1
  ...
  public static int q(InputStream paramInputStream)
  {
    ...
    try
    {
      int i = Exif.fromStream(paramInputStream).orientation;
      return i;
    }
    catch (Exception paramInputStream)
    {
      x.printErrStackTrace("MicroMsg.AppBrandImgUtil", paramInputStream, "duplicate exif", new Object[0]);
    }
    return 1;
  }
  ...
  public static int vR(String paramString)
  {
    ...
    try
    {
      int i = Exif.fromFile(paramString).orientation;
      return i;
    }
    catch (Exception paramString)
    {
      x.printErrStackTrace("MicroMsg.AppBrandImgUtil", paramString, "duplicate exif", new Object[0]);
    }
    return 1;
  }
}
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/appbrand/r/a.class
