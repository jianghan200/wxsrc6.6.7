...
public final class e
{
  ...
  public static String bdt()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        boolean bool;
        x.printErrStackTrace("MicroMsg.MediaCodecUtil", localException, "report hevc info error %s", new Object[] { localException.toString() });
        return "";
        if (!bool) {
          continue;
        }
      ...
      {
        int i6;
        x.printErrStackTrace("MicroMsg.MediaCodecUtil", localThrowable, "report hevc info error %s", new Object[] { localThrowable.toString() });
        continue;
      ...
      if ((i7 != 0) && (i6 != 0))
      {
        ...
        x.i("MicroMsg.MediaCodecUtil", "high api 21 cost[%d] hevc info %s", new Object[] { Long.valueOf(bi.bI(l)), localObject1 });
  ...
  private static String bdu()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = ((StringBuilder)localObject1).toString();
      x.i("MicroMsg.MediaCodecUtil", "below api 21 cost[%d] hevc info %s", new Object[] { Long.valueOf(bi.bI(l)), localObject1 });
      return (String)localObject1;
      if (bool)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/plugin/u/e.class
