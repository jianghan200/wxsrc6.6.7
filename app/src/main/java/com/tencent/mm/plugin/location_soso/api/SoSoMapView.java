  ...
  implements d
{
  ...
  private void setEnableForeignMap(boolean paramBoolean)
  {
    ...
    {
      x.printErrStackTrace("MicroMsg.SoSoMapView", localException, "", new Object[0]);
    }
  }
  ...
  {
    x.d("MicroMsg.SoSoMapView", "addNullView ");
    addView(paramView);
  }
  ...
  {
    x.d("MicroMsg.SoSoMapView", "updateLocationPinLayout");
  ...
  public void zoomToSpan(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    ...
    x.d("MicroMsg.SoSoMapView", "zoomToSpan " + (int)(1000000.0D * paramDouble3) + " " + (int)(1000000.0D * paramDouble4) + "  " + 1000000.0D * paramDouble1 + " " + 1000000.0D * paramDouble2);
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/plugin/location_soso/api/SoSoMapView.class
