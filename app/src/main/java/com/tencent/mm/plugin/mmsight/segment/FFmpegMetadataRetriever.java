...
public class FFmpegMetadataRetriever
{
  ...
  protected void finalize()
  {
    ...
    {
      x.e("FFmpegMetadataRetriever", "do nothing");
      return;
    }
    finally
    {
  ...
  public int getVideoHeight()
  {
    try
    {
      ...
      {
        x.d("FFmpegMetadataRetriever", "video height %s rotate %s", new Object[] { str1, str2 });
    ...
    {
      x.e("FFmpegMetadataRetriever", "can not get video height %s", new Object[] { localException.getMessage() });
    }
  }
  ...
  public int getVideoRotation()
  {
    ...
    {
      x.e("FFmpegMetadataRetriever", "can not get video rotation. %s", new Object[] { localException.getMessage() });
    }
    return 0;
  }
  ...
  public int getVideoWidth()
  {
    ...
    {
      x.e("FFmpegMetadataRetriever", "can not get video width %s", new Object[] { localException.getMessage() });
    }
  }
  ...
  public void setDataSource(android.content.Context paramContext, android.net.Uri paramUri)
  {
    ...
    //   0: aload_2
    //   1: ifnonnull +11 -> 12
    //   4: new 235	java/lang/IllegalArgumentException
    //   7: dup
    //   8: invokespecial 316	java/lang/IllegalArgumentException:<init>	()V
    //   11: athrow
    //   12: aload_2
    //   13: invokevirtual 321	android/net/Uri:getScheme	()Ljava/lang/String;
    //   16: astore_3
    //   17: aload_3
    //   18: ifnull +13 -> 31
    //   21: aload_3
    //   22: ldc_w 323
    //   25: invokevirtual 275	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   28: ifeq +12 -> 40
    //   31: aload_0
    //   32: aload_2
    //   33: invokevirtual 326	android/net/Uri:getPath	()Ljava/lang/String;
    //   36: invokevirtual 328	com/tencent/mm/plugin/mmsight/segment/FFmpegMetadataRetriever:setDataSource	(Ljava/lang/String;)V
    //   39: return
    //   40: aconst_null
    //   41: astore_3
    //   42: aload_1
    //   43: invokevirtual 334	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   46: astore_1
    //   47: aload_1
    //   48: aload_2
    //   49: ldc_w 336
    //   52: invokevirtual 342	android/content/ContentResolver:openAssetFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    //   55: astore_1
    //   56: aload_1
    //   57: ifnonnull +44 -> 101
    //   60: new 235	java/lang/IllegalArgumentException
    //   63: dup
    //   64: invokespecial 316	java/lang/IllegalArgumentException:<init>	()V
    //   67: athrow
    //   68: astore_3
    //   69: aload_1
    //   70: ifnull +7 -> 77
    //   73: aload_1
    //   74: invokevirtual 347	android/content/res/AssetFileDescriptor:close	()V
    //   77: aload_0
    //   78: aload_2
    //   79: invokevirtual 348	android/net/Uri:toString	()Ljava/lang/String;
    //   82: invokevirtual 328	com/tencent/mm/plugin/mmsight/segment/FFmpegMetadataRetriever:setDataSource	(Ljava/lang/String;)V
    //   85: return
    //   86: astore_1
    //   87: new 235	java/lang/IllegalArgumentException
    //   90: dup
    //   91: invokespecial 316	java/lang/IllegalArgumentException:<init>	()V
    //   94: athrow
    //   95: astore_1
    //   96: aload_3
    //   97: astore_1
    //   98: goto -29 -> 69
    //   101: aload_1
    //   102: invokevirtual 352	android/content/res/AssetFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   105: astore_3
    //   106: aload_3
    //   107: invokevirtual 358	java/io/FileDescriptor:valid	()Z
    //   110: ifne +26 -> 136
    //   113: new 235	java/lang/IllegalArgumentException
    //   116: dup
    //   117: invokespecial 316	java/lang/IllegalArgumentException:<init>	()V
    //   120: athrow
    //   121: astore_2
    //   122: aload_1
    //   123: astore_3
    ...
    //   127: ifnull +7 -> 134
    //   130: aload_3
    //   131: invokevirtual 347	android/content/res/AssetFileDescriptor:close	()V
    //   134: aload_1
    //   135: athrow
    //   136: aload_1
    //   137: invokevirtual 362	android/content/res/AssetFileDescriptor:getDeclaredLength	()J
    //   140: lconst_0
    //   141: lcmp
    //   142: ifge +19 -> 161
    //   145: aload_0
    //   146: aload_3
    //   147: invokevirtual 365	com/tencent/mm/plugin/mmsight/segment/FFmpegMetadataRetriever:setDataSource	(Ljava/io/FileDescriptor;)V
    //   150: aload_1
    //   151: ifnull -112 -> 39
    //   154: aload_1
    //   155: invokevirtual 347	android/content/res/AssetFileDescriptor:close	()V
    //   158: return
    //   159: astore_1
    //   160: return
    //   161: aload_0
    //   162: aload_3
    //   163: aload_1
    //   164: invokevirtual 368	android/content/res/AssetFileDescriptor:getStartOffset	()J
    //   167: aload_1
    //   168: invokevirtual 362	android/content/res/AssetFileDescriptor:getDeclaredLength	()J
    //   171: invokevirtual 371	com/tencent/mm/plugin/mmsight/segment/FFmpegMetadataRetriever:setDataSource	(Ljava/io/FileDescriptor;JJ)V
    //   174: goto -24 -> 150
    //   177: astore_1
    //   178: goto -101 -> 77
    //   181: astore_2
    ...
    //   16	26	3	str	String
    //   68	29	3	localSecurityException	SecurityException
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/plugin/mmsight/segment/FFmpegMetadataRetriever.class
