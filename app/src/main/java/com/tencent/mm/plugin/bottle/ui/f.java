...
final class f
{
  ...
  {
    int k = (int)((paramCalendar.getTime().getTime() - hlL) / 86400000L);
    int i = 1900;
    int m = 0;
    while ((i < 2050) && (k > 0))
    {
  ...
  private static int no(int paramInt)
  {
    int j = 348;
    int i = 32768;
    while (i > 8)
    {
      int k = j;
      if ((hlJ[(paramInt - 1900)] & i) != 0L) {
        k = j + 1;
      }
      i >>= 1;
      j = k;
    }
    return j + np(paramInt);
  }
  
  private static int np(int paramInt)
  {
    if (nq(paramInt) != 0)
    {
      if ((hlJ[(paramInt - 1900)] & 0x10000) != 0L) {
        return 30;
      }
      return 29;
    }
  ...
  {
    return (int)(hlJ[(paramInt - 1900)] & 0xF);
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/mm/plugin/bottle/ui/f.class
