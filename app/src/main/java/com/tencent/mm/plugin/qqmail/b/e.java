...
public final class e
{
  ...
  {
    x.i("Msg.Plugin.HttpRequestCache", "HttpRequestCache constructor, path = " + paramString + ", maxCount = " + paramInt);
    this.mcn = paramString;
    paramString = new File(this.mcn);
  ...
  private static byte[] JP(String paramString)
  {
    return g.u(paramString.toString().getBytes()).substring(8, 16).getBytes();
  }
  ...
  private static byte[] decrypt(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    {
      x.printErrStackTrace("Msg.Plugin.HttpRequestCache", paramArrayOfByte1, "", new Object[0]);
    }
    return null;
  }
  ...
  private static String n(String paramString, Map<String, String> paramMap)
  {
  ...
  public static boolean r(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   42: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   45: goto -17 -> 28
    //   48: astore 4
    //   50: aconst_null
    //   51: astore_1
    ...
    //   64: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   67: aload_1
    //   68: ifnull -38 -> 30
    //   71: aload_1
    ...
    //   87: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   90: iconst_0
    //   91: ireturn
    //   92: astore_1
    //   93: aconst_null
    ...
    //   115: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   118: goto -15 -> 103
    //   121: astore_1
    //   122: goto -27 -> 95
    //   125: astore 4
  ...
  public static byte[] readFromFile(String paramString)
  {
    ...
    //   70: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   73: aconst_null
    //   74: areturn
    //   75: aload_3
    ...
    //   92: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   95: goto -16 -> 79
    //   98: astore 4
    //   100: aconst_null
    //   101: astore_3
    ...
    //   114: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   117: aload_3
    //   118: ifnull +62 -> 180
    //   121: aload_3
    ...
    //   137: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   140: aconst_null
    //   141: areturn
    //   142: astore_3
    //   143: aconst_null
    ...
    //   165: invokestatic 126	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   168: goto -15 -> 153
    //   171: astore_3
    //   172: goto -27 -> 145
    //   175: astore 4
  ...
  public final boolean a(String paramString, Map<String, String> paramMap, byte[] paramArrayOfByte)
  {
    ...
    bok();
    paramString = n(paramString, paramMap);
    paramMap = encrypt(paramArrayOfByte, JP(paramString));
    if (paramMap == null)
    {
      x.e("Msg.Plugin.HttpRequestCache", "encrypt fail, cipherText is null");
      return false;
    }
    return r(this.mcn + paramString, paramMap);
  }
  
  public final void bok()
  {
    int j = 0;
    Object localObject = new File(this.mcn).list();
    int i;
    if (localObject != null)
    {
    ...
    do
    {
      ...
      i = 0;
      break;
      String[] arrayOfString = new File(this.mcn).list();
      localObject = null;
  ...
  public final byte[] m(String paramString, Map<String, String> paramMap)
  {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/mm/plugin/qqmail/b/e.class
