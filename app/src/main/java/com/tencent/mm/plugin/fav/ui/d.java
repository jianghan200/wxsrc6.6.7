  ...
  implements w
{
  ...
  {
    return BitmapFactory.decodeResource(ad.getContext().getResources(), m.d.nosdcard_headimg);
  }
  ...
  public final Bitmap a(Bitmap paramBitmap, w.a parama, String paramString)
  {
    ...
    //   0: aload_1
    //   1: astore_3
    //   2: getstatic 102	com/tencent/mm/platformtools/w$a:evZ	Lcom/tencent/mm/platformtools/w$a;
    //   5: aload_2
    //   6: if_acmpne +147 -> 153
    //   9: aload_1
    //   10: astore_3
    ...
    //   25: aastore
    //   26: invokestatic 112	com/tencent/mm/sdk/platformtools/x:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   29: aload_1
    //   30: astore_3
    //   31: new 114	com/tencent/mm/vfs/b
    //   34: dup
    //   35: invokestatic 66	com/tencent/mm/plugin/fav/a/b:aKO	()Ljava/lang/String;
    ...
    //   101: dup
    //   102: aload_0
    //   103: invokevirtual 130	com/tencent/mm/plugin/fav/ui/d:Vv	()Ljava/lang/String;
    ...
    //   116: pop
    //   117: new 135	com/tencent/mm/vfs/e
    //   120: dup
    //   121: aload_1
    //   122: invokespecial 138	com/tencent/mm/vfs/e:<init>	(Lcom/tencent/mm/vfs/b;)V
    //   125: astore_1
    //   126: aload_1
    //   127: astore_3
    //   128: aload_2
    ...
    //   140: astore_3
    //   141: aload_1
    //   142: invokevirtual 153	com/tencent/mm/vfs/e:flush	()V
    //   145: aload_2
    //   146: astore_3
    //   147: aload_1
    //   148: invokevirtual 156	com/tencent/mm/vfs/e:close	()V
    //   151: aload_2
    //   152: astore_3
    //   153: aload_3
    //   154: areturn
    ...
    //   171: invokestatic 162	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   174: aload_2
    //   175: astore_3
    //   176: aload_1
    //   177: ifnull -24 -> 153
    ...
    //   181: astore_3
    //   182: aload_1
    //   183: invokevirtual 156	com/tencent/mm/vfs/e:close	()V
    //   186: aload_2
    //   187: areturn
    //   188: astore_1
    //   189: ldc 104
    ...
    //   198: invokestatic 162	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   201: aload_3
    //   202: areturn
    //   203: astore_1
    //   204: aconst_null
    ...
    //   213: astore_3
    //   214: aload 4
    //   216: invokevirtual 156	com/tencent/mm/vfs/e:close	()V
    //   219: aload_2
    //   220: astore_3
    //   221: aload_1
    //   222: athrow
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/plugin/fav/ui/d.class
