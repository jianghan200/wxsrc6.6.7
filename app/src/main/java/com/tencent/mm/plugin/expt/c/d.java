  ...
  extends i<a>
{
  ...
  public static final String[] diD = { i.a(a.dhO, "ExptItem") };
  private e diF;
  
  public d(e parame)
  {
    super(parame, a.dhO, "ExptItem", ciG);
    this.diF = parame;
  }
  ...
  private boolean a(a parama)
  {
    ...
    {
      bool = super.a(parama);
      x.d("MicroMsg.ExptStorage", "replace expt ret[%b] item[%s]", new Object[] { Boolean.valueOf(bool), parama.toString() });
      return bool;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        x.e("MicroMsg.ExptStorage", "replace expt error [%s]", new Object[] { localException.toString() });
        boolean bool = false;
      }
    }
  }
  ...
  private boolean pq(int paramInt)
  {
    try
    {
      paramInt = this.diF.delete("ExptItem", "exptId=?", new String[] { String.valueOf(paramInt) });
      if (paramInt > 0) {
        return true;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        x.e("MicroMsg.ExptStorage", "delete expt by id [%s]", new Object[] { localException.toString() });
        paramInt = 0;
      }
    }
    return false;
  ...
  public final int aIG()
  {
    try
    {
      int i = this.diF.delete("ExptItem", null, null);
      return i;
    }
    catch (Exception localException)
    {
      x.e("MicroMsg.ExptStorage", "delete all expt error[%s]", new Object[] { localException.toString() });
    }
    return 0;
  }
  ...
  public final List<a> aIH()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	com/tencent/mm/plugin/expt/c/d:diF	Lcom/tencent/mm/sdk/e/e;
    //   4: ldc 95
    //   6: aconst_null
    ...
    //   90: aastore
    //   91: invokestatic 72	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   94: aload_1
    //   95: astore_3
    //   96: aload_2
    //   97: ifnull +11 -> 108
    ...
    //   131: aastore
    //   132: invokestatic 66	com/tencent/mm/sdk/platformtools/x:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   135: aload_1
    //   136: astore_3
    //   137: aload_2
    //   138: ifnull -30 -> 108
  ...
  /* Error */
  public final java.util.ArrayList<Integer> aII()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	com/tencent/mm/plugin/expt/c/d:diF	Lcom/tencent/mm/sdk/e/e;
    ...
    //   85: aastore
    //   86: invokestatic 72	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   89: aload_1
    //   90: astore_3
    //   91: aload_2
    //   92: ifnull +11 -> 103
  ...
  public final int aV(List<Integer> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          boolean bool = pq(((Integer)paramList.next()).intValue());
          if (bool)
          {
            i += 1;
            continue;
  ...
  public final List<a> aZ(List<a> paramList)
  {
    long l = -1L;
  ...
  /* Error */
  public final a pp(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	com/tencent/mm/plugin/expt/c/d:diF	Lcom/tencent/mm/sdk/e/e;
    ...
    //   107: aastore
    //   108: invokestatic 72	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   111: aload_2
    //   112: astore 4
    //   114: aload_3
    //   115: ifnull -35 -> 80
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/plugin/expt/c/d.class
