...
public class LuckyMoneyMoneyInputView
  ...
  implements b
{
  private TextWatcher UE = new LuckyMoneyMoneyInputView.1(this);
  ...
  public LuckyMoneyMoneyInputView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.kVy = ((TextView)paramContext.findViewById(a.f.lucky_money_money_input_group_icon));
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/mm/plugin/luckymoney/ui/LuckyMoneyMoneyInputView.class
