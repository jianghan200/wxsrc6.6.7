...
public final class a
{
  public static int mh(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        int k;
        x.e("Big5Util", "exception:%s", new Object[] { bi.i(paramString) });
        return 0;
      }
      if (i < 2)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/al/a.class
