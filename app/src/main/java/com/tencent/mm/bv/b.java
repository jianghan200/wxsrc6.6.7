...
public final class b
{
  ...
  private static boolean U(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          {
            x.e("MicroMsg.MemoryDumpManager", "hprofFileCheck parse date fail %s", new Object[] { str });
            localFile.delete();
            boolean bool2 = bool1;
            continue;
    ...
    x.w("MicroMsg.MemoryDumpManager", "hprofFileCheck hprofFileDir.length() too large " + localObject.length);
    return false;
  }
  ...
  public static String V(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((StringBuffer)localObject).append(tfv).append(str).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!Q(new File((String)localObject).getParentFile()))
    {
      x.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
      return null;
    }
    try
    {
      ...
      if (paramBoolean2) {
        Toast.makeText(ad.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      }
      x.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { str, Long.valueOf(bi.bH(l)) });
  ...
  public static String ZO(String paramString)
  {
    ...
    long l = System.currentTimeMillis();
    Object localObject = new StringBuffer();
    ((StringBuffer)localObject).append(tfv).append(paramString).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!Q(new File((String)localObject).getParentFile()))
    {
      x.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
    ...
    try
    {
      ...
      Debug.dumpHprofData((String)localObject);
      Toast.makeText(ad.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      x.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { paramString, Long.valueOf(bi.bH(l)) });
  ...
  public static void cot()
  {
    ...
    //   3: bipush 14
    //   5: if_icmplt +7 -> 12
    //   8: invokestatic 242	com/tencent/mm/bv/b:cou	()V
    //   11: return
    ...
    //   81: ldc 96
    //   83: aload 5
    //   85: invokestatic 216	com/tencent/mm/sdk/platformtools/x:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   88: goto -26 -> 62
    //   91: astore_1
    //   92: aload_3
    //   93: astore_2
    ...
    //   96: ldc 96
    //   98: ldc_w 275
    //   101: invokestatic 195	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   104: aload_3
    //   105: ifnull +7 -> 112
    //   108: aload_3
    ...
    //   162: ldc 96
    //   164: ldc_w 287
    //   167: invokestatic 195	com/tencent/mm/sdk/platformtools/x:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   170: aload_3
    //   171: ifnull +7 -> 178
    //   174: aload_3
    ...
    //   153	1	0	localInterruptedException1	InterruptedException
    ...
    //   230	1	1	localInterruptedException2	InterruptedException
    //   236	1	1	localInterruptedException3	InterruptedException
  ...
  {
    Object localObject1 = (ActivityManager)ad.getContext().getSystemService("activity");
    ...
    while (i < j)
    {
      ...
      x.i("MicroMsg.MemoryDumpManager", " pidMemoryInfo.getTotalPrivateDirty(): " + ((Debug.MemoryInfo)localObject2).getTotalPrivateDirty() + "\n");
      x.i("MicroMsg.MemoryDumpManager", " pidMemoryInfo.getTotalPss(): " + ((Debug.MemoryInfo)localObject2).getTotalPss() + "\n");
      x.i("MicroMsg.MemoryDumpManager", " pidMemoryInfo.getTotalSharedDirty(): " + ((Debug.MemoryInfo)localObject2).getTotalSharedDirty() + "\n");
      i += 1;
    }
  }
}
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/mm/bv/b.class
