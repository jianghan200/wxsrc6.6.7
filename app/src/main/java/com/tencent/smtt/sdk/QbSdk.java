...
public class QbSdk
{
  ...
  static void a(Context paramContext, String paramString)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 95	com/tencent/smtt/sdk/QbSdk:a	Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   14: return
    //   15: iconst_1
    //   16: putstatic 95	com/tencent/smtt/sdk/QbSdk:a	Z
    //   19: new 204	java/lang/StringBuilder
    //   22: dup
    //   23: ldc -50
    //   25: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   28: aload_1
    //   29: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   32: invokevirtual 216	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   35: putstatic 109	com/tencent/smtt/sdk/QbSdk:v	Ljava/lang/String;
    //   38: ldc -38
    //   40: new 204	java/lang/StringBuilder
    //   43: dup
    //   44: ldc -36
    //   46: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   49: getstatic 109	com/tencent/smtt/sdk/QbSdk:v	Ljava/lang/String;
    ...
    //   58: invokestatic 225	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: invokestatic 231	com/tencent/smtt/sdk/TbsCoreLoadStat:getInstance	()Lcom/tencent/smtt/sdk/TbsCoreLoadStat;
    //   64: aload_0
    //   65: sipush 401
    //   68: new 233	java/lang/Throwable
    //   71: dup
    //   72: getstatic 109	com/tencent/smtt/sdk/QbSdk:v	Ljava/lang/String;
    //   75: invokespecial 234	java/lang/Throwable:<init>	(Ljava/lang/String;)V
    //   78: invokevirtual 237	com/tencent/smtt/sdk/TbsCoreLoadStat:a	(Landroid/content/Context;ILjava/lang/Throwable;)V
    //   81: goto -70 -> 11
    //   84: astore_0
    //   85: ldc 2
    //   87: monitorexit
  ...
  static boolean a(Context paramContext)
  {
    try
    {
      ...
      Object localObject = an.a().q(paramContext);
      if (localObject == null)
      {
      ...
      b(paramContext, localFile.getParent());
      return true;
    }
  ...
  static boolean a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    paramContext = q.a(r, "isX5Disabled", new Class[] { Integer.TYPE, Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(43610), Integer.valueOf(paramInt2) });
    if (paramContext != null) {
      return ((Boolean)paramContext).booleanValue();
    }
    paramContext = q.a(r, "isX5Disabled", new Class[] { Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(43610) });
    if (paramContext != null) {
      return ((Boolean)paramContext).booleanValue();
    }
    return true;
    ...
    for (;;)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          return false;
          localObject1 = new File(an.a().q(paramContext), "tbs_sdk_extension_dex.jar");
          break;
      ...
      for (Object localObject2 = TbsShareManager.getHostCorePathAppDefined();; localObject2 = ((File)localObject2).getAbsolutePath())
      {
        ...
        b(paramContext, ((File)localObject1).getParent());
        localObject1 = r;
        localObject2 = b.a;
        String str1 = b.b;
        String str2 = b.c;
  ...
  static boolean a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = q.a(r, "canLoadX5Core", new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(43610) });
      int i1;
      if (localObject2 != null)
      {
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    try
    {
      Object localObject2 = q.getConstructor(new Class[] { Context.class, Context.class, String.class, String.class, String.class });
      ...
      for (;;)
      {
        try
        {
          if (TbsShareManager.isThirdPartyApp(paramContext))
          {
            ...
            r = ((Constructor)localObject1).newInstance(new Object[] { paramContext, localObject2, TbsShareManager.getHostCorePathAppDefined(), paramString, null });
            return;
          }
          if (i1 == 0)
          {
          ...
          r = ((Constructor)localObject1).newInstance(new Object[] { paramContext, paramContext, null, paramString, null });
          return;
        }
        catch (Throwable paramContext) {}
  ...
  private static boolean c(Context paramContext)
  {
    try
    {
      ...
      for (Object localObject1 = new File(TbsShareManager.c(paramContext), "tbs_sdk_extension_dex.jar"); !((File)localObject1).exists(); localObject1 = new File(an.a().q(paramContext), "tbs_sdk_extension_dex.jar"))
      {
  ...
  public static boolean canOpenWebPlus(Context paramContext)
  {
    ...
    //   3: aconst_null
    //   4: astore 5
    //   6: getstatic 128	com/tencent/smtt/sdk/QbSdk:w	I
    //   9: ifne +9 -> 18
    //   12: invokestatic 539	com/tencent/smtt/sdk/a:a	()I
    //   15: putstatic 128	com/tencent/smtt/sdk/QbSdk:w	I
    //   18: ldc -38
    //   20: new 204	java/lang/StringBuilder
    //   23: dup
    //   24: ldc_w 721
    //   27: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   30: getstatic 128	com/tencent/smtt/sdk/QbSdk:w	I
    //   33: invokevirtual 362	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   36: invokevirtual 216	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   39: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   42: getstatic 497	android/os/Build$VERSION:SDK_INT	I
    //   45: bipush 7
    //   47: if_icmplt +12 -> 59
    //   50: getstatic 128	com/tencent/smtt/sdk/QbSdk:w	I
    //   53: getstatic 130	com/tencent/smtt/sdk/QbSdk:x	I
    //   56: if_icmpge +5 -> 61
    //   59: iconst_0
    //   60: ireturn
    //   61: aload_0
    //   62: ifnull -3 -> 59
    //   65: new 723	java/io/BufferedInputStream
    //   68: dup
    //   69: new 725	java/io/FileInputStream
    //   72: dup
    //   73: new 251	java/io/File
    //   76: dup
    //   77: invokestatic 244	com/tencent/smtt/sdk/an:a	()Lcom/tencent/smtt/sdk/an;
    //   80: aload_0
    //   81: invokevirtual 247	com/tencent/smtt/sdk/an:q	(Landroid/content/Context;)Ljava/io/File;
    //   84: ldc_w 727
    //   87: invokespecial 256	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   90: invokespecial 729	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   93: invokespecial 732	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   96: astore 6
    //   98: aload 6
    //   100: astore 5
    //   102: new 734	java/util/Properties
    //   105: dup
    //   106: invokespecial 735	java/util/Properties:<init>	()V
    //   109: astore 8
    //   111: aload 6
    //   113: astore 5
    //   115: aload 8
    //   117: aload 6
    //   119: invokevirtual 738	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   122: aload 6
    //   124: astore 5
    //   126: aload 8
    //   128: ldc_w 740
    //   131: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   134: astore 9
    //   136: aload 6
    //   138: astore 5
    //   140: aload 8
    //   142: ldc_w 745
    //   145: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   148: astore 10
    //   150: aload 6
    //   152: astore 5
    //   154: aload 9
    //   156: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   159: istore_1
    //   160: aload 6
    //   162: astore 5
    //   164: aload 10
    //   166: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   169: istore_2
    //   170: aload 6
    //   172: astore 5
    //   174: getstatic 748	android/os/Build$VERSION:SDK	Ljava/lang/String;
    //   177: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   180: istore_3
    //   181: iload_3
    //   182: iload_1
    //   183: if_icmpgt +8 -> 191
    ...
    //   193: astore 5
    //   195: ldc -38
    //   197: new 204	java/lang/StringBuilder
    //   200: dup
    //   201: ldc_w 750
    //   204: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   207: iload_3
    //   208: invokevirtual 362	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   211: invokevirtual 216	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   214: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   217: aload 6
    //   219: invokevirtual 753	java/io/BufferedInputStream:close	()V
    //   222: iconst_0
    //   223: ireturn
    //   224: astore_0
    //   225: iconst_0
    ...
    //   231: aload 8
    //   233: ldc_w 499
    //   236: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   239: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   242: istore_1
    //   243: aload 6
    //   245: invokevirtual 753	java/io/BufferedInputStream:close	()V
    //   248: new 725	java/io/FileInputStream
    //   251: dup
    //   252: new 251	java/io/File
    //   255: dup
    //   256: aload_0
    //   257: invokestatic 755	com/tencent/smtt/sdk/an:s	(Landroid/content/Context;)Ljava/io/File;
    //   260: ldc_w 757
    //   263: invokespecial 256	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   266: invokespecial 729	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   269: astore 5
    //   271: new 734	java/util/Properties
    //   274: dup
    //   275: invokespecial 735	java/util/Properties:<init>	()V
    //   278: astore 6
    //   280: aload 6
    //   282: aload 5
    //   284: invokevirtual 738	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   287: aload 6
    //   289: ldc_w 759
    //   292: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   295: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   298: istore_2
    //   299: aload 6
    //   301: ldc_w 761
    //   304: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   307: invokestatic 507	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   310: istore_3
    //   311: iload_1
    //   312: ldc_w 762
    ...
    //   326: istore_1
    //   327: aload 5
    //   329: invokevirtual 765	java/io/InputStream:close	()V
    //   332: iload_1
    //   333: ifne -274 -> 59
    //   336: iconst_1
    //   337: ireturn
    ...
    //   344: ldc -38
    //   346: ldc_w 767
    //   349: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   352: aload_0
    //   353: ifnull -294 -> 59
    //   356: aload_0
    //   357: invokevirtual 753	java/io/BufferedInputStream:close	()V
    //   360: iconst_0
    //   361: ireturn
    //   362: astore_0
    //   363: iconst_0
    ...
    //   368: ifnull +8 -> 376
    //   371: aload 5
    //   373: invokevirtual 753	java/io/BufferedInputStream:close	()V
    //   376: aload_0
    //   377: athrow
    //   378: iload_1
    //   379: iload_2
    ...
    //   397: iload_3
    //   398: aload_0
    //   399: invokestatic 769	com/tencent/smtt/utils/b:b	(Landroid/content/Context;)I
    //   402: if_icmpeq +8 -> 410
    //   405: iconst_0
    //   406: istore_1
    //   407: goto -80 -> 327
    //   410: aload 6
    //   412: ldc_w 771
    //   415: invokevirtual 743	java/util/Properties:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   418: invokestatic 774	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   421: ifeq +34 -> 455
    //   424: aload_0
    //   425: invokevirtual 590	android/content/Context:getApplicationContext	()Landroid/content/Context;
    ...
    //   464: ldc -38
    //   466: ldc_w 782
    //   469: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   472: aload_0
    //   473: ifnull +7 -> 480
    //   476: aload_0
    //   477: invokevirtual 765	java/io/InputStream:close	()V
    //   480: iconst_1
    //   481: istore_1
    //   482: goto -150 -> 332
    //   485: astore_0
    ...
    //   497: ifnull +8 -> 505
    //   500: aload 5
    //   502: invokevirtual 765	java/io/InputStream:close	()V
    //   505: aload_0
    //   506: athrow
    //   507: astore 5
    //   509: goto -261 -> 248
  ...
  public static void clearAllWebViewCache(Context paramContext, boolean paramBoolean)
  {
    ...
    //   7: dup
    //   8: ldc_w 788
    //   11: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   14: aload_0
    //   15: invokevirtual 489	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   18: ldc_w 790
    //   21: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: iload_1
    //   25: invokevirtual 552	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   28: ldc_w 792
    ...
    //   37: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   40: new 794	com/tencent/smtt/sdk/WebView
    //   43: dup
    //   44: aload_0
    //   45: invokespecial 796	com/tencent/smtt/sdk/WebView:<init>	(Landroid/content/Context;)V
    //   48: invokevirtual 800	com/tencent/smtt/sdk/WebView:getWebViewClientExtension	()Lcom/tencent/smtt/export/external/extension/interfaces/IX5WebViewClientExtension;
    //   51: astore 4
    //   53: aload 4
    //   55: ifnull +214 -> 269
    //   58: invokestatic 561	com/tencent/smtt/sdk/bv:a	()Lcom/tencent/smtt/sdk/bv;
    //   61: astore 4
    //   63: iload_3
    //   64: istore_2
    //   65: aload 4
    ...
    //   71: istore_2
    //   72: aload 4
    //   74: invokevirtual 563	com/tencent/smtt/sdk/bv:b	()Z
    //   77: ifeq +15 -> 92
    //   80: aload 4
    //   82: invokevirtual 566	com/tencent/smtt/sdk/bv:c	()Lcom/tencent/smtt/sdk/bw;
    //   85: aload_0
    //   86: iload_1
    //   87: invokevirtual 802	com/tencent/smtt/sdk/bw:a	(Landroid/content/Context;Z)V
    //   90: iload_3
    //   91: istore_2
    //   92: iload_2
    //   93: ifeq +45 -> 138
    //   96: ldc -38
    //   98: ldc_w 804
    //   101: invokestatic 272	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   104: return
    //   105: astore 4
    //   107: iconst_0
    //   108: istore_2
    //   109: ldc -38
    //   111: new 204	java/lang/StringBuilder
    //   114: dup
    //   115: ldc_w 806
    //   118: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   121: aload 4
    //   123: invokestatic 296	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   126: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   129: invokevirtual 216	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   132: invokestatic 225	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: goto -43 -> 92
    //   138: new 808	android/webkit/WebView
    //   141: dup
    //   142: aload_0
    //   143: invokespecial 809	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   146: astore 4
    //   148: getstatic 497	android/os/Build$VERSION:SDK_INT	I
    //   151: bipush 11
    //   153: if_icmplt +27 -> 180
    //   156: aload 4
    //   158: ldc_w 811
    //   161: invokevirtual 814	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   164: aload 4
    //   166: ldc_w 816
    //   169: invokevirtual 814	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   172: aload 4
    //   174: ldc_w 818
    //   177: invokevirtual 814	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   180: aload 4
    //   182: iconst_1
    //   183: invokevirtual 822	android/webkit/WebView:clearCache	(Z)V
    //   186: iload_1
    //   187: ifeq +14 -> 201
    //   190: aload_0
    //   191: invokestatic 828	android/webkit/CookieSyncManager:createInstance	(Landroid/content/Context;)Landroid/webkit/CookieSyncManager;
    //   194: pop
    //   195: invokestatic 833	android/webkit/CookieManager:getInstance	()Landroid/webkit/CookieManager;
    //   198: invokevirtual 836	android/webkit/CookieManager:removeAllCookie	()V
    //   201: aload_0
    //   202: invokestatic 841	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   205: invokevirtual 844	android/webkit/WebViewDatabase:clearUsernamePassword	()V
    //   208: aload_0
    //   209: invokestatic 841	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   212: invokevirtual 847	android/webkit/WebViewDatabase:clearHttpAuthUsernamePassword	()V
    //   215: aload_0
    //   216: invokestatic 841	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   219: invokevirtual 850	android/webkit/WebViewDatabase:clearFormData	()V
    //   222: invokestatic 855	android/webkit/WebStorage:getInstance	()Landroid/webkit/WebStorage;
    //   225: invokevirtual 858	android/webkit/WebStorage:deleteAllData	()V
    //   228: invokestatic 863	android/webkit/WebIconDatabase:getInstance	()Landroid/webkit/WebIconDatabase;
    //   231: invokevirtual 866	android/webkit/WebIconDatabase:removeAllIcons	()V
    //   234: return
    //   235: astore_0
    //   236: ldc -38
    //   238: new 204	java/lang/StringBuilder
    //   241: dup
    //   242: ldc_w 868
    //   245: invokespecial 209	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   248: aload_0
    //   249: invokestatic 296	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   252: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   255: invokevirtual 216	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   258: invokestatic 225	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   261: return
    //   262: astore 4
    //   264: iconst_1
    //   265: istore_2
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          try
          {
            ...
            com.tencent.smtt.utils.j.a(an.a().q(paramContext), false);
  ...
  public static void initX5Environment(Context paramContext, PreInitCallback paramPreInitCallback)
  {
    ...
    b(paramContext);
    C = new l(paramContext, paramPreInitCallback);
    if (TbsShareManager.isThirdPartyApp(paramContext)) {
  ...
  public static boolean isX5DisabledSync(Context paramContext)
  {
    ...
    i1 = an.a().i(paramContext);
    paramContext = q.a(r, "isX5DisabledSync", new Class[] { Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(i1), Integer.valueOf(43610) });
    if (paramContext != null) {
      return ((Boolean)paramContext).booleanValue();
    }
    return true;
  ...
  public static void reset(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          int i2 = an.a().h(paramContext);
          int i3 = an.a().i(paramContext);
          if ((i2 > 43300) && (i2 != i3))
          {
            ...
            if (i1 != 0)
            {
              com.tencent.smtt.utils.j.b(an.a().p(paramContext), an.a().t(paramContext));
              an.a().b(paramContext);
            }
            return;
          }
  ...
  public static void resetDecoupleCore(Context paramContext)
  {
    ...
    try
    {
      com.tencent.smtt.utils.j.b(an.a().p(paramContext));
      return;
    }
    catch (Throwable paramContext)
    {
  ...
  public static int startMiniQBToLoadUrl(Context paramContext, String paramString, HashMap<String, String> paramHashMap, android.webkit.ValueCallback<String> paramValueCallback)
  {
    ...
    if (localbv.b())
    {
      ...
      TbsLogReport.a(paramContext).b(504, String.valueOf(i1));
      return i1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/smtt/sdk/QbSdk.class
