...
class ai
{
  ...
  private Properties e()
  {
    ...
    //   48	1	1	localException1	Exception
    ...
    //   104	1	3	localException3	Exception
    // Exception table:
    //   from	to	target	type
  ...
  {
    an.a();
    File localFile = new File(an.s(b), "tbscoreinstall.txt");
    if (!localFile.exists()) {}
    try
    {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/smtt/sdk/ai.class
