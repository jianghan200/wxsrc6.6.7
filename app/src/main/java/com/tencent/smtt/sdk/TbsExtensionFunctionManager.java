...
public class TbsExtensionFunctionManager
{
  ...
  public boolean canUseFunction(Context paramContext, String paramString)
  {
    ...
    //   5: dup
    //   6: aload_1
    //   7: invokevirtual 52	android/content/Context:getFilesDir	()Ljava/io/File;
    //   10: aload_2
    //   11: invokespecial 55	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   14: astore_1
    //   15: aload_1
    //   16: invokevirtual 59	java/io/File:exists	()Z
    //   19: ifeq +18 -> 37
    //   22: aload_1
    //   23: invokevirtual 62	java/io/File:isFile	()Z
    //   26: istore_3
    //   27: iload_3
    //   28: ifeq +9 -> 37
    //   31: iconst_1
  ...
  public int getRomCookieDBVersion(Context paramContext)
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: getstatic 69	android/os/Build$VERSION:SDK_INT	I
    //   7: bipush 11
    //   9: if_icmplt +19 -> 28
    //   12: aload_1
    //   13: ldc 20
    //   15: iconst_4
    //   16: invokevirtual 73	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   19: astore_1
    //   20: aload_1
    //   21: ifnonnull +18 -> 39
    //   24: aload_0
    ...
    //   29: ldc 20
    //   31: iconst_0
    //   32: invokevirtual 73	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   35: astore_1
    //   36: goto -16 -> 20
    //   39: aload_1
    //   40: ldc 17
    //   42: iconst_m1
    //   43: invokeinterface 79 3 0
    //   48: istore_2
    //   49: goto -25 -> 24
    //   52: astore_1
    //   53: aload_0
  ...
  public void initTbsBuglyIfNeed(Context paramContext)
  {
    for (;;)
    {
      ...
      label130:
      Object localObject3 = an.a().q(paramContext);
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/smtt/sdk/TbsExtensionFunctionManager.class
