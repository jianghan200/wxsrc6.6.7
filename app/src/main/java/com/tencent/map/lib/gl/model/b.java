...
public abstract class b
{
  ...
  {
    return jf.a(jf.a(paramArrayOfFloat1, paramArrayOfFloat2), this.mVertexList.a());
  }
  
  protected boolean isVisibility(float[][] paramArrayOfFloat)
  {
    return jf.a(paramArrayOfFloat, this.mVertexList.a());
  }
  ...
  public boolean testHint(float paramFloat1, float paramFloat2, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      if (je.a(paramFloat1, paramFloat2, new c(locale1, locale2, locale3).a(), paramArrayOfFloat2, paramArrayOfInt)) {
        return true;
      }
      i += 1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/map/lib/gl/model/b.class
