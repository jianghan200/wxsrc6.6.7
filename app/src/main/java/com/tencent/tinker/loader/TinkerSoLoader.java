...
public class TinkerSoLoader
{
  ...
  {
    paramShareSecurityCheck = (String)paramShareSecurityCheck.vvS.get("assets/so_meta.txt");
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramShareSecurityCheck.put(((ShareBsDiffPatchInfo)localObject2).path + "/" + ((ShareBsDiffPatchInfo)localObject2).name, ((ShareBsDiffPatchInfo)localObject2).bKg);
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/loader/TinkerSoLoader.class
