...
public class TinkerDexLoader
{
  ...
  {
    if (vsk) {
      return paramShareDexDiffPatchInfo.vuB;
    }
    return paramShareDexDiffPatchInfo.vuA;
  }
  ...
  public static boolean a(TinkerApplication paramTinkerApplication, String paramString1, String paramString2, Intent paramIntent, boolean paramBoolean)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        File localFile = new File((String)localObject1 + ((ShareDexDiffPatchInfo)localObject3).dia);
    ...
    if ((vsk) && (!vtm.isEmpty()))
    {
      ...
      if (paramTinkerApplication.isTinkerLoadVerifyFlag())
      {
        localObject2 = vtm.iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (ShareDexDiffPatchInfo)((Iterator)localObject2).next();
          if (!SharePatchFileUtil.b((File)localObject1, ((ShareDexDiffPatchInfo)localObject3).vuz, ((ShareDexDiffPatchInfo)localObject3).vuB))
          {
            ShareIntentUtil.a(paramIntent, -13);
    ...
    if (paramBoolean)
    {
      ...
      try
      {
        localObject3 = ShareTinkerInternals.cHh();
        acQ(paramString1);
  ...
  {
    Object localObject = (String)paramShareSecurityCheck.vvS.get("assets/dex_meta.txt");
    if (localObject == null) {
      return true;
    }
    vtl.clear();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!b((ShareDexDiffPatchInfo)localObject))
      {
        ...
        if ((vsk) && (((ShareDexDiffPatchInfo)localObject).vuz.startsWith("test.dex")))
        {
          paramShareSecurityCheck = (ShareSecurityCheck)localObject;
        }
        else if ((vsk) && (ShareConstants.vuy.matcher(((ShareDexDiffPatchInfo)localObject).dia).matches()))
        {
          vtm.add(localObject);
        }
        else
        {
          localHashMap.put(((ShareDexDiffPatchInfo)localObject).dia, a((ShareDexDiffPatchInfo)localObject));
          vtl.add(localObject);
        }
      }
    }
    if ((vsk) && ((paramShareSecurityCheck != null) || (!vtm.isEmpty())))
    {
      if (paramShareSecurityCheck != null) {
        vtm.add(ShareTinkerInternals.a(paramShareSecurityCheck, vtm.size() + 1));
      }
    ...
    while (paramString2.hasNext())
    {
      ...
      if (!SharePatchFileUtil.ah((File)localObject))
      {
  ...
  {
    if (vsk) {}
    while (!paramShareDexDiffPatchInfo.vuA.equals("0")) {
      return false;
    }
    return true;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/loader/TinkerDexLoader.class
