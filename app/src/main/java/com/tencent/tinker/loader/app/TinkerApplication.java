  ...
  extends Application
{
  ...
  private void onBaseContextAttached(Context paramContext)
  {
    ...
    if (this.useSafeMode)
    {
      paramContext = ShareTinkerInternals.aC(this);
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/loader/app/TinkerApplication.class
