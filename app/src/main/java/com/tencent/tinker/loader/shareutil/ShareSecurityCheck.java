...
public class ShareSecurityCheck
{
  ...
  public final HashMap<String, String> vvS;
  private final HashMap<String, String> vvT;
  ...
  public ShareSecurityCheck(Context paramContext)
  {
    ...
    if (hjG == null)
    {
      ...
      try
      {
        paramContext = SharePatchFileUtil.ag(paramContext.getPackageManager().getPackageInfo(paramContext.getPackageName(), 64).signatures[0].toByteArray());
        hjG = paramContext;
  ...
  private static boolean a(File paramFile, Certificate[] paramArrayOfCertificate)
  {
    if (paramArrayOfCertificate.length > 0)
    {
      ...
      while (i >= 0) {
        try
        {
          boolean bool = hjG.equals(SharePatchFileUtil.ag(paramArrayOfCertificate[i].getEncoded()));
          if (bool) {
            return true;
          }
        }
  ...
  /* Error */
  public final boolean an(File paramFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 107	com/tencent/tinker/loader/shareutil/SharePatchFileUtil:ah	(Ljava/io/File;)Z
    //   4: ifne +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    ...
    //   74: ifeq -49 -> 25
    //   77: aload_0
    //   78: getfield 30	com/tencent/tinker/loader/shareutil/ShareSecurityCheck:vvS	Ljava/util/HashMap;
    //   81: aload 6
    //   83: aload 4
    //   85: aload 5
  ...
  public final HashMap<String, String> cHd()
  {
    ...
    Object localObject = (String)this.vvS.get("assets/package_meta.txt");
    if (localObject == null) {
      return null;
    }
    ...
    while (i < j)
    {
      ...
      if ((arrayOfString != null) && (arrayOfString.length() > 0) && (!arrayOfString.startsWith("#")))
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length >= 2)) {
          this.vvT.put(arrayOfString[0].trim(), arrayOfString[1].trim());
        }
      }
      i += 1;
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/loader/shareutil/ShareSecurityCheck.class
