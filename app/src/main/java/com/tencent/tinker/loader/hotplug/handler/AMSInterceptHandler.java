...
{
  private static final int[] vue = { 16842840 };
  ...
  private boolean a(ActivityInfo paramActivityInfo)
  {
    ...
    try
    {
      localObject2 = ((Resources.Theme)localObject2).obtainStyledAttributes(vue);
  ...
  private void aD(Intent paramIntent)
  {
    ...
    for (;;)
    {
      if (IncrementComponentManager.acR((String)localObject1))
      {
        Object localObject3 = IncrementComponentManager.acS((String)localObject1);
        boolean bool = a((ActivityInfo)localObject3);
        localObject3 = ActivityStubManager.r((String)localObject1, ((ActivityInfo)localObject3).launchMode, bool);
      ...
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = IncrementComponentManager.aC(paramIntent);
      }
  ...
  private Object b(Object paramObject, Method paramMethod, Object[] paramArrayOfObject)
  {
    ...
    for (;;)
    {
      if ((i != -1) && (((Integer)paramArrayOfObject[0]).intValue() == vuf))
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/loader/hotplug/handler/AMSInterceptHandler.class
