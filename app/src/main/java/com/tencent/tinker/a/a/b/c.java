...
public final class c
{
  ...
  public static int b(int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      int k = fJ(paramArrayOfInt1[j], paramArrayOfInt2[j]);
      i = k;
      if (k != 0) {
        break;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/tinker/a/a/b/c.class
