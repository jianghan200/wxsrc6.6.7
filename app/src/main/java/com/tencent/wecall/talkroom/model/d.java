...
public final class d
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    return g.equals(cHI(), ((d)paramObject).cHI());
  }
  ...
  public final String toString()
  {
    ...
    while ((this.vxf == null) || (this.vxg == null))
    {
    ...
    for (localObject = "null";; localObject = localStringBuilder3.toString())
    {
      ...
      localStringBuilder2.append(" uuid:").append(((a.av)localObject).qXJ);
      localStringBuilder2.append(" openClientId:").append(((a.av)localObject).vfv);
      localStringBuilder2.append(" invite uuid: ").append(((a.av)localObject).vfr);
      localStringBuilder2.append(" member id:").append(((a.av)localObject).kpU);
      localStringBuilder2.append(" status: ").append(((a.av)localObject).status);
      localStringBuilder2.append(" reason: ").append(((a.av)localObject).aAk);
      localObject = localStringBuilder2.toString();
      break;
      localStringBuilder3 = new StringBuilder();
      localStringBuilder3.append("VoiceGroupUsrProfile");
      localStringBuilder3.append(" uuid: ").append(((a.aw)localObject).qXJ);
      localStringBuilder3.append(" user name: ").append(((a.aw)localObject).username);
      localStringBuilder3.append(" head url: ").append(((a.aw)localObject).mpV);
    }
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/wecall/talkroom/model/d.class
