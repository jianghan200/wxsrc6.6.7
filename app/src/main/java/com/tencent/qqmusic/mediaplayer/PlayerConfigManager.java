        ...
        if ((isSingleCpuOrScreenOff()) && (ENABLE_CHANGE_THREAD_PRIORITY))
        {
          if (add())
          {
            ...
            if ((i == this.mCurrPriorityIndex) && (i >= 0) && (i < this.THREAD_PRIORITY.length)) {
              Logger.e("PlayerConfigManager", "changeDecodeThreadPriorityIfNeed don't change Priority mCurrPriorityIndex = " + this.THREAD_PRIORITY[this.mCurrPriorityIndex]);
            }
          }
          else
          {
  ...
  public void setCommonPlayerRef(CorePlayer paramCorePlayer)
  {
    if (paramCorePlayer != null)
    {
      ...
      if (paramCorePlayer != null)
      {
        ...
        Logger.e("PlayerConfigManager", "setCommonPlayerRef info = " + paramCorePlayer + ",mPlaySpeed = " + this.mPlaySpeed);
      }
    }
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/qqmusic/mediaplayer/PlayerConfigManager.class
