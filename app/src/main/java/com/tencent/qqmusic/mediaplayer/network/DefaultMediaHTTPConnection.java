  ...
  implements IMediaHTTPConnection
{
  ...
  public int readAt(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    int i = 0;
    long l = paramInt1;
    for (;;)
    {
      ...
      {
        Logger.w("MediaHTTPConnection", "readAt " + paramInt1 + " / " + paramInt2 + " => " + paramArrayOfByte);
        return 64526;
      }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/qqmusic/mediaplayer/network/DefaultMediaHTTPConnection.class
