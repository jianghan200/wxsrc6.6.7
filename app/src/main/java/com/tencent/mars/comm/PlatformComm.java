...
public class PlatformComm
{
  ...
  public static void init(Context paramContext, ag paramag)
  {
  ...
  public static class C2Java
  {
    ...
    public static PlatformComm.APNInfo getAPNInfo()
    {
      ...
      {
        x.printErrStackTrace("PlatformComm", localException, "", new Object[0]);
      }
      return null;
    }
    ...
    public static int getCurRadioAccessNetworkInfo()
    {
      ...
      {
        x.e("PlatformComm", exception2String(localException));
        x.printErrStackTrace("PlatformComm", localException, "", new Object[0]);
    ...
    public static PlatformComm.SIMInfo getCurSIMInfo()
    {
      try
      {
        ...
        int i = ao.getISPCode(PlatformComm.context);
        if (i != 0)
        {
          PlatformComm.SIMInfo localSIMInfo = new PlatformComm.SIMInfo();
          localSIMInfo.ispCode = String.valueOf(i);
          x.d("PlatformComm", "getISPCode MCC_MNC=%s", new Object[] { localSIMInfo.ispCode });
          localSIMInfo.ispName = ao.getISPName(PlatformComm.context);
          return localSIMInfo;
        }
      }
      catch (Exception localException)
    ...
    public static PlatformComm.WifiInfo getCurWifiInfo()
    {
      try
      {
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            x.e("PlatformComm", "getActiveNetworkInfo failed.");
            localObject2 = null;
          }
      ...
      {
        x.printErrStackTrace("PlatformComm", localException2, "", new Object[0]);
        return null;
      }
    }
    ...
    public static int getStatisticsNetType()
    {
      ...
      try
      {
        int i = ao.getNetType(PlatformComm.context);
        if (i == -1) {
          return -1;
        }
    ...
    public static boolean isNetworkConnected()
    {
      ...
      try
      {
        boolean bool = ao.isNetworkConnected(PlatformComm.context);
        return bool;
      }
      catch (Exception localException)
      {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mars/comm/PlatformComm.class
