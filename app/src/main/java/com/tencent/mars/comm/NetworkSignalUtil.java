...
public class NetworkSignalUtil
{
  ...
  public static long getWifiSignalStrength()
  {
    ...
    if ((localWifiInfo != null) && (localWifiInfo.getBSSID() != null))
    {
      ...
      x.v("MicroMsg.NetworkSignalUtil", "Wifi Signal:" + j * 10);
      int i = j;
      if (j > 10) {
        i = 10;
      }
    ...
    x.v("MicroMsg.NetworkSignalUtil", "Can Not Get Wifi Signal");
    return 0L;
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mars/comm/NetworkSignalUtil.class
