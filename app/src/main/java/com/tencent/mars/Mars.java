...
public class Mars
{
  ...
  public static void checkLoadedModules(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        x.i(paramString, "loaded modules: " + Arrays.toString(paramArrayList.toArray(arrayOfString)));
  ...
  {
    PlatformComm.init(paramContext, paramag);
    hasInitialized = true;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/mars/Mars.class
