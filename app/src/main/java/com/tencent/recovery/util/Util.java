...
public class Util
{
  ...
  private static String an(Context paramContext, int paramInt)
  {
  ...
  public static String gS(long paramLong)
  {
    return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS").format(new Date(paramLong));
  }
  
  public static final int hl(Context paramContext)
  {
    ...
    for (Object localObject = paramContext.getMacAddress();; localObject = null)
    {
      ...
      for (paramContext = paramContext.getAddress();; paramContext = null)
      {
        ...
        i = ("A" + u(localStringBuffer.toString().getBytes()).substring(0, 15)).hashCode();
  ...
  {
    return an(paramContext, Process.myPid());
  }
  
  public static final boolean oW(String paramString)
  {
    return (paramString == null) || (paramString.length() == 0);
  }
  
  private static final String u(byte[] paramArrayOfByte)
  {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/recovery/util/Util.class
