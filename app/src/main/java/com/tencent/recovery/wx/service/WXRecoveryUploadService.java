  ...
  extends RecoveryUploadService
{
  ...
  private boolean pushData(JSONArray paramJSONArray, String paramString)
  {
    try
    {
      Object localObject1 = WXUtil.hq(this);
      ...
      String str = EncryptUtil.u(String.format("weixin#$()%d%d", new Object[] { Integer.decode(paramString), Integer.valueOf(i) }).getBytes()).toLowerCase();
      byte[] arrayOfByte = EncryptUtil.r(paramJSONArray);
  ...
  protected boolean uploadData(List<RecoveryHandleItem> paramList)
  {
    ...
    Object localObject1 = "0x26060736";
    ...
    for (;;)
    {
      try
      {
        localJSONArray.put(new JSONObject().put("tag", "RecoveryHandle").put("info", ((RecoveryHandleItem)localObject2).aAL).put("uin", ((RecoveryHandleItem)localObject2).fMk).put("deviceUUID", i).put("time", Util.gS(((RecoveryHandleItem)localObject2).timestamp)).put("cver", ((RecoveryHandleItem)localObject2).clientVersion).put("processName", ((RecoveryHandleItem)localObject2).processName).put("phoneStatus", ((RecoveryHandleItem)localObject2).vhx));
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/recovery/wx/service/WXRecoveryUploadService.class
