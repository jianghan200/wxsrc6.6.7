...
public class RecoveryReporter
{
  ...
  public static <T extends com.tencent.recovery.model.RecoveryPersistentItem> java.util.List<T> a(Context paramContext, String paramString, Class<T> paramClass)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 19	com/tencent/recovery/report/RecoveryReporter:hk	(Landroid/content/Context;)Ljava/io/File;
    //   4: astore_0
    ...
    //   227: aload 8
    //   229: aload 7
    //   231: invokevirtual 106	com/tencent/recovery/model/RecoveryPersistentItem:ack	(Ljava/lang/String;)Z
    //   234: ifeq +18 -> 252
    //   237: aload_1
    //   238: astore_0
    //   239: aload 5
  ...
  public static boolean a(Context paramContext, String paramString, com.tencent.recovery.model.RecoveryPersistentItem paramRecoveryPersistentItem)
  {
    ...
    //   4: astore_0
    //   5: aload_2
    //   6: invokevirtual 124	com/tencent/recovery/model/RecoveryPersistentItem:cEY	()Ljava/lang/String;
    //   9: astore_2
    //   10: ldc 35
    //   12: ldc 126
    //   14: iconst_1
  ...
  {
    new File(hk(paramContext), paramString).delete();
  }
  ...
  public static boolean c(Context paramContext, String paramString, java.util.List<? extends com.tencent.recovery.model.RecoveryPersistentItem> paramList)
  {
    ...
    //   30: dup
    //   31: aload_0
    //   32: invokestatic 19	com/tencent/recovery/report/RecoveryReporter:hk	(Landroid/content/Context;)Ljava/io/File;
    //   35: aload_1
    ...
    //   120: invokevirtual 124	com/tencent/recovery/model/RecoveryPersistentItem:cEY	()Ljava/lang/String;
    //   123: astore 4
    //   125: aload_3
    //   126: astore_0
    //   127: aload_3
  ...
  private static File hk(Context paramContext)
  {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/recovery/report/RecoveryReporter.class
