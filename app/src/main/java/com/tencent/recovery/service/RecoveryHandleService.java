  ...
  protected final void onHandleIntent(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          RecoveryLog.i("Recovery.RecoveryHandleService", "start to handle %s's exception uuid: %s threadId: %d", new Object[] { localRecoveryData.processName, localRecoveryData.fMk, Long.valueOf(Thread.currentThread().getId()) });
          ...
          if ((paramIntent.vhy) && (!bool))
          {
            ...
            localObject2 = OptionFactory.hj(this);
            localObject1 = PendingIntent.getService(this, 1000002, (Intent)localObject1, 0);
            l = System.currentTimeMillis() + ((CommonOptions)localObject2).vhD - 2000L;
            ((AlarmManager)getSystemService("alarm")).set(0, l, (PendingIntent)localObject1);
            RecoveryLog.i("Recovery.RecoveryHandleService", "startAlarm pendingIntent success: %d will retry %s", new Object[] { Integer.valueOf(((PendingIntent)localObject1).hashCode()), Util.gS(l) });
          }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/recovery/service/RecoveryHandleService.class
