  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.userId, ((TipsInfoLog)paramObject).userId)) || (!JceUtil.equals(this.userIdType, ((TipsInfoLog)paramObject).userIdType)) || (!JceUtil.equals(this.gamePackageName, ((TipsInfoLog)paramObject).gamePackageName)) || (!JceUtil.equals(this.gameVersionCode, ((TipsInfoLog)paramObject).gameVersionCode)) || (!JceUtil.equals(this.gameChannelId, ((TipsInfoLog)paramObject).gameChannelId)) || (!JceUtil.equals(this.authorizedTipsCount, ((TipsInfoLog)paramObject).authorizedTipsCount)) || (!JceUtil.equals(this.downloadTipsCount, ((TipsInfoLog)paramObject).downloadTipsCount)) || (!JceUtil.equals(this.installTipsCount, ((TipsInfoLog)paramObject).installTipsCount)) || (!JceUtil.equals(this.networkErrorTipsCount, ((TipsInfoLog)paramObject).networkErrorTipsCount)) || (!JceUtil.equals(this.cancelBtnClickCount, ((TipsInfoLog)paramObject).cancelBtnClickCount)) || (!JceUtil.equals(this.downloadBtnClickCount, ((TipsInfoLog)paramObject).downloadBtnClickCount)) || (!JceUtil.equals(this.installBtnClickCount, ((TipsInfoLog)paramObject).installBtnClickCount)) || (!JceUtil.equals(this.authorizedBtnClickCount, ((TipsInfoLog)paramObject).authorizedBtnClickCount)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("TipsInfoLog", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/TipsInfoLog.class
