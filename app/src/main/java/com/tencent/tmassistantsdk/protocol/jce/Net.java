  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.netType, ((Net)paramObject).netType)) || (!JceUtil.equals(this.extNetworkOperator, ((Net)paramObject).extNetworkOperator)) || (!JceUtil.equals(this.extNetworkType, ((Net)paramObject).extNetworkType)) || (!JceUtil.equals(this.isWap, ((Net)paramObject).isWap)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("Net", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/Net.class
