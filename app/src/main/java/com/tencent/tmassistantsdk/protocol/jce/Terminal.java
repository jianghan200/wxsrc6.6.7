  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.imei, ((Terminal)paramObject).imei)) || (!JceUtil.equals(this.macAdress, ((Terminal)paramObject).macAdress)) || (!JceUtil.equals(this.androidId, ((Terminal)paramObject).androidId)) || (!JceUtil.equals(this.androidIdSdCard, ((Terminal)paramObject).androidIdSdCard)) || (!JceUtil.equals(this.imsi, ((Terminal)paramObject).imsi)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("Terminal", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/Terminal.class
