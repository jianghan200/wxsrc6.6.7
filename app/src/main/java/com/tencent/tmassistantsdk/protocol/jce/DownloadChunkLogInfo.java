  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.UUID, ((DownloadChunkLogInfo)paramObject).UUID)) || (!JceUtil.equals(this.type, ((DownloadChunkLogInfo)paramObject).type)) || (!JceUtil.equals(this.requestUrl, ((DownloadChunkLogInfo)paramObject).requestUrl)) || (!JceUtil.equals(this.networkOperator, ((DownloadChunkLogInfo)paramObject).networkOperator)) || (!JceUtil.equals(this.networkType, ((DownloadChunkLogInfo)paramObject).networkType)) || (!JceUtil.equals(this.isWap, ((DownloadChunkLogInfo)paramObject).isWap)) || (!JceUtil.equals(this.requestRanagePosition, ((DownloadChunkLogInfo)paramObject).requestRanagePosition)) || (!JceUtil.equals(this.requestRanageSize, ((DownloadChunkLogInfo)paramObject).requestRanageSize)) || (!JceUtil.equals(this.responseRangePosition, ((DownloadChunkLogInfo)paramObject).responseRangePosition)) || (!JceUtil.equals(this.responseRangeLength, ((DownloadChunkLogInfo)paramObject).responseRangeLength)) || (!JceUtil.equals(this.responseContentLength, ((DownloadChunkLogInfo)paramObject).responseContentLength)) || (!JceUtil.equals(this.responseHttpCode, ((DownloadChunkLogInfo)paramObject).responseHttpCode)) || (!JceUtil.equals(this.receiveDataSize, ((DownloadChunkLogInfo)paramObject).receiveDataSize)) || (!JceUtil.equals(this.startTime, ((DownloadChunkLogInfo)paramObject).startTime)) || (!JceUtil.equals(this.readHeaderTime, ((DownloadChunkLogInfo)paramObject).readHeaderTime)) || (!JceUtil.equals(this.endTime, ((DownloadChunkLogInfo)paramObject).endTime)) || (!JceUtil.equals(this.errorCode, ((DownloadChunkLogInfo)paramObject).errorCode)) || (!JceUtil.equals(this.resultState, ((DownloadChunkLogInfo)paramObject).resultState)) || (!JceUtil.equals(this.currentRetryCnt, ((DownloadChunkLogInfo)paramObject).currentRetryCnt)) || (!JceUtil.equals(this.via, ((DownloadChunkLogInfo)paramObject).via)) || (!JceUtil.equals(this.appId, ((DownloadChunkLogInfo)paramObject).appId)) || (!JceUtil.equals(this.flag, ((DownloadChunkLogInfo)paramObject).flag)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("DownloadChunkLogInfo", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/DownloadChunkLogInfo.class
