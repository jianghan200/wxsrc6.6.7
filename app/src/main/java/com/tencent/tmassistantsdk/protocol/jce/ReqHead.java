  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.requestId, ((ReqHead)paramObject).requestId)) || (!JceUtil.equals(this.cmdId, ((ReqHead)paramObject).cmdId)) || (!JceUtil.equals(this.phoneGuid, ((ReqHead)paramObject).phoneGuid)) || (!JceUtil.equals(this.qua, ((ReqHead)paramObject).qua)) || (!JceUtil.equals(this.encryptWithPack, ((ReqHead)paramObject).encryptWithPack)) || (!JceUtil.equals(this.terminal, ((ReqHead)paramObject).terminal)) || (!JceUtil.equals(this.assistantAPILevel, ((ReqHead)paramObject).assistantAPILevel)) || (!JceUtil.equals(this.assistantVersionCode, ((ReqHead)paramObject).assistantVersionCode)) || (!JceUtil.equals(this.net, ((ReqHead)paramObject).net)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("ReqHead", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/ReqHead.class
