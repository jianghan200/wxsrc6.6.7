  ...
  implements Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.logType, ((ReportLogRequest)paramObject).logType)) || (!JceUtil.equals(this.logData, ((ReportLogRequest)paramObject).logData)) || (!JceUtil.equals(this.hostUserId, ((ReportLogRequest)paramObject).hostUserId)) || (!JceUtil.equals(this.hostAppPackageName, ((ReportLogRequest)paramObject).hostAppPackageName)) || (!JceUtil.equals(this.hostAppVersion, ((ReportLogRequest)paramObject).hostAppVersion)));
    return true;
  }
  ...
  public final int hashCode()
  {
    ...
    {
      x.printErrStackTrace("ReportLogRequest", localException, "", new Object[0]);
    }
    return 0;
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/tmassistantsdk/protocol/jce/ReportLogRequest.class
