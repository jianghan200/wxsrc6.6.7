...
public class DownloadInfo
{
  ...
  public int startDownloadIfReady(boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty(this.mHeaderParamString)) && ((this.mHeaderParams == null) || (this.mHeaderParams.size() <= 0)))
    {
      ...
      {
        x.printErrStackTrace("_DownloadInfo", localJSONException, "", new Object[0]);
      }
    }
    for (;;)
    {
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/tmassistantsdk/downloadservice/DownloadInfo.class
