...
public class ByteRange
{
  ...
  public static long getTotalSize(String paramString)
  {
    ...
    return bi.WV(paramString.substring(i + 1));
  }
  ...
  public static ByteRange parseContentRange(String paramString)
  {
    ...
    return new ByteRange(bi.WV(localMatcher.group(1)), bi.WV(localMatcher.group(2)));
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/tmassistantsdk/downloadservice/ByteRange.class
