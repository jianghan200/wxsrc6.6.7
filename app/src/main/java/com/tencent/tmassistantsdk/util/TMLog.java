...
public class TMLog
{
  ...
  public static void debugE(String paramString)
  {
    if ((mDebugFlagForSDK) && (!TextUtils.isEmpty(mDebugFlagForSDKTag))) {
      x.e(mDebugFlagForSDKTag, paramString);
    }
  }
  ...
  {
    if ((mDebugFlagForSDK) && (!TextUtils.isEmpty(mDebugFlagForSDKTag))) {
      x.v(mDebugFlagForSDKTag, paramString);
    }
  }
  ...
  public static void time(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        x.v(paramString1, localStringBuffer.toString());
  ...
  public static void w(String paramString1, String paramString2)
  {
    if (isForDebug())
    {
      ...
      x.w(paramString1, str);
    }
  }
}


/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/tmassistantsdk/util/TMLog.class
