  ...
  extends TMAssistantDownloadSDKClientBase
{
  ...
  public TMAssistantDownloadOpenSDKClient(Context paramContext, String paramString1, String paramString2)
  {
    ...
    this.mServiceCallback = new TMAssistantDownloadOpenSDKClient.1(this);
  }
  ...
  public boolean initTMAssistantDownloadSDK()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokespecial 82	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadSDKClientBase:initTMAssistantDownloadSDK	()Z
    //   6: istore_1
    //   7: ldc 8
    //   9: new 84	java/lang/StringBuilder
    //   12: dup
    //   13: ldc 86
    //   15: invokespecial 87	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   18: iload_1
    //   19: invokevirtual 91	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   22: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   25: invokestatic 53	com/tencent/tmassistantsdk/util/TMLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   28: iload_1
    //   29: ifne +78 -> 107
    //   32: new 64	android/content/Intent
    //   35: dup
    //   36: invokespecial 95	android/content/Intent:<init>	()V
    //   39: astore_2
    //   40: aload_2
    //   41: ldc 72
    //   43: ldc 97
    //   45: invokevirtual 101	android/content/Intent:setClassName	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   48: pop
    //   49: aload_2
    //   50: ldc 102
    //   52: invokevirtual 106	android/content/Intent:addFlags	(I)Landroid/content/Intent;
    //   55: pop
    //   56: aload_0
    //   57: getfield 110	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadOpenSDKClient:mContext	Landroid/content/Context;
    //   60: aload_2
    //   61: invokevirtual 116	android/content/Context:startActivity	(Landroid/content/Intent;)V
    //   64: new 118	android/os/HandlerThread
    //   67: dup
    //   68: ldc 120
    //   70: invokespecial 121	android/os/HandlerThread:<init>	(Ljava/lang/String;)V
    //   73: astore_2
    //   74: aload_2
    //   75: invokevirtual 124	android/os/HandlerThread:start	()V
    //   78: new 126	android/os/Handler
    //   81: dup
    //   82: aload_2
    //   83: invokevirtual 130	android/os/HandlerThread:getLooper	()Landroid/os/Looper;
    //   86: invokespecial 133	android/os/Handler:<init>	(Landroid/os/Looper;)V
    //   89: astore_2
    //   90: aload_2
    //   91: new 135	com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadOpenSDKClient$2
    //   94: dup
    //   95: aload_0
    //   96: aload_2
    ...
    //   117: dup
    //   118: ldc -110
    //   120: invokespecial 87	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   123: aload_2
  ...
  {
    this.mServiceInterface = a.a.y(paramIBinder);
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/tmassistantsdk/downloadclient/TMAssistantDownloadOpenSDKClient.class
