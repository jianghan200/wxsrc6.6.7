...
public class TMAssistantSDKChannelDataItem
{
  ...
  public static TMAssistantSDKChannelDataItem getDataItemFromByte(byte[] paramArrayOfByte)
  {
    ...
    catch (UnsupportedEncodingException paramArrayOfByte)
    {
      ...
      long l2;
      int k;
      x.printErrStackTrace("MicroMsg.TMAssistantSDKChannelDataItem", paramArrayOfByte, "", new Object[0]);
      return null;
    }
  ...
  public byte[] getBuffer()
  {
    ...
    {
      x.printErrStackTrace("MicroMsg.TMAssistantSDKChannelDataItem", localJSONException, "", new Object[0]);
      return null;
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      for (;;)
      {
        x.printErrStackTrace("MicroMsg.TMAssistantSDKChannelDataItem", localUnsupportedEncodingException, "", new Object[0]);
      }
    }
  }
}
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/tencent/tmassistantsdk/channel/TMAssistantSDKChannelDataItem.class
