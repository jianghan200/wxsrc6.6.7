...
public class TMOpenSDKToMsdkManager
{
  ...
  public void initOpenSDK(ITMOpenSDKToMsdkListener paramITMOpenSDKToMsdkListener)
  {
    ...
    this.mMainMessageHandler = new ag(Looper.getMainLooper(), new TMOpenSDKToMsdkManager.1(this));
  }
  ...
  protected void showDialog(TipsInfo paramTipsInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        x.printErrStackTrace("OpensdkToMsdkManager", localException, "", new Object[0]);
        continue;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/tmassistantsdk/openSDK/opensdktomsdk/TMOpenSDKToMsdkManager.class
