  ...
  implements IAssistantOnActionListener
{
  ...
  public ArrayList<TMAssistantDownloadTaskInfo> getBatchTaskInfos(ArrayList<TMQQDownloaderOpenSDKParam> paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      {
        x.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramArrayList, "", new Object[0]);
        return null;
      }
    }
    for (;;)
  ...
  public TMAssistantDownloadTaskInfo getDownloadTask(TMQQDownloaderOpenSDKParam paramTMQQDownloaderOpenSDKParam)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramTMQQDownloaderOpenSDKParam = (TMQQDownloaderOpenSDKParam)localObject1;
      ...
      {
        x.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramTMQQDownloaderOpenSDKParam, "", new Object[0]);
        return null;
      }
  ...
  public boolean handleUriAction(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((paramString != null) && (paramString.length > 0)) {
        ...
        {
          x.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramString, "", new Object[0]);
          return false;
        }
      }
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes2-dex2jar.jar!/com/tencent/tmassistantsdk/openSDK/TMQQDownloaderOpenSDKDataProcessor.class
