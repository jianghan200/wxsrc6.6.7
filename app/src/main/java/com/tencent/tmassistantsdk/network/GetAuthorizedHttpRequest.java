    ...
    for (;;)
    {
      ...
      if ((paramInt == 0) && (paramJSONObject != null)) {
        ...
        catch (JSONException paramJSONObject)
        {
          ...
          x.printErrStackTrace("GetAuthorizedHttpRequest", paramJSONObject, "", new Object[0]);
          return;
        }
      }
    }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/tmassistantsdk/network/GetAuthorizedHttpRequest.class
