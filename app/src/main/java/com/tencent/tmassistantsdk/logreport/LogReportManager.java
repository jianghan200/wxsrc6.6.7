    ...
    public void onNetworkChanged()
    {
      ...
      for (;;)
      {
        if (i < j)
        {
          ...
          {
            x.printErrStackTrace("LogReportManager", localException, "", new Object[0]);
          }
        }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes6-dex2jar.jar!/com/tencent/tmassistantsdk/logreport/LogReportManager.class
