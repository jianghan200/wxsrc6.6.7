...
public class TMAssistantFile
{
  ...
  private boolean writeData(FileOutputStream paramFileOutputStream, byte[] paramArrayOfByte, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        x.printErrStackTrace("TMAssistantFile", paramFileOutputStream, "", new Object[0]);
  ...
  public void close()
  {
    ...
    //   49: invokestatic 171	com/tencent/mm/sdk/platformtools/x:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   52: goto -31 -> 21
    //   55: astore_1
    //   56: aload_0
    //   57: monitorexit
  ...
  public boolean flush()
  {
    ...
    try
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          x.printErrStackTrace("TMAssistantFile", localIOException, "", new Object[0]);
      ...
      try
      {
        ...
        else
        {
          try
          {
            ...
            {
              this.mWriteDataBuffer = new byte['䀀'];
              this.mDataBufferDataLen = 0;
            }
          ...
          {
            x.printErrStackTrace("TMAssistantFile", paramArrayOfByte, "", new Object[0]);
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes3-dex2jar.jar!/com/tencent/tmassistantsdk/storage/TMAssistantFile.class
