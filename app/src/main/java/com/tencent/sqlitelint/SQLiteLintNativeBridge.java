...
public class SQLiteLintNativeBridge
{
  ...
  private static void onPublishIssue(String paramString, ArrayList<SQLiteLintIssue> paramArrayList)
  {
    try
    {
      g.vnt.acI(paramString).eh(paramArrayList);
      return;
    }
  ...
  private String[] sqliteLintExecSql(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        arrayOfString[1] = "-1";
        localc = null;
        f localf = g.vnt.acI(paramString1);
        if (localf != null) {
          localc = localf.vnl;
        }
        if (localc == null)
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/com/tencent/sqlitelint/SQLiteLintNativeBridge.class
