  ...
  implements com.tencent.xweb.x5.a.a.a.a.a
{
  ...
  public boolean allowJavaScriptOpenWindowAutomatically(String paramString1, String paramString2)
  {
    ...
    if (localb.vDY != null) {
      return localb.vDY.super_allowJavaScriptOpenWindowAutomatically(paramString1, paramString2);
    }
  ...
  public void didFirstVisuallyNonEmptyPaint()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_didFirstVisuallyNonEmptyPaint();
    }
  }
  ...
  public void documentAvailableInMainFrame()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_documentAvailableInMainFrame();
    }
  }
  ...
  public void handlePluginTag(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_handlePluginTag(paramString1, paramString2, paramBoolean, paramString3);
    }
  }
  ...
  public void hideAddressBar()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_hideAddressBar();
    }
  }
  ...
  public boolean notifyAutoAudioPlay(String paramString, JsResult paramJsResult)
  {
    ...
    if (localb.vDY != null) {
      return localb.vDY.super_notifyAutoAudioPlay(paramString, paramJsResult);
    }
    Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
    return false;
  }
  ...
  public boolean notifyJavaScriptOpenWindowsBlocked(String paramString, String[] paramArrayOfString, ValueCallback<Boolean> paramValueCallback, boolean paramBoolean)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      return localb.vDY.super_notifyJavaScriptOpenWindowsBlocked(paramString, paramArrayOfString, paramValueCallback, paramBoolean);
    }
    Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
    return false;
  }
  ...
  public void onDoubleTapStart()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onDoubleTapStart();
    }
  }
  ...
  public void onFlingScrollBegin(int paramInt1, int paramInt2, int paramInt3)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onFlingScrollBegin(paramInt1, paramInt2, paramInt3);
    }
  }
  ...
  public void onFlingScrollEnd()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onFlingScrollEnd();
    }
  }
  ...
  public void onHideListBox()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onHideListBox();
    }
  }
  ...
  public void onHistoryItemChanged()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onHistoryItemChanged();
    }
  }
  ...
  public void onMetricsSavedCountReceived(String paramString1, boolean paramBoolean, long paramLong, String paramString2, int paramInt)
  {
    ...
    if (localb.vDY != null)
    {
      localb.vDY.super_onMetricsSavedCountReceived(paramString1, paramBoolean, paramLong, paramString2, paramInt);
      return;
    }
    Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
  }
  ...
  public Object onMiscCallBack(String paramString, Bundle paramBundle, Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      return localb.vDY.super_onMiscCallBack(paramString, paramBundle, paramObject1, paramObject2, paramObject3, paramObject4);
    }
    return null;
  }
  ...
  public void onMissingPluginClicked(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onMissingPluginClicked(paramString1, paramString2, paramString3, paramInt);
    }
  }
  ...
  public void onNativeCrashReport(int paramInt, String paramString)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onNativeCrashReport(paramInt, paramString);
    }
  }
  ...
  public void onPinchToZoomStart()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onPinchToZoomStart();
    }
  }
  ...
  public void onPreReadFinished()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onPreReadFinished();
    }
  }
  ...
  public void onPrefetchResourceHit(boolean paramBoolean)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onPrefetchResourceHit(paramBoolean);
    }
  }
  ...
  public void onPromptScaleSaved()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onPromptScaleSaved();
    }
  }
  ...
  public void onReceivedSslErrorCancel()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onReceivedSslErrorCancel();
    }
  }
  ...
  public void onReceivedViewSource(String paramString)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onReceivedViewSource(paramString);
    }
  }
  ...
  public void onReportAdFilterInfo(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onReportAdFilterInfo(paramInt1, paramInt2, paramString, paramBoolean);
    }
  }
  ...
  public void onReportHtmlInfo(int paramInt, String paramString)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onReportHtmlInfo(paramInt, paramString);
    }
  }
  ...
  public void onResponseReceived(WebResourceRequest paramWebResourceRequest, WebResourceResponse paramWebResourceResponse, int paramInt)
  {
    ...
    if (localb.vDY != null)
    {
      localb.vDY.super_onResponseReceived(paramWebResourceRequest, paramWebResourceResponse, paramInt);
      return;
    }
    Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
  }
  ...
  public void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onScrollChanged(paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  public void onSetButtonStatus(boolean paramBoolean1, boolean paramBoolean2)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onSetButtonStatus(paramBoolean1, paramBoolean2);
    }
  }
  ...
  public void onShowListBox(String[] paramArrayOfString, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onShowListBox(paramArrayOfString, paramArrayOfInt1, paramArrayOfInt2, paramInt);
    }
  }
  ...
  public void onShowMutilListBox(String[] paramArrayOfString, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onShowMutilListBox(paramArrayOfString, paramArrayOfInt1, paramArrayOfInt2, paramArrayOfInt3);
    }
  }
  ...
  public void onSlidingTitleOffScreen(int paramInt1, int paramInt2)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onSlidingTitleOffScreen(paramInt1, paramInt2);
    }
  }
  ...
  public void onSoftKeyBoardHide(int paramInt)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onSoftKeyBoardHide(paramInt);
    }
  }
  ...
  public void onSoftKeyBoardShow()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onSoftKeyBoardShow();
    }
  }
  ...
  public void onTransitionToCommitted()
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onTransitionToCommitted();
    }
  }
  ...
  public void onUploadProgressChange(int paramInt1, int paramInt2, String paramString)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onUploadProgressChange(paramInt1, paramInt2, paramString);
    }
  }
  ...
  public void onUploadProgressStart(int paramInt)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onUploadProgressStart(paramInt);
    }
  }
  ...
  public void onUrlChange(String paramString1, String paramString2)
  {
    b localb = this.mXWebProxyImp;
    if (localb.vDY != null) {
      localb.vDY.super_onUrlChange(paramString1, paramString2);
    }
  }
  ...
  public void showTranslateBubble(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    if (localb.vDY != null)
    {
      localb.vDY.super_showTranslateBubble(paramInt1, paramString1, paramString2, paramInt2);
      return;
    }
    Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
  }
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes4-dex2jar.jar!/com/tencent/xweb/x5/sdk/ProxyWebViewSuperWrapper.class
