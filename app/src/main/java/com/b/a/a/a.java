...
{
  private static final FileFilter acg = new a.1();
  
  /* Error */
  @android.annotation.TargetApi(16)
  public static long U(android.content.Context paramContext)
  {
    // Byte code:
  ...
  public static int in()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        j = ad("/sys/devices/system/cpu/possible");
        int i = j;
        if (j == -1) {
          i = ad("/sys/devices/system/cpu/present");
        }
        j = i;
        if (i == -1)
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            if (((File)localObject1).canRead())
            {
              ...
              try
              {
                ...
                localObject2 = Integer.valueOf(bi.WU(new String((byte[])localObject2, 0, j)));
                j = i;
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes5-dex2jar.jar!/com/b/a/a/a.class
