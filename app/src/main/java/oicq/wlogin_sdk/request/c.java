...
public final class c
{
  ...
  private static int a(Context paramContext, String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   193: astore_1
    //   194: aload_0
    //   195: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   198: aload_1
    //   199: ifnull +7 -> 206
    //   202: aload_1
    ...
    //   210: astore_1
    //   211: aload_1
    //   212: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   215: aload_0
    ...
    //   223: astore_1
    //   224: aload_1
    //   225: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   228: aload_0
    ...
    //   236: astore_1
    //   237: aload_1
    //   238: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   241: aload_3
    ...
    //   255: astore_1
    //   256: aload_1
    //   257: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   260: aload_3
  ...
  private int b(TreeMap paramTreeMap, String paramString)
  {
    try
    {
      Object localObject2 = new SecretKeySpec(i.vIA, "DESede");
    ...
    catch (Exception paramTreeMap)
    {
      for (;;)
      {
        ...
        paramString.flush();
        util.gA("exception", paramString.toString());
        int i = 64514;
      }
    }
    finally {}
  ...
  /* Error */
  private static TreeMap bT(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: aload_1
    //   2: invokestatic 190	oicq/wlogin_sdk/request/c:bU	(Landroid/content/Context;Ljava/lang/String;)[B
    //   5: astore 4
    //   7: aload 4
    //   9: ifnull +507 -> 516
    //   12: new 116	javax/crypto/spec/SecretKeySpec
    //   15: dup
    //   16: getstatic 122	oicq/wlogin_sdk/request/i:vIA	[B
    //   19: ldc 124
    ...
    //   123: invokestatic 184	oicq/wlogin_sdk/tools/util:gA	(Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_1
    //   127: astore_2
    //   128: aload_0
    //   129: invokestatic 214	oicq/wlogin_sdk/tools/util:is	(Landroid/content/Context;)[B
    //   132: astore_3
    //   133: aload_2
    //   134: astore_1
    //   135: aload_3
    ...
    //   219: astore_1
    //   220: aload_0
    //   221: invokestatic 217	oicq/wlogin_sdk/tools/util:ir	(Landroid/content/Context;)[B
    //   224: astore_3
    //   225: aload_1
    //   226: astore_2
    //   227: aload_3
    ...
    //   241: dup
    //   242: aload_3
    //   243: invokestatic 223	oicq/wlogin_sdk/tools/c:ce	([B)[B
    //   246: ldc 124
    ...
    //   313: astore_2
    //   314: aload_0
    //   315: invokestatic 226	oicq/wlogin_sdk/tools/util:iq	(Landroid/content/Context;)[B
    //   318: astore_1
    //   319: aload_2
    //   320: astore_0
    //   321: aload_1
    ...
    //   335: dup
    //   336: aload_1
    //   337: invokestatic 223	oicq/wlogin_sdk/tools/c:ce	([B)[B
    //   340: ldc 124
  ...
  /* Error */
  private static byte[] bU(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    ...
    //   114: astore_1
    //   115: aload_0
    //   116: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   119: aload_1
    //   120: ifnull +7 -> 127
    //   123: aload_1
    ...
    //   173: astore_1
    //   174: aload_0
    //   175: invokestatic 108	oicq/wlogin_sdk/tools/util:l	(Ljava/lang/Exception;)V
    //   178: aload_1
    //   179: ifnull +18 -> 197
    //   182: aload_1
  ...
  /* Error */
  private WloginAllSigInfo hi(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   22: invokestatic 281	oicq/wlogin_sdk/tools/util:gz	(Ljava/lang/String;Ljava/lang/String;)V
    //   25: aload_0
    //   26: getfield 19	oicq/wlogin_sdk/request/c:vHY	Ljava/util/TreeMap;
    ...
    //   68: ldc 111
    //   70: invokestatic 294	oicq/wlogin_sdk/request/c:bT	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/TreeMap;
    //   73: astore_3
    //   74: aload_3
    //   75: ifnonnull +8 -> 83
    //   78: aconst_null
    ...
    //   103: ldc_w 273
    //   106: ldc_w 296
    //   109: invokestatic 281	oicq/wlogin_sdk/tools/util:gz	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: aconst_null
    //   113: astore_3
    //   114: goto -66 -> 48
    //   117: aload_0
    //   118: getfield 19	oicq/wlogin_sdk/request/c:vHY	Ljava/util/TreeMap;
  ...
  public final int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[] paramArrayOfByte13, byte[] paramArrayOfByte14, byte[] paramArrayOfByte15, byte[] paramArrayOfByte16, byte[][] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        WloginAllSigInfo localWloginAllSigInfo = (WloginAllSigInfo)this.vHY.get(new Long(paramLong1));
        ...
        if ((localObject != null) && (((WloginSigInfo)localObject)._en_A1 != null))
        {
          ...
          util.adN("before put_siginfo, ret=" + i);
          if (this._context != null)
          {
            paramArrayOfByte2 = bT(this._context, "tk_file");
            ...
            util.adN("after refreshTKTreeMap, ret=" + i);
          }
          if (i != 0)
          {
          ...
          this.vHY.put(new Long(paramLong1), localWloginAllSigInfo);
          return i;
        }
      }
      finally {}
  ...
  /* Error */
  public final WloginSigInfo hj(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   28: invokestatic 281	oicq/wlogin_sdk/tools/util:gz	(Ljava/lang/String;Ljava/lang/String;)V
    //   31: aload_0
    //   32: lload_1
    //   33: invokespecial 353	oicq/wlogin_sdk/request/c:hi	(J)Loicq/wlogin_sdk/request/WloginAllSigInfo;
    //   36: astore_3
    //   37: aload_3
    //   38: ifnonnull +9 -> 47
    //   41: aconst_null
  ...
  public final void i(Long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 19	oicq/wlogin_sdk/request/c:vHY	Ljava/util/TreeMap;
    //   6: aload_1
    ...
    //   22: ldc 111
    //   24: invokestatic 294	oicq/wlogin_sdk/request/c:bT	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/TreeMap;
    //   27: astore_2
    //   28: aload_2
    //   29: ifnonnull +6 -> 35
    //   32: aload_0
...
/* Location:              /Users/Han/Desktop/wxall/微信反编译/反编译 6.6.7/dex2jar-2.0/classes-dex2jar.jar!/oicq/wlogin_sdk/request/c.class
